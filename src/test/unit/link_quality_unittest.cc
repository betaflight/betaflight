 ...
 */
TEST(LQTest, TestDisarmWithImmediateRearm)
{
    doTestArm();
    doTestDisarm();
...
/*
 * Tests the Tests the OSD_LINK_QUALITY element . default
 */
TEST(LQTest, TestElementLQ_DEFAULT)
{
    // given
    ...
    EXPECT_EQ(LQ_SOURCE_NONE, linkQualitySource);
 ...
 */
TEST(LQTest, TestElementLQ_PROTOCOL_CRSF)
{
    // given
...
/*
 * Tests the OSD_LINK_QUALITY element LQ RX_CHANNEL.
 */
TEST(LQTest, TestElementLQ_RX_CHANNEL)
{
    // given
    ...
    // then
    displayPortTestBufferSubstring(8, 1, "99");
    ...
    // then
    displayPortTestBufferSubstring(8, 1, "49");
 ...
 *
*/
TEST(LQTest, TestLQAlarms_DEFUALT)
{
    // given
