...
#define __HAL_RCC_CLK(bus, suffix, enbit, newState) \
...
#if !(defined(STM32H7) || defined(STM32H5) || defined(STM32C5) || defined(STM32G4) || defined(STM32N6))
    case RCC_APB1:
    ...
    case RCC_AHB5:
        __HAL_RCC_CLK(AHB5, NOSUFFIX, mask, NewState);
        break;
    ...
    case RCC_APB4:
        __HAL_RCC_CLK(APB4, 1, mask, NewState);
        break;

    case RCC_APB42:
        __HAL_RCC_CLK(APB4, 2, mask, NewState);
        break;

    case RCC_APB5:
        __HAL_RCC_CLK(APB5, NOSUFFIX, mask, NewState);
        break;
#endif
...
#define __HAL_RCC_RESET(bus, suffix, enbit, NewState) \
    ...
    case RCC_AHB5:
        __HAL_RCC_RESET(AHB5, NOSUFFIX, mask, NewState);
        break;
    ...
    case RCC_APB4:
        __HAL_RCC_RESET(APB4, 1, mask, NewState);
        break;

    case RCC_APB42:
        __HAL_RCC_RESET(APB4, 2, mask, NewState);
        break;

    case RCC_APB5:
        __HAL_RCC_RESET(APB5, NOSUFFIX, mask, NewState);
        break;
#endif
