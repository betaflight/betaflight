...
// Port B
    ...
    DEF_TIM(TIM9,  CH2,  PB1,  0, 0, 0),
    DEF_TIM(TIM1,  CH1,  PB2,  0, 0, 0),
    DEF_TIM(TIM1,  CH4N, PB3,  0, 0, 0),
    DEF_TIM(TIM3,  CH1,  PB4,  0, 0, 0),
    DEF_TIM(TIM3,  CH2,  PB5,  0, 0, 0),
    DEF_TIM(TIM15, CH1,  PB6,  0, 0, 0),
    DEF_TIM(TIM15, CH2,  PB7,  0, 0, 0),
    DEF_TIM(TIM2,  CH3,  PB10, 0, 0, 0),
    DEF_TIM(TIM2,  CH4,  PB11, 0, 0, 0),
    DEF_TIM(TIM8,  CH3N, PB13, 0, 0, 0),
    DEF_TIM(TIM8,  CH4N, PB14, 0, 0, 0),

// Port C
    DEF_TIM(TIM4,  CH4,  PC1,  0, 0, 0),
    DEF_TIM(TIM17, CH1,  PC1,  0, 0, 0),
    DEF_TIM(TIM1,  CH2N, PC4,  0, 0, 0),
    DEF_TIM(TIM12, CH1,  PC4,  0, 0, 0),
    DEF_TIM(TIM1,  CH1,  PC6,  0, 0, 0),
    DEF_TIM(TIM3,  CH1,  PC6,  0, 0, 0),
    DEF_TIM(TIM9,  CH1,  PC6,  0, 0, 0),
    DEF_TIM(TIM3,  CH2,  PC7,  0, 0, 0),
    DEF_TIM(TIM16, CH1N, PC7,  0, 0, 0),
    DEF_TIM(TIM9,  CH2,  PC7,  0, 0, 0),
    DEF_TIM(TIM3,  CH3,  PC8,  0, 0, 0),
    DEF_TIM(TIM3,  CH4,  PC9,  0, 0, 0),
    DEF_TIM(TIM1,  CH4,  PC12, 0, 0, 0),
    DEF_TIM(TIM15, CH1,  PC12, 0, 0, 0),

// Port D
    DEF_TIM(TIM1,  CH3,  PD2,  0, 0, 0),
    DEF_TIM(TIM15, CH1N, PD2,  0, 0, 0),
    DEF_TIM(TIM1,  CH4N, PD5,  0, 0, 0),
    DEF_TIM(TIM1,  CH1,  PD6,  0, 0, 0),
    DEF_TIM(TIM15, CH2,  PD6,  0, 0, 0),
    DEF_TIM(TIM1,  CH2,  PD7,  0, 0, 0),
    DEF_TIM(TIM15, CH1N, PD7,  0, 0, 0),
...
// Port F
    DEF_TIM(TIM4,  CH4,  PF0,  0, 0, 0),
    DEF_TIM(TIM4,  CH3,  PF1,  0, 0, 0),
    DEF_TIM(TIM1,  CH3N, PF2,  0, 0, 0),
    DEF_TIM(TIM1,  CH3,  PF6,  0, 0, 0),
    DEF_TIM(TIM2,  CH4,  PF6,  0, 0, 0),
    DEF_TIM(TIM5,  CH4,  PF6,  0, 0, 0),
    DEF_TIM(TIM15, CH2,  PF6,  0, 0, 0),
    DEF_TIM(TIM1,  CH2N, PF7,  0, 0, 0),
    DEF_TIM(TIM3,  CH3,  PF7,  0, 0, 0),
    DEF_TIM(TIM9,  CH1,  PF7,  0, 0, 0),
    DEF_TIM(TIM2,  CH2,  PF14, 0, 0, 0),

// Port G
    DEF_TIM(TIM1,  CH4N, PG0,  0, 0, 0),
    DEF_TIM(TIM12, CH1,  PG0,  0, 0, 0),
    DEF_TIM(TIM13, CH1,  PG1,  0, 0, 0),
    DEF_TIM(TIM16, CH1N, PG1,  0, 0, 0),
    DEF_TIM(TIM14, CH1,  PG2,  0, 0, 0),
    DEF_TIM(TIM17, CH1N, PG2,  0, 0, 0),
    DEF_TIM(TIM1,  CH3N, PG8,  0, 0, 0),
    DEF_TIM(TIM12, CH2,  PG8,  0, 0, 0),
    DEF_TIM(TIM1,  CH1N, PG10, 0, 0, 0),
    DEF_TIM(TIM17, CH1,  PG12, 0, 0, 0),
    DEF_TIM(TIM4,  CH1,  PG13, 0, 0, 0),
    DEF_TIM(TIM8,  CH4,  PG14, 0, 0, 0),
    DEF_TIM(TIM1,  CH4,  PG15, 0, 0, 0),

// Port H
    DEF_TIM(TIM4,  CH3,  PH9,  0, 0, 0),
    DEF_TIM(TIM16, CH1,  PH9,  0, 0, 0),
};
#endif
