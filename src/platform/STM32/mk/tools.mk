...
PLATFORM_SDK_stm32h5_SUBMODULE := lib/modules/STM32H5
...
PLATFORM_SDK_stm32c5_SUBMODULE := lib/modules/STM32C5
...
PLATFORM_SDK_stm32n6_SUBMODULE := lib/modules/STM32N6
...
STM32H5_LIB_PATH ?= $(ROOT_DIR)/lib/modules/STM32H5
STM32N6_LIB_PATH ?= $(ROOT_DIR)/lib/modules/STM32N6
STM32C5_LIB_PATH ?= $(ROOT_DIR)/lib/modules/STM32C5
...
$(STM32H5_SDK_STAMP):
	...
	$(V1) git submodule update --init --checkout -- lib/modules/STM32H5 || { echo "Failed to update STM32CubeH5"; exit 1; }
...
$(STM32C5_SDK_STAMP):
	...
	$(V1) git submodule update --init --checkout -- lib/modules/STM32C5 || { echo "Failed to update STM32CubeC5"; exit 1; }
...
$(STM32N6_SDK_STAMP):
	...
	$(V1) git submodule update --init --checkout -- lib/modules/STM32N6 || { echo "Failed to update STM32CubeN6"; exit 1; }
