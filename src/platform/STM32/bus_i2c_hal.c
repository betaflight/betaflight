...
{
    HAL_I2C_ER_IRQHandler(&i2cDevice[I2CDEV_1].halHandle->hal);
}

void I2C1_EV_IRQHandler(void)
{
    HAL_I2C_EV_IRQHandler(&i2cDevice[I2CDEV_1].halHandle->hal);
}
#endif
...
{
    HAL_I2C_ER_IRQHandler(&i2cDevice[I2CDEV_2].halHandle->hal);
}

void I2C2_EV_IRQHandler(void)
{
    HAL_I2C_EV_IRQHandler(&i2cDevice[I2CDEV_2].halHandle->hal);
}
#endif
...
{
    HAL_I2C_ER_IRQHandler(&i2cDevice[I2CDEV_3].halHandle->hal);
}

void I2C3_EV_IRQHandler(void)
{
    HAL_I2C_EV_IRQHandler(&i2cDevice[I2CDEV_3].halHandle->hal);
}
#endif
...
{
    HAL_I2C_ER_IRQHandler(&i2cDevice[I2CDEV_4].halHandle->hal);
}

void I2C4_EV_IRQHandler(void)
{
    HAL_I2C_EV_IRQHandler(&i2cDevice[I2CDEV_4].halHandle->hal);
}
#endif
