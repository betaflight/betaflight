...
const uartHardware_t uartHardware[UARTDEV_COUNT] = {
...
#ifdef USE_UART3
    {
        ...
        .rxPins = {
            ...
            { DEFIO_TAG_E(PC4),  GPIO_AF7_USART3 },
...
#ifdef USE_UART4
    {
        ...
        .rxPins = {
            ...
            { DEFIO_TAG_E(PD11), GPIO_AF8_UART4 },
        },
        .txPins = {
            ...
            { DEFIO_TAG_E(PD12), GPIO_AF8_UART4 },
        },
        .rcc = RCC_APB1L(UART4),
        .irqn = UART4_IRQn,
...
#ifdef USE_UART5
    {
        ...
        .rxPins = {
            ...
            { DEFIO_TAG_E(PB15), GPIO_AF14_UART5 },
...
#ifdef USE_UART8
    {
        ...
        .txPins = {
            ...
            { DEFIO_TAG_E(PE2), GPIO_AF8_UART8 },
        },
        .rcc = RCC_APB1L(UART8),
        .irqn = UART8_IRQn,
...
#ifdef USE_UART9
    {
        ...
        .rxPins = {
            ...
            { DEFIO_TAG_E(PG0),  GPIO_AF11_UART9 },
        },
        .txPins = {
            { DEFIO_TAG_E(PD15), GPIO_AF11_UART9 },
            { DEFIO_TAG_E(PG1),  GPIO_AF11_UART9 },
        },
        .rcc = RCC_APB1H(UART9),
        .irqn = UART9_IRQn,
...
#endif
        .rxPins = {
            { DEFIO_TAG_E(PE2),  GPIO_AF7_USART10 },
            { DEFIO_TAG_E(PG11), GPIO_AF6_USART10 },
        },
        .txPins = {
            { DEFIO_TAG_E(PE3),  GPIO_AF7_USART10 },
            { DEFIO_TAG_E(PG12), GPIO_AF6_USART10 },
        },
        .rcc = RCC_APB1L(USART10),
        .irqn = USART10_IRQn,
...
#ifdef USE_LPUART1
    {
        ...
        .rxDMAResource = (dmaResource_t *)NULL,
        .txDMAChannel = GPDMA1_REQUEST_LPUART1_TX,
        .txDMAResource = (dmaResource_t *)NULL,
#endif
        .rxPins = {
            { DEFIO_TAG_E(PA10), GPIO_AF3_LPUART1 },
            { DEFIO_TAG_E(PB7),  GPIO_AF8_LPUART1 },
        },
        .txPins = {
            { DEFIO_TAG_E(PA9),  GPIO_AF3_LPUART1 },
            { DEFIO_TAG_E(PB6),  GPIO_AF8_LPUART1 },
        },
        .rcc = RCC_APB3(LPUART1),
        .irqn = LPUART1_IRQn,
        .txPriority = NVIC_PRIO_SERIALLPUART1_TXDMA,
        .rxPriority = NVIC_PRIO_SERIALLPUART1,
