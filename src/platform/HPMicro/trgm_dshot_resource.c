...
#ifdef HPM6360
    /* TRGM1 pins. */
    { IO_TAG(PA22), IOC_PA22_FUNC_CTL_TRGM1_P_02, 1, 2, HPM_TRGM1_OUTPUT_SRC_TRGM1_P2, HPM_TRGM1_INPUT_SRC_TRGM1_P2 },
    { IO_TAG(PA27), IOC_PA27_FUNC_CTL_TRGM1_P_07, 1, 7, HPM_TRGM1_OUTPUT_SRC_TRGM1_P7, HPM_TRGM1_INPUT_SRC_TRGM1_P7 },

    /* TRGM0 pins. */
    { IO_TAG(PB20), IOC_PB20_FUNC_CTL_TRGM0_P_00, 0, 0, HPM_TRGM0_OUTPUT_SRC_TRGM0_P0, HPM_TRGM0_INPUT_SRC_TRGM0_P0 },
    { IO_TAG(PB21), IOC_PB21_FUNC_CTL_TRGM0_P_01, 0, 1, HPM_TRGM0_OUTPUT_SRC_TRGM0_P1, HPM_TRGM0_INPUT_SRC_TRGM0_P1 },

    /* Additional TRGM0 pins that can be swapped in at runtime. */
    { IO_TAG(PB22), IOC_PB22_FUNC_CTL_TRGM0_P_02, 0, 2, HPM_TRGM0_OUTPUT_SRC_TRGM0_P2, HPM_TRGM0_INPUT_SRC_TRGM0_P2 },
    { IO_TAG(PB23), IOC_PB23_FUNC_CTL_TRGM0_P_03, 0, 3, HPM_TRGM0_OUTPUT_SRC_TRGM0_P3, HPM_TRGM0_INPUT_SRC_TRGM0_P3 },
#endif

#ifdef HPM6750
    /* TRGM1 telemetry pins. */
    { IO_TAG(PB7), IOC_PB07_FUNC_CTL_TRGM1_P_02, 1, 2, HPM_TRGM1_OUTPUT_SRC_TRGM1_P2, HPM_TRGM1_INPUT_SRC_TRGM1_P2 },
    { IO_TAG(PB13), IOC_PB13_FUNC_CTL_TRGM1_P_03, 1, 3, HPM_TRGM1_OUTPUT_SRC_TRGM1_P3, HPM_TRGM1_INPUT_SRC_TRGM1_P3 },

    /* TRGM2 telemetry pins. */
    { IO_TAG(PC16), IOC_PC16_FUNC_CTL_TRGM2_P_02, 2, 2, HPM_TRGM2_OUTPUT_SRC_TRGM2_P2, HPM_TRGM2_INPUT_SRC_TRGM2_P2 },
    { IO_TAG(PC21), IOC_PC21_FUNC_CTL_TRGM2_P_03, 2, 3, HPM_TRGM2_OUTPUT_SRC_TRGM2_P3, HPM_TRGM2_INPUT_SRC_TRGM2_P3 },
#endif
};
