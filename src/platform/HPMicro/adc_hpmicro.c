...
#ifdef HPM6750
            adc12_get_prd_result(adc->ADCx, adcOperatingConfig[i].adcChannel, &result);
            adcValues[adcOperatingConfig[i].dmaIndex] = result;
#elif defined(HPM6360)
            adc16_get_prd_result(adc->ADCx, adcOperatingConfig[i].adcChannel, &result);
