...
#ifdef USE_SPI
#ifdef HPM6750
    { DMA_PERIPH_SPI_SDO, SPIDEV_0, { DMA_OPT4(1, HPM_DMA_SRC_SPI0_TX, 4, 5, 6, 7)} },
    { DMA_PERIPH_SPI_SDI, SPIDEV_0, { DMA_OPT4(1, HPM_DMA_SRC_SPI0_RX, 4, 5, 6, 7)} },
    { DMA_PERIPH_SPI_SDO, SPIDEV_1, { DMA_OPT4(1, HPM_DMA_SRC_SPI1_TX, 4, 5, 6, 7)} },
    { DMA_PERIPH_SPI_SDI, SPIDEV_1, { DMA_OPT4(1, HPM_DMA_SRC_SPI1_RX, 4, 5, 6, 7)} },
    { DMA_PERIPH_SPI_SDO, SPIDEV_2, { DMA_OPT4(1, HPM_DMA_SRC_SPI2_TX, 4, 5, 6, 7)} },
    { DMA_PERIPH_SPI_SDI, SPIDEV_2, { DMA_OPT4(1, HPM_DMA_SRC_SPI2_RX, 4, 5, 6, 7)} },
    { DMA_PERIPH_SPI_SDO, SPIDEV_3, { DMA_OPT4(1, HPM_DMA_SRC_SPI3_TX, 4, 5, 6, 7)} },
    { DMA_PERIPH_SPI_SDI, SPIDEV_3, { DMA_OPT4(1, HPM_DMA_SRC_SPI3_RX, 4, 5, 6, 7)} },
#endif
#ifdef HPM6360
    { DMA_PERIPH_SPI_SDO, SPIDEV_0, { DMA_OPT3(1, HPM_DMA_SRC_SPI0_TX, 5, 6, 7)} },
    { DMA_PERIPH_SPI_SDI, SPIDEV_0, { DMA_OPT1(1, HPM_DMA_SRC_SPI0_RX, 0)} },
    { DMA_PERIPH_SPI_SDO, SPIDEV_1, { DMA_OPT3(1, HPM_DMA_SRC_SPI1_TX, 5, 6, 7)} },
    { DMA_PERIPH_SPI_SDI, SPIDEV_1, { DMA_OPT3(1, HPM_DMA_SRC_SPI1_RX, 5, 6, 7)} },
    { DMA_PERIPH_SPI_SDO, SPIDEV_2, { DMA_OPT3(1, HPM_DMA_SRC_SPI2_TX, 5, 6, 7)} },
    { DMA_PERIPH_SPI_SDI, SPIDEV_2, { DMA_OPT3(1, HPM_DMA_SRC_SPI2_RX, 5, 6, 7)} },
    { DMA_PERIPH_SPI_SDO, SPIDEV_3, { DMA_OPT3(1, HPM_DMA_SRC_SPI3_TX, 5, 6, 7)} },
    { DMA_PERIPH_SPI_SDI, SPIDEV_3, { DMA_OPT3(1, HPM_DMA_SRC_SPI3_RX, 5, 6, 7)} },
#endif
#endif                          // USE_SPI
};
...
static const dmaPeripheralMappingHPM_t dmaPeripheralMappingHPM[] = {
    ...
    { HPM_DMA_PERIPH_PWM_OUT, 0, { DMA(2, 0, HPM_DMA_SRC_MOT1_0)} },
    { HPM_DMA_PERIPH_PWM_OUT, 1, { DMA(2, 1, HPM_DMA_SRC_MOT1_1)} },
    { HPM_DMA_PERIPH_PWM_OUT, 2, { DMA(2, 2, HPM_DMA_SRC_MOT2_2)} },
    { HPM_DMA_PERIPH_PWM_OUT, 3, { DMA(2, 3, HPM_DMA_SRC_MOT2_3)} },
