...
PLATFORM_SDK_gd32h7_SUBMODULE := lib/modules/GD32H7
...
GD32H7_LIB_PATH ?= $(ROOT_DIR)/lib/modules/GD32H7
...
$(GD32H7_SDK_STAMP):
	...
	$(V1) git submodule update --init --checkout -- lib/modules/GD32H7 || { echo "Failed to update GD32H7xx_Firmware"; exit 1; }
