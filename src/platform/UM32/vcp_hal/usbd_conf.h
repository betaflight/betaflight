...
#define IMR_MSK (INT_ACK | INT_RESUME | INT_SUSPEND | INT_BUS_RESET)
...
/* Exported functions ------------------------------------------------------- */
void USB_WritePMA(uint8_t *pbUsrBuf, uint32_t wPMABufAddr, uint8_t wNBytes);
void USB_ReadPMA(uint8_t *pbUsrBuf, uint32_t wPMABufAddr, uint8_t wNBytes);
