...
bool ws2811LedStripHardwareInit(void)
{
    ...
    hdma_tim.Init.DstMSize            = DMA_BURST_DST_NUM_1;   
    hdma_tim.Init.SrcMSize            = DMA_BURST_SRC_NUM_1;   
   
    hdma_tim.Init.SrcInc              = DMA_SRCINC_INC;    
    hdma_tim.Init.DstInc              = DMA_DSTINC_NOC;     
    hdma_tim.Init.SrcDataAlignment    = DMA_SRCDATAALIGN_WORD;  
    hdma_tim.Init.DstDataAlignment    = DMA_DSTDATAALIGN_WORD;  
    ...
    hdma_tim.Init.FCMode              = DMA_FCMODE_DISABLE;   
