...
{
    IOConfigGPIOAF(io, cfg, GPIO_NO_AF);
}
...
void IOConfigGPIOAF(IO_t io, ioConfig_t cfg, uint8_t af)
{
    ...
    GPIO_InitStructure.GPIO_Slew_Rate  = IO_CONFIG_GET_SLEW(cfg);
    GPIO_InitStructure.GPIO_Pull       = IO_CONFIG_GET_PULL(cfg);
    GPIO_InitStructure.GPIO_Current    = IO_CONFIG_GET_CURRENT(cfg);
