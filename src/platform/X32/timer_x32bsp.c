...
static const x32TimerInfo_t timerInstances[HARDWARE_TIMER_DEFINITION_COUNT] = {
    { .tim = ATIM1,  .rcc = RCC_APB2_1(ATIM1),  .inputIrq = ATIM1_CC_IRQn, .updateIrq = ATIM1_UP_IRQn, .separateUpdateIrq = true,  .advanced = true,  .number = X32_TIMER_ATIM1 },
    { .tim = ATIM2,  .rcc = RCC_APB2_1(ATIM2),  .inputIrq = ATIM2_CC_IRQn, .updateIrq = ATIM2_UP_IRQn, .separateUpdateIrq = true,  .advanced = true,  .number = X32_TIMER_ATIM2 },
    { .tim = GTIMA1, .rcc = RCC_APB2_1(GTIMA1), .inputIrq = GTIMA1_IRQn,   .updateIrq = GTIMA1_IRQn,   .separateUpdateIrq = false, .advanced = false, .number = X32_TIMER_GTIMA1 },
    { .tim = GTIMA2, .rcc = RCC_APB2_1(GTIMA2), .inputIrq = GTIMA2_IRQn,   .updateIrq = GTIMA2_IRQn,   .separateUpdateIrq = false, .advanced = false, .number = X32_TIMER_GTIMA2 },
    { .tim = GTIMA3, .rcc = RCC_APB2_1(GTIMA3), .inputIrq = GTIMA3_IRQn,   .updateIrq = GTIMA3_IRQn,   .separateUpdateIrq = false, .advanced = false, .number = X32_TIMER_GTIMA3 },
    { .tim = GTIMA4, .rcc = RCC_APB1_1(GTIMA4), .inputIrq = GTIMA4_IRQn,   .updateIrq = GTIMA4_IRQn,   .separateUpdateIrq = false, .advanced = false, .number = X32_TIMER_GTIMA4 },
    { .tim = GTIMA5, .rcc = RCC_APB1_2(GTIMA5), .inputIrq = GTIMA5_IRQn,   .updateIrq = GTIMA5_IRQn,   .separateUpdateIrq = false, .advanced = false, .number = X32_TIMER_GTIMA5 },
    { .tim = GTIMA6, .rcc = RCC_APB1_2(GTIMA6), .inputIrq = GTIMA6_IRQn,   .updateIrq = GTIMA6_IRQn,   .separateUpdateIrq = false, .advanced = false, .number = X32_TIMER_GTIMA6 },
    { .tim = GTIMA7, .rcc = RCC_APB1_2(GTIMA7), .inputIrq = GTIMA7_IRQn,   .updateIrq = GTIMA7_IRQn,   .separateUpdateIrq = false, .advanced = false, .number = X32_TIMER_GTIMA7 },
    { .tim = GTIMB1, .rcc = RCC_APB1_1(GTIMB1), .inputIrq = GTIMB1_IRQn,   .updateIrq = GTIMB1_IRQn,   .separateUpdateIrq = false, .advanced = false, .number = X32_TIMER_GTIMB1 },
    { .tim = GTIMB2, .rcc = RCC_APB1_1(GTIMB2), .inputIrq = GTIMB2_IRQn,   .updateIrq = GTIMB2_IRQn,   .separateUpdateIrq = false, .advanced = false, .number = X32_TIMER_GTIMB2 },
    { .tim = GTIMB3, .rcc = RCC_APB1_1(GTIMB3), .inputIrq = GTIMB3_IRQn,   .updateIrq = GTIMB3_IRQn,   .separateUpdateIrq = false, .advanced = false, .number = X32_TIMER_GTIMB3 },
    { .tim = ATIM3,  .rcc = RCC_APB5_1(ATIM3),  .inputIrq = ATIM3_CC_IRQn, .updateIrq = ATIM3_UP_IRQn, .separateUpdateIrq = true,  .advanced = true,  .number = X32_TIMER_ATIM3 },
    { .tim = ATIM4,  .rcc = RCC_APB5_1(ATIM4),  .inputIrq = ATIM4_CC_IRQn, .updateIrq = ATIM4_UP_IRQn, .separateUpdateIrq = true,  .advanced = true,  .number = X32_TIMER_ATIM4 },
};
...
static bool isGeneralTimerB(const TIM_TypeDef *tim)
{
    return (tim == GTIMB1) || (tim == GTIMB2) || (tim == GTIMB3);
}
static void timerEnableClock(const void *tim)
{
...
#define X32_TIM_CC_HANDLER(handlerName, tim) \
    ...
    void handlerName(void) \
    { \
        timCCHandler((tim), &timerConfig[lookupTimerIndex((tim))]); \
    }
...
#define X32_TIM_UP_HANDLER(handlerName, tim) \
    ...
    void handlerName(void) \
    { \
        timUpdateHandler((tim), &timerConfig[lookupTimerIndex((tim))]); \
    }
...
#define X32_TIM_GLOBAL_HANDLER(handlerName, tim) \
    ...
    void handlerName(void) \
    { \
        timCombinedHandler((tim), &timerConfig[lookupTimerIndex((tim))]); \
    }
...
{
    return (index < ARRAYLEN(timerInstances)) ? timerInstances[index].number : 0;
}
...
static uint32_t x32PeripheralKernelDivider(uint32_t registerValue, uint32_t fieldMask)
{
    uint32_t fieldValue = registerValue & fieldMask;
...
static uint32_t x32PeripheralKernelClock(uint32_t ahbClockHz, uint32_t registerValue, uint32_t fieldMask)
{
    return ahbClockHz / x32PeripheralKernelDivider(registerValue, fieldMask);
}

uint8_t timerInputInterrupt(const timerHardware_t *timHw)
{
    const uint8_t timerIndex = lookupTimerIndex(timHw->tim);
...
uint32_t timerClockFromInstance(const timerResource_t *tim)
{
    ...
    if ((timer == ATIM1) || (timer == ATIM2)) {
        return x32PeripheralKernelClock(clocks.AHB2ClkFreq, RCC->APB2DIV1, RCC_APB2DIV1_APB2ATIMDIV);
    }

    if ((timer == GTIMA1) || (timer == GTIMA2) || (timer == GTIMA3)) {
        return x32PeripheralKernelClock(clocks.AHB2ClkFreq, RCC->APB2DIV1, RCC_APB2DIV1_APB2GTIMDIV);
    }

    if ((timer == ATIM3) || (timer == ATIM4)) {
        return x32PeripheralKernelClock(clocks.AHB5ClkFreq, RCC->APB5DIV1, RCC_APB5DIV1_APB5ATIMDIV);
    }

    return x32PeripheralKernelClock(clocks.AHB1ClkFreq, RCC->APB1DIV1, RCC_APB1DIV1_APB1GTIMDIV);
}
...
void timerConfigure(const timerHardware_t *timHw, uint16_t period, uint32_t hz)
{
    ...
    if ((isAdvancedTimer((TIM_TypeDef *)timHw->tim)) || (isGeneralTimerB((TIM_TypeDef *)timHw->tim))) {
...
void timerForceOverflow(timerResource_t *tim)
{
    ...
    const uint8_t timerIndex = lookupTimerIndex(timer);
    if (timerIndex >= ARRAYLEN(timerInstances)) {
        return;
    }
