...
PLATFORM_SDKS += x32m7
PLATFORM_SDK_x32m7_SUBMODULE := lib/modules/X32M7
...
X32M7_LIB_PATH ?= $(ROOT_DIR)/lib/modules/X32M7
...
$(X32M7_SDK_STAMP):
	...
	$(V1) git submodule update --init --checkout -- lib/modules/X32M7 || { echo "Failed to update X32M7"; exit 1; }
	@echo "X32M7 ready"
