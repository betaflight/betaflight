...
void Get_SerialNum(void)
{
    ...
    /* Enable OPTC Clock */
    RCC_EnableAXIPeriphClk1(RCC_AXI_PERIPHEN_M7_OTPC | RCC_AXI_PERIPHEN_M4_OTPC, ENABLE);

    OTPC_ReadWord(0x0238, &deviceserial0);
    OTPC_ReadWord(0x0239, &deviceserial1);
    OTPC_ReadWord(0x023A, &deviceserial2);
