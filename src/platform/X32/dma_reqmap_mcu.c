...
#define DMA_REQUEST_UART11_RX DMAMUX1_REQUEST_UART11_RX
#define DMA_REQUEST_UART11_TX DMAMUX1_REQUEST_UART11_TX
#define DMA_REQUEST_UART12_RX DMAMUX1_REQUEST_UART12_RX
#define DMA_REQUEST_UART12_TX DMAMUX1_REQUEST_UART12_TX
#define DMA_REQUEST_UART13_RX DMAMUX1_REQUEST_UART13_RX
#define DMA_REQUEST_UART13_TX DMAMUX1_REQUEST_UART13_TX
#define DMA_REQUEST_UART14_RX DMAMUX1_REQUEST_UART14_RX
#define DMA_REQUEST_UART14_TX DMAMUX1_REQUEST_UART14_TX
#define DMA_REQUEST_UART15_RX DMAMUX1_REQUEST_UART15_RX
#define DMA_REQUEST_UART15_TX DMAMUX1_REQUEST_UART15_TX
...
#define DMA_REQUEST_SPI5_SDO DMAMUX1_REQUEST_SPI5_TX
#define DMA_REQUEST_SPI5_SDI DMAMUX1_REQUEST_SPI5_RX
#define DMA_REQUEST_SPI6_SDO DMAMUX1_REQUEST_SPI6_TX
#define DMA_REQUEST_SPI6_SDI DMAMUX1_REQUEST_SPI6_RX
#define DMA_REQUEST_SPI7_SDO DMAMUX1_REQUEST_SPI7_TX
#define DMA_REQUEST_SPI7_SDI DMAMUX1_REQUEST_SPI7_RX
...
static const dmaPeripheralMapping_t dmaPeripheralMapping[] = {
    ...
    REQMAP_DIR(SPI, 6, SDO),
    REQMAP_DIR(SPI, 6, SDI),
#endif
#ifdef USE_SPI_DEVICE_7
    REQMAP_DIR(SPI, 7, SDO),
    REQMAP_DIR(SPI, 7, SDI),
#endif
...
#endif
#ifdef USE_UART11
    REQMAP_DIR(UART, 11, TX),
    REQMAP_DIR(UART, 11, RX),
#endif
#ifdef USE_UART12
    REQMAP_DIR(UART, 12, TX),
    REQMAP_DIR(UART, 12, RX),
#endif
#ifdef USE_UART13
    REQMAP_DIR(UART, 13, TX),
    REQMAP_DIR(UART, 13, RX),
#endif
#ifdef USE_UART14
    REQMAP_DIR(UART, 14, TX),
    REQMAP_DIR(UART, 14, RX),
#endif
#ifdef USE_UART15
    REQMAP_DIR(UART, 15, TX),
    REQMAP_DIR(UART, 15, RX),
#endif
