...
PLATFORM_SDK_apm32f4_SUBMODULE := lib/modules/APM32F4
...
APM32F4_LIB_PATH ?= $(ROOT_DIR)/lib/modules/APM32F4
...
$(APM32F4_SDK_STAMP):
	...
	$(V1) git submodule update --init --checkout -- lib/modules/APM32F4 || { echo "Failed to update APM32F4"; exit 1; }
	@echo "APM32F4 ready"
