...
void pgResetFn_rxConfig(rxConfig_t *rxConfig)
{
    RESET_CONFIG_2(rxConfig_t, rxConfig,
        ...
        .rcInterpolation = RC_INTERPOLATION_AUTO,
        .rcSmoothingChannels = SMOOTHING_CHANNELS_RPYT,
        .rcInterpolationInterval = 19,
        .fpvCamAngleDegrees = 0,
        .airModeActivateThreshold = 25,
        .max_aux_channel = DEFAULT_AUX_CHANNEL_COUNT,
        .rc_smoothing_type = RC_SMOOTHING_TYPE_FILTER,
        .rc_smoothing_setpoint_cutoff = 0,      // automatically calculate the cutoff by default
        .rc_smoothing_ff_cutoff = 0, // automatically calculate the cutoff by default
