...
typedef enum {
    WAYPOINT_PATTERN_CIRCLE = 0,
    WAYPOINT_PATTERN_FIGURE8
} waypointPattern_e;

typedef struct {
    int32_t latitude;       // Latitude in degrees * 10^6 (6 decimal places, ±90.000000)
    int32_t longitude;      // Longitude in degrees * 10^6 (6 decimal places, ±180.000000)
