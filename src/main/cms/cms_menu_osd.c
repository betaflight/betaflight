...
const OSD_Entry menuOsdActiveElemsEntries[] =
{
    ...
    {"PIDs Tuning Slider DMP",  OME_VISIBLE | DYNAMIC, NULL, &osdConfig_item_pos[OSD_PIDS_TUNING_SLIDER_DMP]},
    {"PIDs Tuning Slider TRK",  OME_VISIBLE | DYNAMIC, NULL, &osdConfig_item_pos[OSD_PIDS_TUNING_SLIDER_TRK]},
    {"PIDs Tuning Slider STK",  OME_VISIBLE | DYNAMIC, NULL, &osdConfig_item_pos[OSD_PIDS_TUNING_SLIDER_STK]},
    {"PIDs Tuning Slider DMX",  OME_VISIBLE | DYNAMIC, NULL, &osdConfig_item_pos[OSD_PIDS_TUNING_SLIDER_DMX]},
    {"PIDs Tuning Slider DRF",  OME_VISIBLE | DYNAMIC, NULL, &osdConfig_item_pos[OSD_PIDS_TUNING_SLIDER_DRF]},
    {"PIDs Tuning Slider PID",  OME_VISIBLE | DYNAMIC, NULL, &osdConfig_item_pos[OSD_PIDS_TUNING_SLIDER_PID]},
    {"PIDs Tuning Slider PIT",  OME_VISIBLE | DYNAMIC, NULL, &osdConfig_item_pos[OSD_PIDS_TUNING_SLIDER_PIT]},
    {"PIDs Tuning Slider MLT",  OME_VISIBLE | DYNAMIC, NULL, &osdConfig_item_pos[OSD_PIDS_TUNING_SLIDER_MLT]},
    {"Filter Slider Gyro",      OME_VISIBLE | DYNAMIC, NULL, &osdConfig_item_pos[OSD_FILTER_SLIDER_GYRO]},
    {"Filter Slider Dterm",     OME_VISIBLE | DYNAMIC, NULL, &osdConfig_item_pos[OSD_FILTER_SLIDER_DTERM]},
