...
static uint16_t cmsx_tpa_d_breakpoint;
static uint8_t cmsx_tpa_p_rate;
static uint16_t cmsx_tpa_p_breakpoint;
...
static const void *cmsx_profileOtherOnEnter(displayPort_t *pDisp)
{
    ...
    cmsx_tpa_d_breakpoint = pidProfile->tpa_d_breakpoint;
    cmsx_tpa_p_rate = pidProfile->tpa_p_rate;
    cmsx_tpa_p_breakpoint = pidProfile->tpa_p_breakpoint;
...
static const void *cmsx_profileOtherOnExit(displayPort_t *pDisp, const OSD_Entry *self)
{
    ...
    pidProfile->tpa_d_breakpoint = cmsx_tpa_d_breakpoint;
    pidProfile->tpa_p_rate = cmsx_tpa_p_rate;
    pidProfile->tpa_p_breakpoint = cmsx_tpa_p_breakpoint;
...
static const OSD_Entry cmsx_menuProfileOtherEntries[] = {
    ...
    { "TPA D BRKPT",     OME_UINT16, NULL, &(OSD_UINT16_t){ &cmsx_tpa_d_breakpoint, 1000, 2000, 10} },
    { "TPA P RATE",      OME_FLOAT,  NULL, &(OSD_FLOAT_t) { &cmsx_tpa_p_rate, 0, 100, 1, 10} },
    { "TPA P BRKPT",     OME_UINT16, NULL, &(OSD_UINT16_t){ &cmsx_tpa_p_breakpoint, 1000, 2000, 10} },
