...
static OSD_Entry cmsx_menuPsasEntries[] =
{
    ...
    { "ROLL", OME_UINT8, NULL, &(OSD_UINT8_t){ &temp_psas_stick_gain[PID_ROLL],  0, 255, 1 }},
    { "PITCH", OME_UINT8, NULL, &(OSD_UINT8_t){ &temp_psas_stick_gain[PID_PITCH],  0, 255, 1 }},
    { "YAW", OME_UINT8, NULL, &(OSD_UINT8_t){ &temp_psas_stick_gain[PID_YAW],  0, 255, 1 }},
    ...
    { "ACC Z I", OME_UINT8, NULL, &(OSD_UINT8_t){ &temp_psas_pitch_accel_i_gain,  0, 255, 1 }},
    { "ACC Z P", OME_UINT16, NULL, &(OSD_UINT16_t){ &temp_psas_pitch_accel_p_gain,  0, 1000, 10 }},
    { "ACC Z MAX", OME_UINT8, NULL, &(OSD_UINT8_t){ &temp_psas_pitch_accel_max,  0, 255, 1 }},
    { "ACC Z MIN", OME_UINT8, NULL, &(OSD_UINT8_t){ &temp_psas_pitch_accel_min,  0, 255, 1 }},

    { "-- AOA LIMITER --", OME_Label, NULL, NULL},
    { "WING LOAD", OME_UINT16, NULL, &(OSD_UINT16_t){ &temp_psas_wing_load,  0, 1500, 1 }},
    { "I", OME_UINT8, NULL, &(OSD_UINT8_t){ &temp_psas_aoa_limiter_gain,  0, 255, 1 }},
    { "LIMIT", OME_UINT8, NULL, &(OSD_UINT8_t){ &temp_psas_lift_c_limit,  5, 20, 1 }},
    { "FORECAST", OME_UINT8, NULL, &(OSD_UINT8_t){ &temp_psas_aoa_limiter_forecast_time,  0, 255, 1 }},
