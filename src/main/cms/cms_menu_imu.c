...
static uint8_t temp_psas_speed_optimum_vref;
static uint8_t temp_psas_speed_main_curve_power;
static uint16_t temp_psas_speed_main_curve_min;
static uint16_t temp_psas_speed_main_curve_max;
...
static const void *cmsx_PsasRead(void)
{
    ...
    temp_psas_speed_optimum_vref =  pidProfile->psas_speed_optimum_vref;
    temp_psas_speed_main_curve_power =  pidProfile->psas_speed_main_curve_power;
    temp_psas_speed_main_curve_min =  pidProfile->psas_speed_main_curve_min;
    temp_psas_speed_main_curve_max =  pidProfile->psas_speed_main_curve_max;
...
static const void *cmsx_PsasWriteback(displayPort_t *pDisp, const OSD_Entry *self)
{
    ...
    pidProfile->psas_speed_optimum_vref = temp_psas_speed_optimum_vref;
    pidProfile->psas_speed_main_curve_power = temp_psas_speed_main_curve_power;
    pidProfile->psas_speed_main_curve_min = temp_psas_speed_main_curve_min;
    pidProfile->psas_speed_main_curve_max = temp_psas_speed_main_curve_max;
...
static OSD_Entry cmsx_menuPsasEntries[] =
{
    ...
    { "-- MAIN SPEED CURVE --", OME_Label, NULL, NULL},
    { "REF. SPEED", OME_UINT8, NULL, &(OSD_UINT8_t){ &temp_psas_speed_optimum_vref, 0, UINT8_MAX, 1 }},
    { "POWER", OME_UINT8, NULL, &(OSD_UINT8_t){ &temp_psas_speed_main_curve_power, 5, 30, 1 }},
    { "MIN", OME_UINT16, NULL, &(OSD_UINT16_t){ &temp_psas_speed_main_curve_min, 1, 100, 1 }},
    { "MAX", OME_UINT16, NULL, &(OSD_UINT16_t){ &temp_psas_speed_main_curve_max, 100, 500, 1 }},
