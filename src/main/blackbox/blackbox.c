...
static bool blackboxWriteSysinfo()
{
    ...
    switch (xmitState.headerIndex) {
        ...
        BLACKBOX_PRINT_HEADER_LINE("deadband:%d",                           currentProfile->rcControlsConfig.deadband);
        BLACKBOX_PRINT_HEADER_LINE("yaw_deadband:%d",                       currentProfile->rcControlsConfig.yaw_deadband);
