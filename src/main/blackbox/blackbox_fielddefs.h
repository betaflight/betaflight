...
typedef enum {
    ...
    FLIGHT_LOG_FIELD_CONDITION_NONZERO_PSAS_PITCH_PILOT,
    FLIGHT_LOG_FIELD_CONDITION_NONZERO_PSAS_PITCH_DAMPING,
    FLIGHT_LOG_FIELD_CONDITION_NONZERO_PSAS_PITCH_STABILITY,
    FLIGHT_LOG_FIELD_CONDITION_NONZERO_PSAS_PITCH_I,
    FLIGHT_LOG_FIELD_CONDITION_NONZERO_PSAS_PITCH_P,
    FLIGHT_LOG_FIELD_CONDITION_NONZERO_PSAS_ROLL_PILOT,
    FLIGHT_LOG_FIELD_CONDITION_NONZERO_PSAS_ROLL_DAMPING,
    FLIGHT_LOG_FIELD_CONDITION_NONZERO_PSAS_YAW_PILOT,
    FLIGHT_LOG_FIELD_CONDITION_NONZERO_PSAS_YAW_DAMPING,
    FLIGHT_LOG_FIELD_CONDITION_NONZERO_PSAS_YAW_STABILITY,
    FLIGHT_LOG_FIELD_CONDITION_NONZERO_PSAS_YAW_ROLL_CROSS_LINK,
#endif
