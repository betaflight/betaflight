...
const timerHardware_t timerHardware[USABLE_TIMER_CHANNEL_COUNT] = {
    ...
    { TIM8,  IO_TAG(PC6),  TIM_CHANNEL_1, 0, IOCFG_IPD,      GPIO_AF3_TIM8,  TIM_USE_PWM | TIM_USE_MC_SERVO | TIM_USE_MC_CHNFW }, // S3_IN 3
    { TIM8,  IO_TAG(PC7),  TIM_CHANNEL_2, 0, IOCFG_IPD,      GPIO_AF3_TIM8,  TIM_USE_PWM | TIM_USE_MC_SERVO | TIM_USE_MC_CHNFW }, // S4_IN 4
    { TIM8,  IO_TAG(PC8),  TIM_CHANNEL_3, 0, IOCFG_IPD,      GPIO_AF3_TIM8,  TIM_USE_PWM | TIM_USE_MC_SERVO | TIM_USE_MC_CHNFW}, // S6_IN 6
    { TIM8,  IO_TAG(PC9),  TIM_CHANNEL_4, 0, IOCFG_IPD,      GPIO_AF3_TIM8,  TIM_USE_PWM | TIM_USE_MC_SERVO | TIM_USE_MC_CHNFW}, // S5_IN 5
