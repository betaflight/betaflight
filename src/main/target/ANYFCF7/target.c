...
// STANDARD LAYOUT
const timerHardware_t timerHardware[USABLE_TIMER_CHANNEL_COUNT] = {
    { TIM12, IO_TAG(PB14), TIM_CHANNEL_1, TIM_USE_PWM | TIM_USE_PPM, 0, GPIO_AF9_TIM12}, // S1_IN
    { TIM12, IO_TAG(PB15), TIM_CHANNEL_2, TIM_USE_PWM, 0, GPIO_AF9_TIM12}, // S2_IN
    { TIM8,  IO_TAG(PC6),  TIM_CHANNEL_1, TIM_USE_PWM, 0, GPIO_AF3_TIM8}, // S3_IN
    { TIM8,  IO_TAG(PC7),  TIM_CHANNEL_2, TIM_USE_PWM, 0, GPIO_AF3_TIM8}, // S4_IN
    { TIM8,  IO_TAG(PC9),  TIM_CHANNEL_4, TIM_USE_PWM, 0, GPIO_AF3_TIM8}, // S5_IN
    { TIM8,  IO_TAG(PC8),  TIM_CHANNEL_3, TIM_USE_PWM, 0, GPIO_AF3_TIM8}, // S6_IN

    { TIM4,  IO_TAG(PB8),  TIM_CHANNEL_3, TIM_USE_MOTOR, 1, GPIO_AF2_TIM4}, // S10_OUT 1
    { TIM2,  IO_TAG(PA2),  TIM_CHANNEL_3, TIM_USE_MOTOR, 1, GPIO_AF1_TIM2}, // S6_OUT  2
    { TIM4,  IO_TAG(PB9),  TIM_CHANNEL_4, TIM_USE_MOTOR, 1, GPIO_AF2_TIM4}, // S5_OUT  3
    { TIM2,  IO_TAG(PA3),  TIM_CHANNEL_4, TIM_USE_MOTOR, 1, GPIO_AF1_TIM2}, // S1_OUT  4
    { TIM5,  IO_TAG(PA1),  TIM_CHANNEL_2, TIM_USE_MOTOR, 1, GPIO_AF2_TIM5}, // S2_OUT
    { TIM9,  IO_TAG(PE6),  TIM_CHANNEL_2, TIM_USE_MOTOR, 1, GPIO_AF3_TIM9}, // S3_OUT
    { TIM3,  IO_TAG(PB5),  TIM_CHANNEL_2, TIM_USE_MOTOR, 1, GPIO_AF2_TIM3}, // S4_OUT
    { TIM5,  IO_TAG(PA0),  TIM_CHANNEL_1, TIM_USE_MOTOR, 1, GPIO_AF2_TIM5}, // S7_OUT
    { TIM2,  IO_TAG(PB3),  TIM_CHANNEL_2, TIM_USE_MOTOR, 1, GPIO_AF1_TIM2}, // S8_OUT
    { TIM3,  IO_TAG(PB4),  TIM_CHANNEL_1, TIM_USE_MOTOR, 1, GPIO_AF2_TIM3}, // S9_OUT
};
#endif
