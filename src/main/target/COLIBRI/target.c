...
const timerHardware_t timerHardware[USABLE_TIMER_CHANNEL_COUNT] = {
	{ TIM1, IO_TAG(PA10), TIM_Channel_3, TIM1_CC_IRQn, 0, IOCFG_AF_PP_PD, GPIO_AF_TIM1 }, // S1_IN
    { TIM8, IO_TAG(PC6),  TIM_Channel_1, TIM8_CC_IRQn, 0, IOCFG_AF_PP_PD, GPIO_AF_TIM8 }, // S2_IN
    { TIM8, IO_TAG(PC7),  TIM_Channel_2, TIM8_CC_IRQn, 0, IOCFG_AF_PP_PD, GPIO_AF_TIM8 }, // S3_IN
    { TIM8, IO_TAG(PC8),  TIM_Channel_3, TIM8_CC_IRQn, 0, IOCFG_AF_PP_PD, GPIO_AF_TIM8 }, // S4_IN
    { TIM2, IO_TAG(PA15), TIM_Channel_1, TIM2_IRQn,    0, IOCFG_AF_PP_PD, GPIO_AF_TIM2 }, // S5_IN
    { TIM2, IO_TAG(PB3),  TIM_Channel_2, TIM2_IRQn,    0, IOCFG_AF_PP_PD, GPIO_AF_TIM2 }, // S6_IN
    { TIM5, IO_TAG(PA0),  TIM_Channel_1, TIM5_IRQn,    0, IOCFG_AF_PP_PD, GPIO_AF_TIM5 }, // S7_IN
    { TIM5, IO_TAG(PA1),  TIM_Channel_2, TIM5_IRQn,    0, IOCFG_AF_PP_PD, GPIO_AF_TIM5 }, // S8_IN
