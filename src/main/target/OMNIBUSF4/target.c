...
#endif // CL_RACINGF4
	DEF_TIM(TIM1,  CH2N, PB0,  TIM_USE_MOTOR,               TIMER_OUTPUT_ENABLED|TIMER_OUTPUT_INVERTED, 0), // M1 - DMA2_ST6
	DEF_TIM(TIM3,  CH4, PB1,  TIM_USE_MOTOR,               TIMER_OUTPUT_ENABLED, 0),                      // M2_OUT D1_ST2
    DEF_TIM(TIM2,  CH4, PA3,  TIM_USE_MOTOR,               TIMER_OUTPUT_ENABLED, 1),                      // M3_OUT D1_ST6
    DEF_TIM(TIM2,  CH3, PA2,  TIM_USE_MOTOR,               TIMER_OUTPUT_ENABLED, 0),                      // M4_OUT D1_ST1
#if defined(CL_RACINGF4)
    DEF_TIM(TIM3,  CH1, PB4,   TIM_USE_BEEPER,             TIMER_OUTPUT_ENABLED,  0), // BEEPER PWM
 	DEF_TIM(TIM4,  CH3, PB8,   TIM_USE_LED, 			   TIMER_OUTPUT_STANDARD, 0),  // LED D1_ST7
