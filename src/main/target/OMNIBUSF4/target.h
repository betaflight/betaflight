...
#ifdef OMNIBUSF4SD
#define SPI_CS_SET  MPU6000_CS_PIN, BMP280_CS_PIN, MAX7456_SPI_CS_PIN, SDCARD_SPI_CS_PIN
#else
#define SPI_CS_SET  MPU6000_CS_PIN, BMP280_CS_PIN, MAX7456_SPI_CS_PIN, M25P16_CS_PIN
#endif
