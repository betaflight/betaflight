...
const timerHardware_t timerHardware[USABLE_TIMER_CHANNEL_COUNT] = {
    ...
    // Main outputs 6 PWM
	DEF_TIM( TIM8, CH1, PB6, TIM_USE_MOTOR,             TIMER_OUTPUT_ENABLED ),
...
//	DEF_TIM( TIM3, CH2, PC7, TIM_USE_SERVO,             TIMER_OUTPUT_ENABLED ),
	// Additional outputs
	DEF_TIM( TIM16,CH1, PA6, TIM_USE_LED, 				TIMER_OUTPUT_ENABLED ),
	DEF_TIM( TIM17,CH1, PA7, TIM_USE_LED,  				TIMER_OUTPUT_ENABLED ),
};
