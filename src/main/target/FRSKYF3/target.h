...
#define TARGET_BOARD_IDENTIFIER "FrskyF3X8R"  
...
#define MPU6000_CS_PIN          PB12//PC14
...
#endif
//#define BMP280_SPI_INSTANCE     SPI1  (I2C1)
...
#define USE_SPI
//ashang #define USE_SPI_DEVICE_1
...
#define USE_SPI_DEVICE_1 // PB12,13,14,15 on AF5
...
#define SDCARD_SPI_FULL_SPEED_CLOCK_DIVIDER     4   ////(SPI_CLOCK_FAST)  ///////2

#define USE_ESC_SENSOR

// DSHOT output 4 uses DMA1_Channel5, so don't use it for the SDCARD until we find an alternative
#ifndef USE_DSHOT
//ashang #define SDCARD_DMA_CHANNEL_TX               DMA1_Channel5
//ashang #define SDCARD_DMA_CHANNEL_TX_COMPLETE_FLAG DMA1_FLAG_TC5
#endif
...
#define DEFAULT_FEATURES        (FEATURE_VBAT | FEATURE_CURRENT_METER | FEATURE_BLACKBOX | FEATURE_TELEMETRY | FEATURE_LED_STRIP | FEATURE_OSD)

//ASHANG #define BUTTONS
//ASHANG #define BUTTON_A_PIN            PB1
//ASHANG #define BUTTON_B_PIN            PB0

//#define AVOID_UART3_FOR_PWM_PPM // Disable this for using UART3

#define SPEKTRUM_BIND_PIN       UART3_RX_PIN

//ASHANG #define BINDPLUG_PIN            PB0
...
#define USABLE_TIMER_CHANNEL_COUNT 9 // PPM + 6 Outputs (2 shared with UART3)
