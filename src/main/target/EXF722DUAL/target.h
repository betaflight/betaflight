...
#if defined(GEPRCF7DUAL)
#define TARGET_BOARD_IDENTIFIER "GF7D"
#elif defined(IFLIGHTF7DUAL)
#define TARGET_BOARD_IDENTIFIER "IF7D"
#elif defined(TTTRCF7DUAL)
#define TARGET_BOARD_IDENTIFIER "TF7D"
#else
#define TARGET_BOARD_IDENTIFIER "EX7D"
#endif

#if defined(GEPRCF7DUAL)
#define USBD_PRODUCT_STRING "GEPRCF7DUAL"
#elif defined(IFLIGHTF7DUAL)
#define USBD_PRODUCT_STRING "IFLIGHTF7DUAL"
#elif defined(TTTRCF7DUAL)
#define USBD_PRODUCT_STRING "TTTRCF7DUAL"
#else
#define USBD_PRODUCT_STRING "EXF7DUAL"
#endif
