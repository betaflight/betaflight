...
const timerHardware_t timerHardware[USABLE_TIMER_CHANNEL_COUNT] = {
    ...
    DEF_TIM(TIM3, CH3, PB1, TIM_USE_MOTOR | TIM_USE_LED, TIMER_OUTPUT_STANDARD, 0 ), // S5_OUT - DMA1_ST7
    DEF_TIM(TIM3, CH4, PB0, TIM_USE_MOTOR,               TIMER_OUTPUT_STANDARD, 0 ), // S6_OUT - DMA1_ST2
};
