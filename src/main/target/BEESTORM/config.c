...
#define BEST_FRSKY_RSSI_CH_IDX     9
...
void targetConfiguration(void)
{
    ...
    *customMotorMixerMutable(3) = (motorMixer_t){ 1.0f,  0.414178f, -1.0f, -1.0f };    // FRONT_L
    ...
    rxConfigMutable()->rssi_channel = BEST_FRSKY_RSSI_CH_IDX;
    rxFailsafeChannelConfig_t *channelFailsafeConfig = rxFailsafeChannelConfigsMutable(BEST_FRSKY_RSSI_CH_IDX - 1);
