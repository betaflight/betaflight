...
const timerHardware_t timerHardware[USABLE_TIMER_CHANNEL_COUNT] = {
    ...
    DEF_TIM(TIM8, CH2N, PB14, TIM_USE_MOTOR,               TIMER_OUTPUT_ENABLED, 0), // PWM3  - DMA2_ST3, DMA2_ST2
    ...
    DEF_TIM(TIM1, CH3N, PB15, TIM_USE_MOTOR,               TIMER_OUTPUT_ENABLED, 0), // PWM10 - (DMA2_ST6), (DMA2_ST6) - Collision
