...
const timerHardware_t timerHardware[USABLE_TIMER_CHANNEL_COUNT] = {
    ...
    DEF_TIM(TIM3,  CH3, PB0,   TIM_USE_MOTOR,               TIMER_OUTPUT_ENABLED, 0 ), // S5_OUT - DMA1_ST7 - LED Control
    DEF_TIM(TIM3,  CH4, PB1,   TIM_USE_MOTOR | TIM_USE_LED, TIMER_OUTPUT_ENABLED, 0 ), // S6_OUT - DMA1_ST3 - Camera Control
    DEF_TIM(TIM4,  CH2, PB7,   TIM_USE_ANY,                 TIMER_OUTPUT_ENABLED, 0 ), // S7_OUT
    DEF_TIM(TIM12, CH1, PB14,  TIM_USE_BEEPER,              TIMER_OUTPUT_ENABLED, 0 ), // BEEPER PWM
};
