...
#include "serial_post.h"
    ...
    && !defined(USE_ACCGYRO_LSM6DSV320X) \
...
// Generate USE_SPI_GYRO
    ...
    || defined(USE_ACCGYRO_LSM6DSV16X) || defined(USE_ACCGYRO_LSM6DSV320X) || defined(USE_ACCGYRO_LSM6DSO) || defined(USE_ACCGYRO_LSM6DSK320X)
#ifndef USE_SPI_GYRO
#define USE_SPI_GYRO
#endif
#endif
