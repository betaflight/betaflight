...
#if defined(USE_FLASH_M25P16) || defined(USE_FLASH_W25M) || defined(USE_FLASH_W25N01G) || defined(USE_FLASH_W25Q128FV) || defined(USE_FLASH_W25N02K)
#if !defined(USE_FLASH_CHIP)
#define USE_FLASH_CHIP
#endif
#endif

#if defined(USE_SPI) && (defined(USE_FLASH_M25P16) || defined(USE_FLASH_W25M512) || defined(USE_FLASH_W25N01G) || defined(USE_FLASH_W25M02G) || defined(USE_FLASH_W25N02K))
#if !defined(USE_FLASH_SPI)
#define USE_FLASH_SPI
#endif
#endif

#if defined(USE_QUADSPI) && (defined(USE_FLASH_W25Q128FV) || defined(USE_FLASH_W25N01G) || defined(USE_FLASH_W25N02K))
