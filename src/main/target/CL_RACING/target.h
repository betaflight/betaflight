...
#define USBD_PRODUCT_STRING "CL_R"
#ifdef OPBL
...
#define INVERTER                PC0 // PC0 used as inverter select GPIO  for Sbus or Sat rx
...
#define SERIAL_PORT_COUNT      5 //VCP, USART1, USART3  USART4
#define USE_SPI
