...
#define SERIAL_UART_MASK ((SERIAL_UART0_USED * BIT(0)) | (SERIAL_UART1_USED * BIT(1)) | (SERIAL_UART2_USED * BIT(2)) | (SERIAL_UART3_USED * BIT(3)) | (SERIAL_UART4_USED * BIT(4)) | (SERIAL_UART5_USED * BIT(5)) | (SERIAL_UART6_USED * BIT(6)) | (SERIAL_UART7_USED * BIT(7 - 1)) | (SERIAL_UART8_USED * BIT(8)) | (SERIAL_UART9_USED * BIT(9)) | (SERIAL_UART10_USED * BIT(10)))
...
# warning "UART0_RX_PIN is defined but UART1 is not enabled"
#endif
#if !SERIAL_UART0_USED &&  defined(UART0_RX_PIN)
# undef UART0_RX_PIN
#endif
...
# warning "UART0_TX_PIN is defined but UART1 is not enabled"
#endif
#if !SERIAL_UART0_USED &&  defined(UART0_TX_PIN)
# undef UART0_TX_PIN
#endif
