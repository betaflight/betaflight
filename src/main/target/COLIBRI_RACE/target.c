...
const uint16_t multiPPM[] = {
    ...
    PWM10 | (MAP_TO_SERVO_OUTPUT << 8),  // servo #1
    PWM11 | (MAP_TO_SERVO_OUTPUT << 8),  // servo #2
    PWM6  | (MAP_TO_SERVO_OUTPUT << 8),  // servo #3
    PWM7  | (MAP_TO_SERVO_OUTPUT << 8),  // servo #4
    PWM8  | (MAP_TO_SERVO_OUTPUT << 8),  // servo #5
    PWM9  | (MAP_TO_SERVO_OUTPUT << 8),  // servo #6
    0xFFFF
};
...
const uint16_t airPPM[] = {
    ...
    PWM4  | (MAP_TO_SERVO_OUTPUT << 8),  // servo #4
    PWM5  | (MAP_TO_SERVO_OUTPUT << 8),  // servo #5
    PWM10 | (MAP_TO_SERVO_OUTPUT << 8),  // servo #1
    PWM11 | (MAP_TO_SERVO_OUTPUT << 8),  // servo #2
    PWM6  | (MAP_TO_SERVO_OUTPUT << 8),  // servo #3
    PWM7  | (MAP_TO_SERVO_OUTPUT << 8),  // servo #6
    PWM8  | (MAP_TO_SERVO_OUTPUT << 8),  // servo #7
    PWM9  | (MAP_TO_SERVO_OUTPUT << 8),  // servo #8
    0xFFFF
};
...
const timerHardware_t timerHardware[USABLE_TIMER_CHANNEL_COUNT] = {
    ...
    { TIM8,  IO_TAG(PC8),  TIM_Channel_3, TIM8_BRK_IRQn,           1, IOCFG_AF_PP,    GPIO_AF_4 }, // PMW4 - PC8
    { TIM8,  IO_TAG(PC9),  TIM_Channel_4, TIM8_BRK_IRQn,           1, IOCFG_AF_PP,    GPIO_AF_4 }, // PWM5 - PC9
