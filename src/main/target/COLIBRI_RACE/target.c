...
const timerHardware_t timerHardware[USABLE_TIMER_CHANNEL_COUNT] = {
    ...
    { TIM2,  IO_TAG(PA0),  TIM_Channel_1, 1, IOCFG_AF_PP,    GPIO_AF_1, TIM_USE_MC_MOTOR | TIM_USE_MC_SERVO }, // PWM6 - PA0
    { TIM2,  IO_TAG(PA1),  TIM_Channel_2, 1, IOCFG_AF_PP,    GPIO_AF_1, TIM_USE_MC_MOTOR | TIM_USE_MC_SERVO }, // PWM7 - PA1
    { TIM2,  IO_TAG(PA2),  TIM_Channel_3, 1, IOCFG_AF_PP,    GPIO_AF_1, TIM_USE_MC_MOTOR | TIM_USE_MC_SERVO }, // PWM8 - PA2
    { TIM2,  IO_TAG(PA3),  TIM_Channel_4, 1, IOCFG_AF_PP,    GPIO_AF_1, TIM_USE_MC_MOTOR | TIM_USE_MC_SERVO }, // PWM9 - PA3
