...
const timerHardware_t timerHardware[USABLE_TIMER_CHANNEL_COUNT] = {
    ...
    { TIM8,  IO_TAG(PC8),  TIM_Channel_3, TIM_USE_MOTOR,                1, GPIO_AF_TIM8,  DMA2_Stream4, DMA_Channel_7, DMA2_ST4_HANDLER }, // ESC 3
    { TIM8,  IO_TAG(PC9),  TIM_Channel_4, TIM_USE_MOTOR,                1, GPIO_AF_TIM8,  DMA2_Stream7, DMA_Channel_7, DMA2_ST7_HANDLER }, // ESC 4
