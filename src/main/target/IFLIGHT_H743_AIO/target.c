...
const timerHardware_t timerHardware[USABLE_TIMER_CHANNEL_COUNT] = {
    ...
    DEF_TIM( TIM3, CH1, PB4,  TIM_USE_MOTOR,           0,  4,  0 ), // M5
    DEF_TIM( TIM3, CH2, PB5,  TIM_USE_MOTOR,           0,  5,  0 ), // M6
    DEF_TIM( TIM1, CH3, PE13, TIM_USE_MOTOR,           0,  6,  0 ), // M7
    DEF_TIM( TIM1, CH4, PE14, TIM_USE_MOTOR,           0,  7,  0 ), // M8
};
