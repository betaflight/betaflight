...
const timerHardware_t timerHardware[USABLE_TIMER_CHANNEL_COUNT] = {
    ...
    DEF_TIM(TIM2,  CH1,  PA0,  TIM_USE_SERVO, 1 ),  // PWM1 [TIM2_CH1 (D1_CH5)]
    DEF_TIM(TIM2,  CH2,  PA1,  TIM_USE_SERVO, 1 ),  // PWM2 [TIM2_CH2 (D1_CH7)] [TIM15_CH1N (D1_CH5)]
    DEF_TIM(TIM2,  CH3,  PA2,  TIM_USE_SERVO, 1 ),  // PWM3 [TIM2_CH3 (D1_CH1)] [TIM15_CH1  (D1_CH5)]
    DEF_TIM(TIM15, CH2,  PA3,  TIM_USE_SERVO, 1 ),  // PWM4 [TIM2_CH4 (D1_CH7)]
    DEF_TIM(TIM16, CH1,  PA6,  TIM_USE_SERVO, 1 ),  // PWM5 [TIM16_CH1  (D1_CH3 / D1_CH6)] [TIM3_CH1 (D1_CH6)]
