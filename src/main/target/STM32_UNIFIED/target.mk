...
ifeq ($(TARGET), STM32F411_CC2500)
F411_TARGETS += $(TARGET)

else
ifeq ($(TARGET), STM32F411_SX12XX)
F411_TARGETS += $(TARGET)
...
ifeq ($(TARGET), STM32F7X2_CC2500)
F7X2RE_TARGETS += $(TARGET)

else
ifeq ($(TARGET), STM32F7X2_SX12XX)
F7X2RE_TARGETS += $(TARGET)
...
ifeq ($(TARGET), STM32G47X_CC2500)
G47X_TARGETS += $(TARGET)

else
ifeq ($(TARGET), STM32G47X_SX12XX)
G47X_TARGETS += $(TARGET)
...
ifeq ($(TARGET), $(filter $(TARGET), STM32G47X STM32G47X_CC2500 STM32G47X_SX12XX))
