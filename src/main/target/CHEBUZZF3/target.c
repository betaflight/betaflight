...
const timerHardware_t timerHardware[USABLE_TIMER_CHANNEL_COUNT] = {
    ...
    { TIM15, IO_TAG(PF9),  TIM_Channel_1, TIM1_BRK_TIM15_IRQn,     0, IOCFG_AF_PP_PD, }, // PWM7 - PF9
    { TIM15, IO_TAG(PF10), TIM_Channel_2, TIM1_BRK_TIM15_IRQn,     0, IOCFG_AF_PP_PD, }, // PWM8 - PF10
    ...
    { TIM2,  IO_TAG(PA3),  TIM_Channel_4, TIM2_IRQn,               0, IOCFG_AF_PP,    }, // PWM15 - PA3
    { TIM3,  IO_TAG(PB0),  TIM_Channel_3, TIM3_IRQn,               0, IOCFG_AF_PP,    }, // PWM16 - PB0
    { TIM3,  IO_TAG(PB1),  TIM_Channel_4, TIM3_IRQn,               0, IOCFG_AF_PP,    }, // PWM17 - PB1
    { TIM3,  IO_TAG(PA4),  TIM_Channel_2, TIM3_IRQn,               0, IOCFG_AF_PP,    }  // PWM18 - PA4
};
