...
const timerHardware_t timerHardware[USABLE_TIMER_CHANNEL_COUNT] = {
    DEF_TIM(TIM4, CH3,  PB8,  TIM_USE_PPM | TIM_USE_LED,   TIMER_INPUT_ENABLED,                           1), // PPM   - DMA2_ST6, *DMA2_ST1, DMA2_ST3


	DEF_TIM(TIM2, CH4,  PA3,  TIM_USE_MOTOR,               TIMER_OUTPUT_ENABLED,                          0), // PWM1  - DMA2_ST2, DMA2_ST2
    DEF_TIM(TIM3, CH3,  PC8,  TIM_USE_MOTOR,               TIMER_OUTPUT_ENABLED,                          0), // PWM2  - DMA2_ST3, DMA2_ST2
    DEF_TIM(TIM2, CH3,  PA2,  TIM_USE_MOTOR,               TIMER_OUTPUT_ENABLED, 						  0), // PWM3  - DMA2_ST6, DMA2_ST2
    DEF_TIM(TIM3, CH4,  PC9,  TIM_USE_MOTOR,               TIMER_OUTPUT_ENABLED,                          0), // PWM4  - DMA1_ST7
