...
#define STR_OSD_ARMED                 TR2("AKTIVERET", "*** AKTIVERET ***") 	// Max length: 10; translation of: ARMED; HD> Max length: 20; HD translation of: *** ARMED ***
#define STR_OSD_STATS                 TR2("- STATISTIK -", "--- STATISTIK ---") 	// Max length: 39; description; HD> Max length: 39; description
#define STR_OSD_TIM_SOURCE_1          TR2("ON TIME ", "ON TIME ")           	// Max length: 25; description; HD> Max length: 25; description
#define STR_OSD_TIM_SOURCE_2          TR2("TOTAL AKT", "TOTAL AKTIVERET")   	// Max length: 33; description; HD> Max length: 33; description
#define STR_OSD_TIM_SOURCE_3          TR2("SIDST AKT", "SIDST AKTIVERET")   	// Max length: 33; description; HD> Max length: 33; description
#define STR_OSD_TIM_SOURCE_4          TR2("TIL/AKT ", "TIL/AKTIVERET ")     	// Max length: 31; description; HD> Max length: 31; description
#define STR_OSD_STAT_MAX_ALTITUDE     TR2("MAX HOEJDE", "MAXIMAL HOEJDE")   	// Max length: 33; description; HD> Max length: 33; description
#define STR_OSD_STAT_MAX_SPEED        TR2("MAX FART", "MAXIMAL FART")       	// Max length: 29; description; HD> Max length: 29; description
#define STR_OSD_STAT_MAX_DISTANCE     TR2("MAX DISTANCE", "MAXIMAL DISTANCE") 	// Max length: 37; description; HD> Max length: 37; description
...
#define STR_OSD_STAT_MAX_CURRENT      TR2("MAX STROEM", "MAXIMAL STROEM")   	// Max length: 33; description; HD> Max length: 33; description
...
#define STR_OSD_STAT_MAX_G_FORCE      TR2("MAX G-KRAFT", "MAXIMAL G-KRAFT") 	// Max length: 35; description; HD> Max length: 35; description
#define STR_OSD_STAT_MAX_ESC_TEMP     TR2("MAX ESC TEMP", "MAXIMAL ESC TEMP") 	// Max length: 37; description; HD> Max length: 37; description
#define STR_OSD_STAT_MAX_ESC_RPM      TR2("MAX ESC RPM", "MAXIMAL ESV RPM") 	// Max length: 35; description; HD> Max length: 35; description
...
#define STR_OSDW_RESCUE_NA            TR2("FEJLSIKRING N/A", "FEJLSIKRING IKKE MULIG") 	// Max length: 46; description; HD> Max length: 46; description
...
#define STR_OSDE_DISARMED             TR2("EJ AKTIV)", "*** DEAKTIVERET ***") 	// Max length: 36; description; HD> Max length: 36; description
...
#define STR_OSDE_RATE                 TR2("HAST_", "HASTIGHED_")            	// Max length: 24; description; HD> Max length: 24; description
...
#define STR_ODSE_ANTIGRAVITY          TR2("AT", "ANTI G")                   	// Max length:  2; description; HD> Max length:  6; HD translation of: ANTI G
