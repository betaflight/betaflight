...
#define TR_CLI_PARSINGFAIL          "PARSING FEJLET"
#define TR_CLI_INVALIDRESSOURCE     "UGYLDIGT RESOURCE NAVN: '%s'"
#define TR_CLI_ARG_INVALIDCOUNT     "UGYLDIGT ANTAL ARGUMENTER"
#define TR_CLI_ARG_INVALIDRANGE     "%s ER IKKE MELLEM %d OG %d"
#define TR_CLI_ARG_OUTOFRANGE       "ARGUMENT UDENFOR INTERVAL"
...
#define TR_CLI_STATUS_ARM_DISABLE   "Aktiver IKKE flag:"
...
#define TR_CLI_SDCARD_NAME          "SD kort: "
#define TR_CLI_SDCARD_NOCONFIG      "Ikke konfigureret"
#define TR_CLI_SDCARD_NONE          "Ikke indsat"
#define TR_CLI_SDCARD_NOSTART       "Startop fejlet"
#define TR_CLI_SDCARD_MANUFAC       "Producent 0x%x, %ukB, %02d/%04d, v%d.%d, '"
#define TR_CLI_SDCARD_FILESYSTEM    "'\r\n" "Filsystem: "
#define TR_CLI_SDCARD_READY         "Klart"
#define TR_CLI_SDCARD_INIT          "Initialiserer"
#define TR_CLI_SDCARD_FATAL         "Fejlet helt"
#define TR_CLI_SDCARD_NOFATMBR      " - ingen FAT MBR partitioner"
#define TR_CLI_SDCARD_BADFAT        " - fejlagtig FAT blok"

#define TR_CLI_FLASH_INFO           "Flash sektorer=%u, sektorStoerrelse=%u, siderPerSektor=%u, sideStoerrelse=%u, totalStoerrelse=%u JEDEC ID=0x%08x"
#define TR_CLI_FLASH_PART           "Partitioner:"
#define TR_CLI_FLASH_SIZE           "FlashFS stoerrelse=%u, brugtStoerrelse=%u"
#define TR_CLI_FLASH_ER_LONG        "Sletter, vent venligst ... "
#define TR_CLI_FLASH_ER_SHORT       "Sletter,"
#define TR_CLI_FLASH_ER_DONE        "Faerdig."
#define TR_CLI_FLASH_VR             "Kontrollerer"
#define TR_CLI_FLASH_VR_OK          "Succes"
#define TR_CLI_FLASH_VR_FAIL        "Fejlet"
#define TR_CLI_FLASH_WROTE          "Skrevet %u bytes ved %u."
#define TR_CLI_FLASH_READ           "Laest %u bytes ved %u:"

#define TR_CLI_ENABLED              "Aktiveret"
#define TR_CLI_DISABLED             "Deaktiveret"
#define TR_CLI_AVAILABLE            "Mulige:"
#define TR_CLI_UNAVAILABLE          "Ikke mulig"
#define TR_CLI_NOSUPPORT            "Ikke understoettet."
