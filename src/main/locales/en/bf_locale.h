...
#define STR_CLI_ARG_NOTBETWEEN        "NOT BETWEEN"                         	// Max length: 35; translation of: NOT BETWEEN;
#define STR_CLI_ARG_AND               "AND"                                 	// Max length:  3; translation of: AND;
#define STR_CLI_ARG_OUTOFRANGE        "ARGUMENT OUT OF RANGE"               	// Max length: 35; translation of: ARGUMENT OUT OF RANGE;
#define STR_CLI_DSHOT_READ            "Dshot reads:"                        	// Max length: 15; translation of: Dshot reads:;
#define STR_CLI_DSHOT_INVALID_PKT     "Dshot invalid pkts:"                 	// Max length: 20; translation of: Dshot invalid pkts:;
#define STR_CLI_DSHOT_DIR_CHANGE      "Dshot directionChange cycles:"       	// Max length: 29; translation of: Dshot directionChange cycles:;
#define STR_CLI_DSHOT_DIR_CHANGE_MIC  ", micros:"                           	// Max length: 10; translation of: , micros:;
#define STR_CLI_DSHOT_HEAD1           "Motor    Type   eRPM    RPM     Hz Invalid   TEMP    VCC   CURR  ST/EV   DBG1   DBG2   DBG3" 	// Max length:115; translation of: Motor    Type   eRPM    RPM     Hz Invalid   TEMP    VCC   CURR  ST/EV   DBG1   DBG2   DBG3;
#define STR_CLI_DSHOT_LINE1           "=====  ====== ====== ====== ====== ======= ====== ====== ====== ====== ====== ====== ======" 	// Max length:115; translation of: =====  ====== ====== ====== ====== ======= ====== ====== ====== ====== ====== ====== ======;
#define STR_CLI_DSHOT_HEAD2           "Motor    Type   eRPM    RPM     Hz   TEMP    VCC   CURR  ST/EV   DBG1   DBG2   DBG3" 	// Max length:115; translation of: Motor    Type   eRPM    RPM     Hz   TEMP    VCC   CURR  ST/EV   DBG1   DBG2   DBG3;
#define STR_CLI_DSHOT_LINE2           "=====  ====== ====== ====== ====== ====== ====== ====== ====== ====== ====== ======" 	// Max length:115; translation of: =====  ====== ====== ====== ====== ====== ====== ====== ====== ====== ====== ======;
#define STR_CLI_DSHOT_NO_TELEM        "Dshot telemetry not enabled"         	// Max length: 30; translation of: Dshot telemetry not enabled;
#define STR_CLI_STORAGE_NOTFOUND      "Storage not present or failed to initialize!" 	// Max length: 50; translation of: Storage not present or failed to initialize!;
...
#define STR_CLI_STATUS_STACK_SIZE     "Stack size:"                         	// Max length: 15; translation of: Stack size:;
#define STR_CLI_STATUS_STACK_ADDR     "Stack address:"                      	// Max length: 15; translation of: Stack address:;
#define STR_CLI_STATUS_STACK_USED     "Stack used:"                         	// Max length: 15; translation of: Stack used:;
#define STR_CLI_STATUS_CONFIG         "Configuration:"                      	// Max length: 15; translation of: Configuration:;
...
#define STR_CLI_STATUS_CPU_SYSTEM     "System rate:"                        	// Max length: 12; translation of: System rate:;
#define STR_CLI_STATUS_BAT_VOLTAGE    "Voltage:"                            	// Max length:  8; translation of: Voltage:;
#define STR_CLI_STATUS_BAT_TYPE       "battery"                             	// Max length:  7; translation of: battery;
#define STR_CLI_STATUS_FLASH          "FLASH: JEDEC ID="                    	// Max length: 16; translation of: FLASH: JEDEC ID=;
#define STR_CLI_TASK_LATE_LIST        "Task list             rate/hz  max/us  avg/us maxload avgload  total/ms   late    run reqd/us" 	// Max length:115; translation of: Task list             rate/hz  max/us  avg/us maxload avgload  total/ms   late    run reqd/us;
#define STR_CLI_TASK_LIST             "Task list             rate/hz  max/us  avg/us maxload avgload  total/ms" 	// Max length:100; translation of: Task list             rate/hz  max/us  avg/us maxload avgload  total/ms;
#define STR_CLI_TASK_MINIMAL          "Task list"                           	// Max length: 10; translation of: Task list;
#define STR_CLI_TASK_RX_CHECK         "RX Check Function"                   	// Max length: 20; translation of: RX Check Function;
#define STR_CLI_TASK_TOTAL            "Total (excluding SERIAL)"            	// Max length: 25; translation of: Total (excluding SERIAL);
#define STR_CLI_TASK_SCHEDULER_START  "Scheduler start cycles"              	// Max length: 25; translation of: Scheduler start cycles;
#define STR_CLI_TASK_SCHEDULER_GAURD  "guard cycles"                        	// Max length: 12; translation of: guard cycles;
#define STR_CLI_VERSION_HAS_CONFIG    "config: YES"                         	// Max length: 15; translation of: config: YES;
...
#define STR_CLI_TIMERS_FREE           " FREE"                               	// Max length:  6; translation of:  FREE;
#define STR_CLI_STATUS_ARM_DISABLE    "Arming disable flags:"               	// Max length: 25; translation of: Arming disable flags;
#define STR_CLI_DSHOT_TEL_INFO        " NO DATA"                            	// Max length: 10; translation of:  NO DATA;
#define STR_CLI_MSC_TIMEZONE          "INVALID TIMEZONE OFFSET"             	// Max length: 25; translation of: INVALID TIMEZONE OFFSET;
#define STR_CLI_MSC_RESTART           "Restarting in mass storage mode"     	// Max length: 35; translation of: Restarting in mass storage mode;
#define STR_CLI_MSC_REBOOT            "\r\nRebooting"                       	// Max length: 15; translation of: \r\nRebooting;
#define STR_CLI_PROCESS               "UNKNOWN COMMAND, TRY 'HELP'"         	// Max length: 30; translation of: UNKNOWN COMMAND, TRY 'HELP';
#define STR_CLI_ENTER_LONG            "\r\nEntering CLI Mode, type 'exit' to return, or 'help'" 	// Max length: 75; translation of: \r\nEntering CLI Mode, type 'exit' to return, or 'help';
#define STR_CLI_ENTER_SHORT           "\r\nCLI"                             	// Max length: 10; translation of: \r\nCLI;
#define STR_CLI_SDCARD_NAME           "SD card: "                           	// Max length: 10; translation of: SD card: ;
#define STR_CLI_SDCARD_NOCONFIG       "Not configured"                      	// Max length: 20; translation of: Not configured;
#define STR_CLI_SDCARD_NONE           "None inserted"                       	// Max length: 20; translation of: None inserted;
#define STR_CLI_SDCARD_NOSTART        "Startup failed"                      	// Max length: 20; translation of: Startup failed;
#define STR_CLI_SDCARD_MANUFAC        "Manufacturer"                        	// Max length: 15; translation of: Manufacturer;
#define STR_CLI_SDCARD_FILESYSTEM     "\r\nFilsystem: "                     	// Max length: 15; translation of: \r\nFilsystem: ;
#define STR_CLI_SDCARD_READY          "Ready"                               	// Max length:  5; translation of: Ready;
#define STR_CLI_SDCARD_INIT           "Initializing"                        	// Max length: 15; translation of: Initializing;
#define STR_CLI_SDCARD_FATAL          "Fatal"                               	// Max length: 15; translation of: Fatal;
#define STR_CLI_SDCARD_NOFATMBR       " - no FAT MBR partitions"            	// Max length: 30; translation of:  - no FAT MBR partitions;
#define STR_CLI_SDCARD_BADFAT         " - bad FAT header"                   	// Max length: 30; translation of:  - bad FAT header;
#define STR_CLI_FLASH_SEC             "Flash sectors="                      	// Max length: 30; translation of: Flash sectors=;
#define STR_CLI_FLASH_SEC_SIZE        "sectorSize="                         	// Max length: 11; translation of: sectorSize=;
#define STR_CLI_FLASH_SEC_PAGE        "pagesPerSector="                     	// Max length: 15; translation of: pagesPerSector=;
#define STR_CLI_FLASH_PAGE_SIZE       "pageSize="                           	// Max length: 10; translation of: pageSize=;
#define STR_CLI_FLASH_TOTAL_SIZE      "totalSize="                          	// Max length: 10; translation of: totalSize=;
#define STR_CLI_FLASH_JEDEC           "JEDEC ID="                           	// Max length: 10; translation of: JEDEC ID=;
#define STR_CLI_FLASH_PART            "Partitions:"                         	// Max length: 15; translation of: Partitions:;
#define STR_CLI_FLASH_SIZE            "FlashFS size="                       	// Max length: 15; translation of: FlashFS size=;
#define STR_CLI_FLASH_SIZE_USED       "usedSize="                           	// Max length: 15; translation of: usedSize=;
#define STR_CLI_FLASH_ER_LONG         "Erasing, please wait ... "           	// Max length: 30; translation of: Erasing, please wait ... ;
#define STR_CLI_FLASH_ER_SHORT        "Erasing,"                            	// Max length: 15; translation of: Erasing,;
#define STR_CLI_FLASH_ER_DONE         "Done."                               	// Max length: 10; translation of: Done.;
#define STR_CLI_FLASH_VR              "Verifying"                           	// Max length: 15; translation of: Verifying;
#define STR_CLI_FLASH_VR_OK           "Success"                             	// Max length: 15; translation of: Success;
#define STR_CLI_FLASH_VR_FAIL         "Failed"                              	// Max length: 15; translation of: Failed;
#define STR_CLI_FLASH_WROTE           "Wrote"                               	// Max length: 10; translation of: Wrote;
#define STR_CLI_FLASH_READ            "Reading"                             	// Max length: 10; translation of: Reading;
#define STR_CLI_FLASH_BYTES_AT        "bytes at:"                           	// Max length: 10; translation of: bytes at:;
#define STR_CLI_ENABLED               "Enabled"                             	// Max length: 15; translation of: Enabled;
#define STR_CLI_DISABLED              "Disabled"                            	// Max length: 15; translation of: Disabled;
