...
#define MSP_GPS_RESCUE           135    //out message         GPS Rescues angle, returnAltitude, descentDistance, rescueGroundSpeed, sanityChecks and minSats
...
#define MSP_SET_GPS_RESCUE       225    //in message          GPS Rescues's angle, returnAltitude, descentDistance, rescueGroundSpeed and sanityChecks
