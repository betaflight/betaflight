...
typedef struct telemetryConfig_s {
    ...
    uint8_t mavlink_txbuff_change; // TX buffer space change during one telemetries transmit loop (approximately) 0...100%
    uint8_t mavlink_txbuff_margin; // TX buffer space margin to send mavlink telemetry data 1...100%
} telemetryConfig_t;
