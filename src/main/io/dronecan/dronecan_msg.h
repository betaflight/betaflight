...
// pressure. Multi-frame: uint5 flags, float32 static_pressure, float32
...
#define RAWAIRDATA_OFFSET_STATIC_P      5U      // 32 bits float32, Pa
#define RAWAIRDATA_OFFSET_DIFF_P        37U     // 32 bits float32, Pa
#define RAWAIRDATA_OFFSET_DIFF_TEMP     85U     // 16 bits float16, K (diff-pressure sensor)
