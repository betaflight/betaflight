...
static const uint8_t ubloxInit[] = {
    ...
    0x00, 0xC8, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x1A, 0x28,
     ...
     //Preprocessor Airborne_2g Dynamic Platform Model Option
    #elif defined(GPS_UBLOX_MODE_AIRBORNE_2G)
	// CFG-NAV5 - Set engine settings, Airborn <2g(100m/s horiz, 50m/s vert., medium position deviation, low latency). Captured with NEO M8M (popular chineese M8N-Fake), u-center 8.25
	0xB5, 0x62, 0x06, 0x24, 0x24, 0x00, 0xFF, 0xFF, 0x07, 0x03, 0x00, 0x00, 0x00, 0x00, 0x10, 0x27,
	0x00, 0x00, 0x05, 0x00, 0xFA, 0x00, 0xFA, 0x00, 0x64, 0x00, 0x5E, 0x01, 0x00, 0x3C, 0x00, 0x00,
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x85, 0x2A,
	...
	// for M8M. set GLONASS on, Galileo on, BeiDou off, Auto Channels
	...
	0x01, 0x01, 0x06, 0x08, 0x0E, 0x00, 0x01, 0x00, 0x01, 0x01, 0x30, 0xAD,
};
    ...
    *gpsPacketLogChar = LOG_IGNORED;
    ...
    case MSG_POSLLH:
        *gpsPacketLogChar = LOG_UBLOX_POSLLH;
        ...
        gpsSol.llh.alt = _buffer.posllh.altitude_msl / 100;  //alt in 0.1m
        if (next_fix) {
            ENABLE_STATE(GPS_FIX);
        } else {
            DISABLE_STATE(GPS_FIX);
