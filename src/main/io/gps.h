...
typedef enum {
    ...
    CFG_SBAS_USE_TESTMODE = 0x10360002,
    CFG_SBAS_USE_RANGING = 0x10360003,
    CFG_SBAS_USE_DIFFCORR = 0x10360004,
    CFG_SBAS_USE_INTEGRITY = 0x10360005,
    CFG_SBAS_PRNSCANMASK = 0x50360006,
} ubxValsetBytes_e;
