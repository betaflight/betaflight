...
static const char * const featureNames[] = {
    ...
    "RX_MSP", "RSSI_ADC", "LED_STRIP", "DISPLAY",
...
static void printLed(uint8_t dumpMask, master_t *defaultConfig)
{
	...
	ledConfigDefault = &defaultConfig->ledConfigs[i];
        equalsDefault = ledConfig->xy == ledConfigDefault->xy
            && ledConfig->color == ledConfigDefault->color
            && ledConfig->flags == ledConfigDefault->flags;
