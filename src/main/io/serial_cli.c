...
const clivalue_t valueTable[] = {
	...
	{ "telemetry_flvss_cells",      VAR_UINT8  | MASTER_VALUE | MODE_LOOKUP, .config.lookup = { TABLE_OFF_ON } , PG_TELEMETRY_CONFIG, offsetof(telemetryConfig_t, telemetry_flvss_cells)},
