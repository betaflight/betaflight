...
const clivalue_t valueTable[] = {
    ...
    { "servo_notch_freq_idx",       VAR_INT16  | PROFILE_VALUE, &masterConfig.profile[0].mixerConfig.servo_notch_freq_idx, 0, 99 },
    { "servo_notch_enable",         VAR_INT8   | PROFILE_VALUE, &masterConfig.profile[0].mixerConfig.servo_notch_enable, 0, 1 },
