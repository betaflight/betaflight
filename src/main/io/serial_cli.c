...
const clivalue_t valueTable[] = {
    ...
    { "flashchip_id",                VAR_UINT32 | MASTER_VALUE, .config.minmax = { 0,  0xffffff } ,   PG_SYSTEM_CONFIG, offsetof(systemConfig_t, flashchip_id)},
    { "flashchip_nsect",             VAR_UINT16 | MASTER_VALUE, .config.minmax = { 0,  0xffff } ,   PG_SYSTEM_CONFIG, offsetof(systemConfig_t, flashchip_nsect)},
    { "flashchip_pps",               VAR_UINT16 | MASTER_VALUE, .config.minmax = { 0,  0xffff } ,   PG_SYSTEM_CONFIG, offsetof(systemConfig_t, flashchip_pps)},
#endif
