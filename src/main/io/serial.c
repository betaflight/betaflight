...
#ifdef TELEMETRY
#define ALL_FUNCTIONS_SHARABLE_WITH_MSP (FUNCTION_BLACKBOX | TELEMETRY_SHAREABLE_PORT_FUNCTIONS_MASK)
#else
...
bool isSerialConfigValid(serialConfig_t *serialConfigToCheck)
{
     ...
     * - unidirectional telemetry (FrSky / LTM / MAVLink) can be shared with MSP or serial RX
     * - MSP can be shared with blackbox
