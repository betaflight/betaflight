...
#if defined(USE_LPUART1) && (defined(USE_LPUART1_TX_PIN) || defined(USE_LPUART1_RX_PIN))

#define SERIAL_PORT_IDENTIFIER_TO_INDEX(x) (((x) <= SERIAL_PORT_USART_MAX) ? ((x) - SERIAL_PORT_USART1) : ((x) - SERIAL_PORT_LPUART1))
#define SERIAL_PORT_IDENTIFIER_TO_UARTDEV(x) (((x) <= SERIAL_PORT_USART_MAX) ? ((x) - SERIAL_PORT_USART1 + UARTDEV_1) : ((x) - SERIAL_PORT_LPUART1) + LPUARTDEV_1)
