...
typedef enum {
    VTX_TX805_PIT_MODE_OFF = 0,
    VTX_TX805_PIT_MODE_PIR,
    VTX_TX805_PIT_MODE_POR,
} vtxTx805PitMode_e;
#endif
...
#ifdef USE_VTX_SMARTAUDIO
    uint8_t tx805PitMode;   // support non-standard Eachine TX805 pit mode behavior, from vtxTx805PitMode_e
#endif
} vtxSettingsConfig_t;
