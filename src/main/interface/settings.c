...
// PG_OSD_CONFIG
    ...
    { "osd_warn_constant_idle",     VAR_UINT16  | MASTER_VALUE | MODE_BITSET, .config.bitpos = OSD_WARNING_CONSTANT_IDLE,    PG_OSD_CONFIG, offsetof(osdConfig_t, enabledWarnings)},    { "osd_warn_esc_fail",          VAR_UINT16  | MASTER_VALUE | MODE_BITSET, .config.bitpos = OSD_WARNING_ESC_FAIL,         PG_OSD_CONFIG, offsetof(osdConfig_t, enabledWarnings)},
