...
// PG_PID_PROFILE
    ...
    { "iterm_relax_lowpass",        VAR_UINT8  | PROFILE_VALUE, .config.minmax = { 1, 50 }, PG_PID_PROFILE, offsetof(pidProfile_t, iterm_relax_lowpass) },
    { "iterm_relax_cutoff",         VAR_UINT8  | PROFILE_VALUE, .config.minmax = { 1, 255 }, PG_PID_PROFILE, offsetof(pidProfile_t, iterm_relax_cutoff) },
