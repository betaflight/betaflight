...
static const char * const lookupTablePreLowpassType[] = {
    "FKF", "PT1"
};
...
const lookupTableEntry_t lookupTables[] = {
    ...
    { lookupTablePreLowpassType, sizeof(lookupTablePreLowpassType) / sizeof(char *) },
...
// PG_GYRO_CONFIG
    ...
    { "gyro_pre_lowpass_type",          VAR_UINT8  | MASTER_VALUE | MODE_LOOKUP, .config.lookup = { TABLE_PRE_LOWPASS_TYPE }, PG_GYRO_CONFIG, offsetof(gyroConfig_t, gyro_soft_pre_lpf_type) },
    { "gyro_pre_lowpass_hz",     VAR_UINT16 | MASTER_VALUE, .config.minmax = { 0, 16000 }, PG_GYRO_CONFIG, offsetof(gyroConfig_t, gyro_soft_pre_lpf_hz) },
    ...
    { "gyro_lowpass_hz",            VAR_UINT16  | MASTER_VALUE, .config.minmax = { 0, 16000 }, PG_GYRO_CONFIG, offsetof(gyroConfig_t, gyro_soft_lpf_hz) },
