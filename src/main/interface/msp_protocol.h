...
#define MSP_GPS_RESCUE           135    //out message         GPS Rescues's angle, initialAltitude, descentDistance and rescueGroundSpeed
#define MSP_GPS_RESCUE_PIDS      136    //out message         GPS Rescues's PIDS
...
#define MSP_SET_GPS_RESCUE       225    //in message          GPS Rescues's angle, initialAltitude, descentDistance and rescueGroundSpeed
#define MSP_SET_GPS_RESCUE_PIDS  226    //in message          GPS Rescues's PIDS
