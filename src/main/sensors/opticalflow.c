...
void opticalflowProcess(void) {
    ...
    if (deltaTimeUs != 0) { // New data
        ...
        DEBUG_SET(DEBUG_OPTICALFLOW, 2, lrintf(DEGREES_TO_RADIANS(delayedGyroRotated.x) * 1000));  //!< Gyro Compensation X [0.001rad/s]
        DEBUG_SET(DEBUG_OPTICALFLOW, 3, lrintf(DEGREES_TO_RADIANS(delayedGyroRotated.y) * 1000));  //!< Gyro Compensation Y [0.001rad/s]
        ...
        DEBUG_SET(DEBUG_OPTICALFLOW, 4, lrintf(processed.x * 1000));  //!< Compensated Flow Rate X [0.001rad/s]
        DEBUG_SET(DEBUG_OPTICALFLOW, 5, lrintf(processed.y * 1000));  //!< Compensated Flow Rate Y [0.001rad/s]
