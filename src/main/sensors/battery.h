...
typedef struct batteryConfig_s {
    ...
    uint16_t cellMinVoltSOC;              // user can set the minimum cell voltage they want for the purposes of battery soc prediction
    uint16_t cellMaxVoltSOC;              // user can set the maximum cell voltage they want for the purposes of battery soc prediction
