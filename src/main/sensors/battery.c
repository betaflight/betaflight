...
void batteryUpdateVoltage(timeUs_t currentTimeUs)
{
    ...
    DEBUG_SET(DEBUG_BATTERY, 0, voltageMeter.unfiltered);                 //!< Battery Voltage Unfiltered [0.01V]
    DEBUG_SET(DEBUG_BATTERY, 1, voltageMeter.displayFiltered);            //!< Battery Voltage [0.01V]
    ...
    DEBUG_SET(DEBUG_BATTERY, 6, voltageMeter.voltageStablePrevFiltered);  //!< Last Stable Battery Voltage [0.01V]
