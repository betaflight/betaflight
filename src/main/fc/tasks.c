...
cfTask_t cfTasks[TASK_COUNT] = {
    ...
    [TASK_BATTERY_VOLTAGE] = DEFINE_TASK("BATTERY_VOLTAGE", NULL, NULL, batteryUpdateVoltage, TASK_PERIOD_HZ(500), TASK_PRIORITY_MEDIUM),//wooooork.
    [TASK_BATTERY_CURRENT] = DEFINE_TASK("BATTERY_CURRENT", NULL, NULL, batteryUpdateCurrentMeter, TASK_PERIOD_HZ(500), TASK_PRIORITY_MEDIUM), 
