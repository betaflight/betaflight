...
// PG_GYRO_CONFIG
    ...
    { "enable_gyro_notch1",         VAR_UINT8  | MASTER_VALUE | MODE_LOOKUP, .config.lookup = { TABLE_OFF_ON }, PG_GYRO_CONFIG, offsetof(gyroConfig_t, enable_gyro_soft_notch_1) },
    ...
    { "enable_gyro_notch2",         VAR_UINT8  | MASTER_VALUE | MODE_LOOKUP, .config.lookup = { TABLE_OFF_ON }, PG_GYRO_CONFIG, offsetof(gyroConfig_t, enable_gyro_soft_notch_2) },
...
// PG_PID_PROFILE
    ...
    { "enable_dterm_notch",         VAR_UINT8  | MASTER_VALUE | MODE_LOOKUP, .config.lookup = { TABLE_OFF_ON }, PG_PID_PROFILE, offsetof(pidProfile_t, enable_dterm_notch) },    
