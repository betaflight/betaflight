...
// PG_GYRO_CONFIG
    ...
    { "gyro_notch1_enabled",        VAR_UINT8  | MASTER_VALUE | MODE_LOOKUP, .config.lookup = { TABLE_OFF_ON }, PG_GYRO_CONFIG, offsetof(gyroConfig_t, gyro_soft_notch_enabled_1) },
    ...
    { "gyro_notch2_enabled",        VAR_UINT8  | MASTER_VALUE | MODE_LOOKUP, .config.lookup = { TABLE_OFF_ON }, PG_GYRO_CONFIG, offsetof(gyroConfig_t, gyro_soft_notch_enabled_2) },
...
// PG_PID_PROFILE
    ...
    { "dterm_notch_enabled",        VAR_UINT8  | MASTER_VALUE | MODE_LOOKUP, .config.lookup = { TABLE_OFF_ON }, PG_PID_PROFILE, offsetof(pidProfile_t, dterm_notch_enabled) },    
