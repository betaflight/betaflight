...
static const clivalue_t valueTable[] = {
    ...
    { "mag_i2c_bus",                VAR_INT8    | MASTER_VALUE, &compassConfig()->mag_i2cBus, .config.minmax = { I2CINVALID, I2CDEV_COUNT - 1 } },
#endif
...
#endif
#ifdef USE_OLEDI2C
    { "i2c_bus_oled",               VAR_INT8    | MASTER_VALUE, &oledi2cConfig()->bus, .config.minmax = { I2CINVALID, I2CDEV_COUNT - 1 } },
#endif
};
#endif
