...
static bool mspFcProcessOutCommand(uint8_t cmdMSP, sbuf_t *dst, sbuf_t *src, mspPostProcessFnPtr *mspPostProcessFn)
{
    ...
    case MSP_PID_CONTROLLER:
        sbufWriteU8(dst, currentProfile->pidProfile.pidController);
        break;
    ...
    case MSP_PID_ADVANCED:
        ...
        sbufWriteU8(dst, currentProfile->pidProfile.deltaMethod);
...
static mspResult_e mspFcProcessInCommand(uint8_t cmdMSP, sbuf_t *src)
{
    ...
    case MSP_SET_PID_CONTROLLER:
        ...
        currentProfile->pidProfile.pidController = constrain(sbufReadU8(src), 0, 1);
    ...
    case MSP_SET_PID_ADVANCED:
        ...
        currentProfile->pidProfile.deltaMethod = sbufReadU8(src);
