...
void servoMixer(void)
{
    ...
    if (FLIGHT_MODE(PASSTHRU_MODE)) {
        ...
        input[INPUT_STABILIZED_ROLL] = psasControl.roll.Sum / 100.0f * 500.0f;
        input[INPUT_STABILIZED_PITCH] = psasControl.pitch.Sum / 100.0f * 500.0f;
        input[INPUT_STABILIZED_YAW] = psasControl.yaw.Sum / 100.0f * 500.0f;
    } else {
