...
void servoMixer(void)
{
    ...
    if (FLIGHT_MODE(PASSTHRU_MODE)) {
        ...
        input[INPUT_STABILIZED_ROLL] = pidData[FD_ROLL].PIDSum * PID_SERVO_MIXER_SCALING;
        input[INPUT_STABILIZED_PITCH] = pidData[FD_PITCH].PIDSum * PID_SERVO_MIXER_SCALING;
        input[INPUT_STABILIZED_YAW] = pidData[FD_YAW].PIDSum * PID_SERVO_MIXER_SCALING;
