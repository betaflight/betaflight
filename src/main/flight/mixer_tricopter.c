...
float binarySearchOutput(float yawOutput, float motorWoPitchCorr);
float getPitchCorrectionAtTailAngle(float angle, float thrustFactor);
...
UNIT_TESTED float motorToThrust(float motor) {
