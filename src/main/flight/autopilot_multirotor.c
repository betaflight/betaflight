...
{
    ap.sticksActive = false;
    ap.maxAngle = apConfig()->ap_max_angle;
    altitudePidCoeffs.Kp = apConfig()->ap_altitude_P * ALTITUDE_P_SCALE;
    altitudePidCoeffs.Ki = apConfig()->ap_altitude_I * ALTITUDE_I_SCALE;
    altitudePidCoeffs.Kd = apConfig()->ap_altitude_D * ALTITUDE_D_SCALE;
    altitudePidCoeffs.Kf = apConfig()->ap_altitude_F * ALTITUDE_F_SCALE;
    positionPidCoeffs.Kp = apConfig()->ap_position_P * POSITION_P_SCALE;
    positionPidCoeffs.Ki = apConfig()->ap_position_I * POSITION_I_SCALE;
    positionPidCoeffs.Kd = apConfig()->ap_position_D * POSITION_D_SCALE;
    positionPidCoeffs.Kf = apConfig()->ap_position_A * POSITION_A_SCALE; // Kf used for acceleration
    ...
    ap.vaLpfCutoff = apConfig()->ap_position_cutoff * 0.01f;
