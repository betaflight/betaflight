...
void init(void)
{
    ...
    if (masterConfig.motorAndServoConfig.motor_pwm_protocol == PWM_TYPE_BRUSHED) {
    ...
    if (isMixerUsingServos()) {
        ...
        servoInit(&masterConfig.motorAndServoConfig);
    }
#endif
    ...
    mixerUsePWMOutputConfiguration(servoCount, masterConfig.motorAndServoConfig.use_unsyncedPwm);
