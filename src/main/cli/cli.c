...
#endif
#ifdef USE_UART
    DEFA( OWNER_SERIAL_TX,     PG_SERIAL_PIN_CONFIG, serialPinConfig_t, ioTagTx[0], UART_PORT_COUNT ),
    DEFA( OWNER_SERIAL_RX,     PG_SERIAL_PIN_CONFIG, serialPinConfig_t, ioTagRx[0], UART_PORT_COUNT ),
#endif
#ifdef USE_INVERTER
#ifdef USE_LPUART1
    DEFA( OWNER_INVERTER,      PG_SERIAL_PIN_CONFIG, serialPinConfig_t, ioTagInverter[0], UART_PORT_COUNT + LPUART_PORT_COUNT ),
#else
    DEFA( OWNER_INVERTER,      PG_SERIAL_PIN_CONFIG, serialPinConfig_t, ioTagInverter[0], UART_PORT_COUNT ),
#endif
#endif
...
#endif
#ifdef USE_LPUART1
    DEFA( OWNER_LPUART_TX,     PG_SERIAL_PIN_CONFIG, serialPinConfig_t, ioTagTx[LPUART_FIRST_INDEX], LPUART_PORT_COUNT ),
    DEFA( OWNER_LPUART_RX,     PG_SERIAL_PIN_CONFIG, serialPinConfig_t, ioTagRx[LPUART_FIRST_INDEX], LPUART_PORT_COUNT ),
#endif
#ifdef USE_I2C
