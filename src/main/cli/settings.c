...
// PG_OSD_CONFIG
    ...
    { "osd_custom_frame",           VAR_UINT8  | MASTER_VALUE | MODE_LOOKUP, .config.lookup = { TABLE_OFF_ON }, PG_OSD_CONFIG, offsetof(osdConfig_t, custom_frame_enabled) },
    { "osd_custom_frame_pos_x",     VAR_UINT8  | MASTER_VALUE, .config.minmaxUnsigned = { 0, 63 }, PG_OSD_CONFIG, offsetof(osdConfig_t, custom_frame_pos_x) },
    { "osd_custom_frame_pos_y",     VAR_UINT8  | MASTER_VALUE, .config.minmaxUnsigned = { 0, 31 }, PG_OSD_CONFIG, offsetof(osdConfig_t, custom_frame_pos_y) },
    { "osd_custom_frame_width",     VAR_UINT8  | MASTER_VALUE, .config.minmaxUnsigned = { OSD_CUSTOM_FRAME_MIN_WIDTH, OSD_CUSTOM_FRAME_MAX_WIDTH }, PG_OSD_CONFIG, offsetof(osdConfig_t, custom_frame_width) },
    { "osd_custom_frame_height",    VAR_UINT8  | MASTER_VALUE, .config.minmaxUnsigned = { OSD_CUSTOM_FRAME_MIN_HEIGHT, OSD_CUSTOM_FRAME_MAX_HEIGHT }, PG_OSD_CONFIG, offsetof(osdConfig_t, custom_frame_height) },
