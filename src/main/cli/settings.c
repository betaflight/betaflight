...
#endif
#ifdef USE_PSAS
    { "blackbox_disable_psas",       VAR_UINT32 | MASTER_VALUE | MODE_BITSET, .config.bitpos = FLIGHT_LOG_FIELD_SELECT_PSAS,   PG_BLACKBOX_CONFIG, offsetof(blackboxConfig_t, fields_disabled_mask) },
#endif
...
// PG_PID_PROFILE
    ...
    { PARAM_NAME_PSAS_SPEED_PITCH_STICK_ENABLE, VAR_UINT8 | PROFILE_VALUE | MODE_LOOKUP, .config.lookup = { TABLE_OFF_ON }, PG_PID_PROFILE, offsetof(pidProfile_t, psas_speed_stick_curve_enable[FD_PITCH]) },
    { PARAM_NAME_PSAS_SPEED_PITCH_MAIN_ENABLE,  VAR_UINT8 | PROFILE_VALUE | MODE_LOOKUP, .config.lookup = { TABLE_OFF_ON }, PG_PID_PROFILE, offsetof(pidProfile_t, psas_speed_main_curve_enable[FD_PITCH]) },
    { PARAM_NAME_PSAS_SPEED_ROLL_STICK_ENABLE, VAR_UINT8 | PROFILE_VALUE | MODE_LOOKUP, .config.lookup = { TABLE_OFF_ON }, PG_PID_PROFILE, offsetof(pidProfile_t, psas_speed_stick_curve_enable[FD_ROLL]) },
    { PARAM_NAME_PSAS_SPEED_ROLL_MAIN_ENABLE, VAR_UINT8 | PROFILE_VALUE | MODE_LOOKUP, .config.lookup = { TABLE_OFF_ON }, PG_PID_PROFILE, offsetof(pidProfile_t, psas_speed_main_curve_enable[FD_ROLL]) },
    { PARAM_NAME_PSAS_SPEED_YAW_STICK_ENABLE, VAR_UINT8 | PROFILE_VALUE | MODE_LOOKUP, .config.lookup = { TABLE_OFF_ON }, PG_PID_PROFILE, offsetof(pidProfile_t, psas_speed_stick_curve_enable[FD_YAW]) },
    { PARAM_NAME_PSAS_SPEED_YAW_MAIN_ENABLE, VAR_UINT8 | PROFILE_VALUE | MODE_LOOKUP, .config.lookup = { TABLE_OFF_ON }, PG_PID_PROFILE, offsetof(pidProfile_t, psas_speed_main_curve_enable[FD_YAW]) },
    { PARAM_NAME_PSAS_SPEED_OPTIMUM_VREF, VAR_UINT8 | PROFILE_VALUE, .config.minmaxUnsigned = { 0, UINT8_MAX }, PG_PID_PROFILE, offsetof(pidProfile_t, psas_speed_optimum_vref) },
    { PARAM_NAME_PSAS_SPEED_MAIN_CURVE_POWER, VAR_UINT8 | PROFILE_VALUE, .config.minmaxUnsigned = { 5, 30 }, PG_PID_PROFILE, offsetof(pidProfile_t, psas_speed_main_curve_power) },
    { PARAM_NAME_PSAS_SPEED_ROLL_STICK_CURVE_POWER, VAR_UINT8 | PROFILE_VALUE, .config.minmaxUnsigned = { 5, 30 }, PG_PID_PROFILE, offsetof(pidProfile_t, psas_speed_roll_stick_curve_power) },
    { PARAM_NAME_PSAS_SPEED_MAIN_CURVE_MIN, VAR_UINT16 | PROFILE_VALUE, .config.minmaxUnsigned = { 1, 100 }, PG_PID_PROFILE, offsetof(pidProfile_t, psas_speed_main_curve_min) },
