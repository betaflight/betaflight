...
// PG_PID_PROFILE
    ...
    { PARAM_NAME_ANTI_GRAVITY_THROTTLE_CHANGE_MAX_LIMIT, VAR_UINT8 | PROFILE_VALUE, .config.minmaxUnsigned = { 0, 250 }, PG_PID_PROFILE, offsetof(pidProfile_t, antiGravityThrottleChangeMaxLimit) },
    { PARAM_NAME_ANTI_GRAVITY_PBOOST_MULTIPLIER,         VAR_UINT8 | PROFILE_VALUE, .config.minmaxUnsigned = { 0, 250 }, PG_PID_PROFILE, offsetof(pidProfile_t, antiGravityPboostMultiplier) },
