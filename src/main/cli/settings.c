...
// PG_PID_PROFILE
    ...
    { PARAM_NAME_PSAS_PITCH_STICK_SPEED_ENABLE,     VAR_UINT8 | PROFILE_VALUE | MODE_LOOKUP, .config.lookup = { TABLE_OFF_ON }, PG_PID_PROFILE, offsetof(pidProfile_t, psas_stick_speed_enable[FD_PITCH]) },
    ...
    { PARAM_NAME_PSAS_PITCH_DAMPING_SPEED_ENABLE,     VAR_UINT8 | PROFILE_VALUE | MODE_LOOKUP, .config.lookup = { TABLE_OFF_ON }, PG_PID_PROFILE, offsetof(pidProfile_t, psas_damping_speed_enable[FD_PITCH]) },
    ...
    { PARAM_NAME_PSAS_PITCH_STABILITY_SPEED_ENABLE,     VAR_UINT8 | PROFILE_VALUE | MODE_LOOKUP, .config.lookup = { TABLE_OFF_ON }, PG_PID_PROFILE, offsetof(pidProfile_t, psas_pitch_stability_speed_enable) },
    ...
    { PARAM_NAME_PSAS_YAW_STICK_SPEED_ENABLE,     VAR_UINT8 | PROFILE_VALUE | MODE_LOOKUP, .config.lookup = { TABLE_OFF_ON }, PG_PID_PROFILE, offsetof(pidProfile_t, psas_stick_speed_enable[FD_YAW]) },
    ...
    { PARAM_NAME_PSAS_YAW_DAMPING_SPEED_ENABLE,     VAR_UINT8 | PROFILE_VALUE | MODE_LOOKUP, .config.lookup = { TABLE_OFF_ON }, PG_PID_PROFILE, offsetof(pidProfile_t, psas_damping_speed_enable[FD_YAW]) },
    ...
    { PARAM_NAME_PSAS_YAW_STABILITY_SPEED_ENABLE,     VAR_UINT8 | PROFILE_VALUE | MODE_LOOKUP, .config.lookup = { TABLE_OFF_ON }, PG_PID_PROFILE, offsetof(pidProfile_t, psas_yaw_stability_speed_enable) },
