...
// PG_BATTERY_CONFIG
    ...
    { "cell_min_volt_soc",        VAR_UINT16  | MASTER_VALUE, .config.minmaxUnsigned = { 300, 400 }, PG_BATTERY_CONFIG, offsetof(batteryConfig_t, cellMinVoltSOC) },
    { "cell_max_volt_soc",        VAR_UINT16  | MASTER_VALUE, .config.minmaxUnsigned = { 400, 500 }, PG_BATTERY_CONFIG, offsetof(batteryConfig_t, cellMaxVoltSOC) },
