...
// PG_PID_PROFILE
    ...
    { PARAM_NAME_PSAS_PITCH_STICK_SPEED_ENABLE,     VAR_UINT8 | PROFILE_VALUE, .config.lookup = { TABLE_OFF_ON }, PG_PID_PROFILE, offsetof(pidProfile_t, psas_stick_speed_enable[FD_PITCH]) },
    { PARAM_NAME_PSAS_PITCH_STICK_SPEED_SCALE,      VAR_UINT8 | PROFILE_VALUE, .config.minmaxUnsigned = { 50, 150 }, PG_PID_PROFILE, offsetof(pidProfile_t, psas_stick_speed_scale[FD_PITCH]) },
    ...
    { PARAM_NAME_PSAS_PITCH_DAMPING_SPEED_ENABLE,     VAR_UINT8 | PROFILE_VALUE, .config.lookup = { TABLE_OFF_ON }, PG_PID_PROFILE, offsetof(pidProfile_t, psas_damping_speed_enable[FD_PITCH]) },
    { PARAM_NAME_PSAS_PITCH_DAMPING_SPEED_SCALE,      VAR_UINT8 | PROFILE_VALUE, .config.minmaxUnsigned = { 50, 150 }, PG_PID_PROFILE, offsetof(pidProfile_t, psas_damping_speed_scale[FD_PITCH]) },
    ...
    { PARAM_NAME_PSAS_PITCH_STABILITY_SPEED_ENABLE,     VAR_UINT8 | PROFILE_VALUE, .config.lookup = { TABLE_OFF_ON }, PG_PID_PROFILE, offsetof(pidProfile_t, psas_pitch_stability_speed_enable) },
    { PARAM_NAME_PSAS_PITCH_STABILITY_SPEED_SCALE,      VAR_UINT8 | PROFILE_VALUE, .config.minmaxUnsigned = { 50, 150 }, PG_PID_PROFILE, offsetof(pidProfile_t, psas_pitch_stability_speed_scale) },
    ...
    { PARAM_NAME_PSAS_PITCH_ACCEL_I_GAIN,         VAR_UINT8 | PROFILE_VALUE, .config.minmaxUnsigned = { 0, UINT8_MAX }, PG_PID_PROFILE, offsetof(pidProfile_t, psas_pitch_accel_i_gain) },
    ...
    { PARAM_NAME_PSAS_ROLL_STICK_SPEED_ENABLE, VAR_UINT8 | PROFILE_VALUE, .config.lookup = { TABLE_OFF_ON }, PG_PID_PROFILE, offsetof(pidProfile_t, psas_stick_gain[FD_ROLL]) },
    ...
    { PARAM_NAME_PSAS_ROLL_DAMPING_SPEED_ENABLE,     VAR_UINT8 | PROFILE_VALUE, .config.lookup = { TABLE_OFF_ON }, PG_PID_PROFILE, offsetof(pidProfile_t, psas_damping_speed_enable[FD_ROLL]) },
    { PARAM_NAME_PSAS_ROLL_DAMPING_SPEED_SCALE,      VAR_UINT8 | PROFILE_VALUE, .config.minmaxUnsigned = { 50, 150 }, PG_PID_PROFILE, offsetof(pidProfile_t, psas_damping_speed_scale[FD_ROLL]) },
    ...
    { PARAM_NAME_PSAS_YAW_STICK_SPEED_ENABLE,     VAR_UINT8 | PROFILE_VALUE, .config.lookup = { TABLE_OFF_ON }, PG_PID_PROFILE, offsetof(pidProfile_t, psas_stick_speed_enable[FD_YAW]) },
    { PARAM_NAME_PSAS_YAW_STICK_SPEED_SCALE,      VAR_UINT8 | PROFILE_VALUE, .config.minmaxUnsigned = { 50, 150 }, PG_PID_PROFILE, offsetof(pidProfile_t, psas_stick_speed_scale[FD_YAW]) },
    ...
    { PARAM_NAME_PSAS_YAW_DAMPING_SPEED_ENABLE,     VAR_UINT8 | PROFILE_VALUE, .config.lookup = { TABLE_OFF_ON }, PG_PID_PROFILE, offsetof(pidProfile_t, psas_damping_speed_enable[FD_YAW]) },
    { PARAM_NAME_PSAS_YAW_DAMPING_SPEED_SCALE,      VAR_UINT8 | PROFILE_VALUE, .config.minmaxUnsigned = { 50, 150 }, PG_PID_PROFILE, offsetof(pidProfile_t, psas_damping_speed_scale[FD_YAW]) },
    ...
    { PARAM_NAME_PSAS_YAW_STABILITY_SPEED_ENABLE,     VAR_UINT8 | PROFILE_VALUE, .config.lookup = { TABLE_OFF_ON }, PG_PID_PROFILE, offsetof(pidProfile_t, psas_yaw_stability_speed_enable) },
    { PARAM_NAME_PSAS_YAW_STABILITY_SPEED_SCALE,      VAR_UINT8 | PROFILE_VALUE, .config.minmaxUnsigned = { 50, 150 }, PG_PID_PROFILE, offsetof(pidProfile_t, psas_yaw_stability_speed_scale) },
    ...
    { PARAM_NAME_PSAS_AOA_LIMITER_FORECAST_TIME, VAR_UINT8 | PROFILE_VALUE, .config.minmaxUnsigned = { 0, UINT8_MAX }, PG_PID_PROFILE, offsetof(pidProfile_t, psas_aoa_limiter_forecast_time) },
