...
// PG_PID_PROFILE
    ...
    { PARAM_NAME_PSAS_SPEED_OPTIMUM_VREF, VAR_UINT8 | PROFILE_VALUE, .config.minmaxUnsigned = { 1, UINT8_MAX }, PG_PID_PROFILE, offsetof(pidProfile_t, psas_speed_optimum_vref) },
