...
// position as displayed in the GUI.
    ...
    { "osd_watt_hours_drawn_pos",   VAR_UINT16  | MASTER_VALUE, .config.minmaxUnsigned = { 0, OSD_POSCFG_MAX }, PG_OSD_ELEMENT_CONFIG, offsetof(osdElementConfig_t, item_pos[OSD_WATT_HOURS_DRAWN]) },
    ...
    { "osd_stat_watt_hours_drawn",  VAR_UINT32  | MASTER_VALUE | MODE_BITSET, .config.bitpos = OSD_STAT_WATT_HOURS_DRAWN, PG_OSD_CONFIG, offsetof(osdConfig_t, enabled_stats)},
