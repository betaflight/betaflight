...
// PG_IMU_CONFIG
    ...
    { "imu_magnetic_declination_deci_degrees", VAR_UINT16 | MASTER_VALUE, .config.minmaxUnsigned = { 0, 3599 }, PG_IMU_CONFIG, offsetof(imuConfig_t, imu_magnetic_declination_deci_degrees) },
