...
// PG_MIXER_CONFIG
    ...
    { "pwm_outputs_reversed",    VAR_UINT16 |  MASTER_VALUE,  .config.minmax = { 0, 32767 }, PG_MIXER_CONFIG, offsetof(mixerConfig_t, pwm_outputs_reversed) },
...
// PG_PID_ADJUST    
    { "pid_adjust_aux_channel",     VAR_UINT8  | MASTER_VALUE,  .config.minmax = { 0, 7 }, PG_PID_ADJUST, offsetof(pidAdjust_t, pid_adjust_aux_channel) },
