...
// PG_PID_PROFILE
    ...
    { PARAM_NAME_SPEED_CURVE_VREF, VAR_UINT8 | PROFILE_VALUE, .config.minmaxUnsigned = { 1, 55 }, PG_PID_PROFILE, offsetof(pidProfile_t, speed_curve_vref) },
    ...
    { PARAM_NAME_SPEED_CURVE_MIN, VAR_UINT16 | PROFILE_VALUE, .config.minmaxUnsigned = { 10, 99 }, PG_PID_PROFILE, offsetof(pidProfile_t, speed_curve_min) },
    { PARAM_NAME_SPEED_CURVE_MAX, VAR_UINT16 | PROFILE_VALUE, .config.minmaxUnsigned = { 100, 1600 }, PG_PID_PROFILE, offsetof(pidProfile_t, speed_curve_max) },
#endif
