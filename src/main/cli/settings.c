...
// PG_GYRO_CONFIG
    ...
    { PARAM_NAME_GYRO_LLC_FREQ_HZ,  VAR_UINT16 | MASTER_VALUE, .config.minmaxUnsigned = { 1, LPF_MAX_HZ }, PG_GYRO_CONFIG, offsetof(gyroConfig_t, gyro_llc_freq_hz) },
    { PARAM_NAME_GYRO_LLC_PHASE,    VAR_INT8   | MASTER_VALUE, .config.minmax =         { -90, 90 },       PG_GYRO_CONFIG, offsetof(gyroConfig_t, gyro_llc_phase) },
...
#endif
    { PARAM_NAME_DTERM_LLC_FREQ_HZ, VAR_UINT16 | PROFILE_VALUE, .config.minmaxUnsigned = { 1, LPF_MAX_HZ }, PG_PID_PROFILE, offsetof(pidProfile_t, dterm_llc_freq_hz) },
    { PARAM_NAME_DTERM_LLC_PHASE,   VAR_INT8   | PROFILE_VALUE, .config.minmax =         { -90, 90 },       PG_PID_PROFILE, offsetof(pidProfile_t, dterm_llc_phase) },
    { PARAM_NAME_PTERM_LLC_FREQ_HZ, VAR_UINT16 | PROFILE_VALUE, .config.minmaxUnsigned = { 1, LPF_MAX_HZ }, PG_PID_PROFILE, offsetof(pidProfile_t, pterm_llc_freq_hz) },
    { PARAM_NAME_PTERM_LLC_PHASE,   VAR_INT8   | PROFILE_VALUE, .config.minmax =         { -90, 90 },       PG_PID_PROFILE, offsetof(pidProfile_t, pterm_llc_phase) },
