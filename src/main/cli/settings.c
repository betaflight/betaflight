...
// PG_PID_PROFILE
    ...
    { PARAM_NAME_HORIZON_LEVEL_ADDITIVE, VAR_UINT8  | PROFILE_VALUE | MODE_LOOKUP, .config.lookup = { TABLE_OFF_ON }, PG_PID_PROFILE, offsetof(pidProfile_t, horizon_level_additive) },
