...
#endif
#ifdef USART5_APB2_PERIPHERALS_TX
    RCC_APB2PeriphClockCmd(USART5_APB2_PERIPHERALS_TX, ENABLE);
#endif
#ifdef USART5_APB2_PERIPHERALS_RX
    RCC_APB2PeriphClockCmd(USART5_APB2_PERIPHERALS_TX, ENABLE);
#endif
