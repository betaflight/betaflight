...
UNUSED_ static int w25n_readExtensionBytes(flashDevice_t *fdevice, uint32_t address, uint8_t *buffer, int length)
{
...
UNUSED_ static void w25n_readBBLUT(flashDevice_t *fdevice, bblut_t *bblut, int lutsize)
{
...
UNUSED_ static void w25n_writeBBLUT(flashDevice_t *fdevice, uint16_t lba, uint16_t pba)
{
    w25n_waitForReady(fdevice);
