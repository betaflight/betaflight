...
void spiBusTransactionWriteRegister(const busDevice_t *bus, uint8_t reg, uint8_t data)
{
...
{
    spiBusTransactionBegin(bus);
    spiBusTransactionWriteRegister(bus, reg, data);
    spiBusTransactionEnd(bus);
...
uint8_t spiBusReadRegister(const busDevice_t *bus, uint8_t reg)
{
    ...
    spiBusTransactionBegin(bus);
    data = spiBusTransactionReadRegister(bus, reg);
    spiBusTransactionEnd(bus);
