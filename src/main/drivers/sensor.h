...
typedef bool (*sensorMagInitFuncPtr)(struct magDev_s *magdev);                    // sensor init prototype
typedef bool (*sensorMagReadFuncPtr)(struct magDev_s *magdev, int16_t *data);           // sensor read and align prototype
