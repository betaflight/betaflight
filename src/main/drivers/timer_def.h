...
#define TIMER_TAG_INDEX(timNo)           (((timNo) >> 3) - 1)
#define TIMER_TAG_NO(timNo)              ((timNo) >> 3)
#define TIMER_TAG_CHANNEL_INDEX(timNo)   (((timNo) & 0x7) - 1)
#define TIMER_TAG_CHANNEL_NO(timNo)      ((timNo) & 0x7)
#define DEF_TIM_CH(timNo, chanNo)        (((timNo) << 3) | (chanNo))
