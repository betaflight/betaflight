...
#define SPI_IO_CS_HIGH_CFG      IO_CONFIG(GPIO_Mode_AF,  GPIO_Speed_50MHz, GPIO_OType_PP, GPIO_PuPd_UP)
...
#define SPI_IO_CS_HIGH_CFG      IO_CONFIG(GPIO_MODE_AF_PP, GPIO_SPEED_FREQ_VERY_HIGH, GPIO_OType_PP, GPIO_PuPd_UP)
#elif defined(AT32F4)
...
#define SPI_IO_CS_HIGH_CFG      IO_CONFIG(GPIO_MODE_MUX, GPIO_DRIVE_STRENGTH_STRONGER, GPIO_OUTPUT_PUSH_PULL , GPIO_PULL_UP)
#endif
