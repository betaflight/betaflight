...
const timerDef_t timerDefinitions[HARDWARE_TIMER_DEFINITION_COUNT] = {
    { .TIMx = TIM1,  .rcc = RCC_APB2(TIM1),  .inputIrq = 0},
    ...
    { .TIMx = TIM10, .rcc = RCC_APB2(TIM10), .inputIrq = 0},
    { .TIMx = TIM11, .rcc = RCC_APB2(TIM11), .inputIrq = 0},
    { .TIMx = TIM12, .rcc = RCC_APB1(TIM12), .inputIrq = TIM8_BRK_TIM12_IRQn},
    { .TIMx = TIM13, .rcc = RCC_APB1(TIM13), .inputIrq = 0},
    { .TIMx = TIM14, .rcc = RCC_APB1(TIM14), .inputIrq = 0},
};
