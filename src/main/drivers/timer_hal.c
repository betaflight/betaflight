...
void timerInit(void)
{
    ...
    for (unsigned i = 0; i < TIMER_CHANNEL_COUNT; i++) {
        ...
        th->channel = CC_CHANNEL_FROM_INDEX(TIMER_TAG_CHANNEL_INDEX(timerTags[i]));
        th->output = timerChannelConfig(i)->nChannel ? TIMER_OUTPUT_N_CHANNEL : TIMER_OUTPUT_NONE;
