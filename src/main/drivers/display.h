...
typedef struct displayPortVTable_s {
    ...
    bool (*writeFontCharacter)(displayPort_t *instance, uint16_t addr, const struct osdCharacter_s *chr, uint16_t bytes);
    uint16_t (*readFontCharacter)(displayPort_t *instance, uint16_t addr, struct osdCharacter_s *chr);
...
bool displayWriteFontCharacter(displayPort_t *instance, uint16_t addr, const struct osdCharacter_s *chr, uint16_t bytes);
uint16_t displayReadFontCharacter(displayPort_t *instance, uint16_t addr, struct osdCharacter_s *chr);
