...
VALID_TARGETS	 = NAZE NAZE32PRO OLIMEXINO STM32F3DISCOVERY CHEBUZZF3 $(CC3D_TARGETS) CJMCU EUSTM32F103RC BEEROTORF3 SPRACINGF3 PORT103R SPARKY ALIENWIIF1 ALIENWIIF3 COLIBRI_RACE MOTOLAB RMDO IRCFUSIONF3 AFROMINI
...
256K_TARGETS = EUSTM32F103RC PORT103R STM32F3DISCOVERY CHEBUZZF3 NAZE32PRO BEEROTORF3 SPRACINGF3 IRCFUSIONF3 SPARKY ALIENWIIF3 COLIBRI_RACE MOTOLAB

F3_TARGETS = STM32F3DISCOVERY CHEBUZZF3 NAZE32PRO BEEROTORF3 SPRACINGF3 IRCFUSIONF3 SPARKY ALIENWIIF3 COLIBRI_RACE MOTOLAB RMDO
...
ifneq ($(TARGET),$(filter $(TARGET),SPRACINGF3 IRCFUSIONF3 BEEROTORF3))
INCLUDE_DIRS := $(INCLUDE_DIRS) \
		   $(USBFS_DIR)/inc \
		   $(ROOT)/src/main/vcp
...
ifeq ($(TARGET),$(filter $(TARGET),RMDO IRCFUSIONF3 BEEROTORF3))
