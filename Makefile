...
VALID_TARGETS	 = ALIENWIIF1 ALIENWIIF3 CC3D CHEBUZZF3 CJMCU COLIBRI_RACE LUX_RACE EUSTM32F103RC MOTOLAB NAZE NAZE32PRO OLIMEXINO PORT103R PORT103V RMDO SPARKY SPRACINGF3 SPRACINGF3MINI STM32F3DISCOVERY 
...
FLASH_SIZE = 128
else ifeq ($(TARGET),$(filter $(TARGET),ALIENWIIF3 CHEBUZZF3 COLIBRI_RACE LUX_RACE EUSTM32F103RC MOTOLAB NAZE32PRO PORT103R PORT103V SPARKY SPRACINGF3 SPRACINGF3MINI STM32F3DISCOVERY))
FLASH_SIZE = 256
else
...
else ifeq ($(TARGET),$(filter $(TARGET),EUSTM32F103RC PORT103R PORT103V))
...
PORT103V_SRC = $(EUSTM32F103RC_SRC)
