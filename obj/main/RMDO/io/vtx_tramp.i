...
# 65 "./src/main/io/vtx_tramp.c" 3 4
                                      ((void *)0)
# 65 "./src/main/io/vtx_tramp.c"
                                          ;
...
# 164 "./src/main/io/vtx_tramp.c" 3 4
_Bool 
# 164 "./src/main/io/vtx_tramp.c"
    trampCommitChanges(void)
{
    if (trampStatus != TRAMP_STATUS_ONLINE) {
        return 
# 167 "./src/main/io/vtx_tramp.c" 3 4
              0
# 167 "./src/main/io/vtx_tramp.c"
                   ;
    }

    trampStatus = TRAMP_STATUS_SET_FREQ_PW;
    return 
# 171 "./src/main/io/vtx_tramp.c" 3 4
          1
# 171 "./src/main/io/vtx_tramp.c"
              ;
}
...
# 250 "./src/main/io/vtx_tramp.c"
        ...
        return 
# 252 "./src/main/io/vtx_tramp.c" 3 4
              0
# 252 "./src/main/io/vtx_tramp.c"
                   ;
    }
}
...
# 449 "./src/main/io/vtx_tramp.c" 3 4
_Bool 
# 449 "./src/main/io/vtx_tramp.c"
...
# 475 "./src/main/io/vtx_tramp.c" 3 4
_Bool 
# 475 "./src/main/io/vtx_tramp.c"
    vtxTrampGetBandAndChannel(uint8_t *pBand, uint8_t *pChannel)
{
    if (!vtxTrampIsReady()) {
        return 
# 478 "./src/main/io/vtx_tramp.c" 3 4
              0
# 478 "./src/main/io/vtx_tramp.c"
                   ;
    }
    ...
    *pChannel = trampChannel;
    return 
# 483 "./src/main/io/vtx_tramp.c" 3 4
          1
    ...
    vtxTrampGetPowerIndex(uint8_t *pIndex)
{
    if (!vtxTrampIsReady()) {
        return 
# 489 "./src/main/io/vtx_tramp.c" 3 4
              0
# 489 "./src/main/io/vtx_tramp.c"
                   ;
    }
    ...
    return 
# 501 "./src/main/io/vtx_tramp.c" 3 4
          1
# 501 "./src/main/io/vtx_tramp.c"
              ;
}


# 504 "./src/main/io/vtx_tramp.c" 3 4
_Bool 
# 504 "./src/main/io/vtx_tramp.c"
    vtxTrampGetPitMode(uint8_t *pOnOff)
{
    if (!vtxTrampIsReady()) {
        return 
# 507 "./src/main/io/vtx_tramp.c" 3 4
              0
# 507 "./src/main/io/vtx_tramp.c"
                   ;
    }

    *pOnOff = trampPitMode;
    return 
# 511 "./src/main/io/vtx_tramp.c" 3 4
          1
# 511 "./src/main/io/vtx_tramp.c"
              ;
}
...
# 544 "./src/main/io/vtx_tramp.c"
    ...
    return 
# 551 "./src/main/io/vtx_tramp.c" 3 4
          1
# 551 "./src/main/io/vtx_tramp.c"
              ;
}
