...
# 52 "./src/main/io/vtx_smartaudio.c" 2
...
# 63 "./src/main/io/vtx_smartaudio.c"
static serialPort_t *smartAudioSerialPort = 
# 63 "./src/main/io/vtx_smartaudio.c" 3 4
                                           ((void *)0)
# 63 "./src/main/io/vtx_smartaudio.c"
                                               ;
...
# 106 "./src/main/io/vtx_smartaudio.c"
...
{
# 192 "./src/main/io/vtx_smartaudio.c"
}
...
# 467 "./src/main/io/vtx_smartaudio.c"
...
# 507 "./src/main/io/vtx_smartaudio.c"
static 
# 507 "./src/main/io/vtx_smartaudio.c" 3 4
      _Bool 
# 507 "./src/main/io/vtx_smartaudio.c"
           saQueueEmpty(void)
{
...
static 
# 512 "./src/main/io/vtx_smartaudio.c" 3 4
      _Bool 
# 512 "./src/main/io/vtx_smartaudio.c"
           saQueueFull(void)
{
...
# 618 "./src/main/io/vtx_smartaudio.c" 3 4
_Bool 
# 618 "./src/main/io/vtx_smartaudio.c"
    vtxSmartAudioInit(void)
{
# 630 "./src/main/io/vtx_smartaudio.c"
...
# 639 "./src/main/io/vtx_smartaudio.c" 3 4
                                                                                              ((void *)0)
# 639 "./src/main/io/vtx_smartaudio.c"
                                                                                                  , 4800, MODE_RXTX, portOptions);
    }

    if (!smartAudioSerialPort) {
        return 
# 643 "./src/main/io/vtx_smartaudio.c" 3 4
              0
# 643 "./src/main/io/vtx_smartaudio.c"
                   ;
    }
    ...
    return 
# 648 "./src/main/io/vtx_smartaudio.c" 3 4
          1
# 648 "./src/main/io/vtx_smartaudio.c"
              ;
}
...
# 728 "./src/main/io/vtx_smartaudio.c" 3 4
_Bool 
# 728 "./src/main/io/vtx_smartaudio.c"
    vtxSAIsReady(void)
{
    ...
    vtxSAGetBandAndChannel(uint8_t *pBand, uint8_t *pChannel)
{
    if (!vtxSAIsReady()) {
        return 
# 779 "./src/main/io/vtx_smartaudio.c" 3 4
              0
# 779 "./src/main/io/vtx_smartaudio.c"
                   ;
    }
...
# 787 "./src/main/io/vtx_smartaudio.c" 3 4
_Bool 
# 787 "./src/main/io/vtx_smartaudio.c"
    vtxSAGetPowerIndex(uint8_t *pIndex)
{
    if (!vtxSAIsReady()) {
        return 
# 790 "./src/main/io/vtx_smartaudio.c" 3 4
              0
# 790 "./src/main/io/vtx_smartaudio.c"
                   ;
    }

    *pIndex = ((saDevice.version == 1) ? saDacToPowerIndex(saDevice.power) : saDevice.power) + 1;
    return 
# 794 "./src/main/io/vtx_smartaudio.c" 3 4
          1
# 794 "./src/main/io/vtx_smartaudio.c"
              ;
}


# 797 "./src/main/io/vtx_smartaudio.c" 3 4
_Bool 
# 797 "./src/main/io/vtx_smartaudio.c"
    vtxSAGetPitMode(uint8_t *pOnOff)
{
    if (!(vtxSAIsReady() && (saDevice.version == 2))) {
        return 
# 800 "./src/main/io/vtx_smartaudio.c" 3 4
              0
# 800 "./src/main/io/vtx_smartaudio.c"
                   ;
    }

    *pOnOff = (saDevice.mode & 2) ? 1 : 0;
    return 
# 804 "./src/main/io/vtx_smartaudio.c" 3 4
          1
# 804 "./src/main/io/vtx_smartaudio.c"
              ;
}
