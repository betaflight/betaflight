...
# 53 "./src/main/io/vtx_string.c" 3 4
_Bool 
# 53 "./src/main/io/vtx_string.c"
    ...
    for (int band = 4 ; band >= 0 ; band--) {
        for (int channel = 0 ; channel < 8 ; channel++) {
            if (vtx58frequencyTable[band][channel] == freq) {
                ...
                *pChannel = channel + 1;
                return 
# 62 "./src/main/io/vtx_string.c" 3 4
                      1
# 62 "./src/main/io/vtx_string.c"
                          ;
            }
        }
    }
    ...
    *pChannel = 0;
    ...
    return 
# 70 "./src/main/io/vtx_string.c" 3 4
          0
# 70 "./src/main/io/vtx_string.c"
               ;
}
