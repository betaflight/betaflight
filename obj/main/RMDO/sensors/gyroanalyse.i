...
# 31 "./src/main/sensors/gyroanalyse.c" 2
...
# 35 "./src/main/sensors/gyroanalyse.c" 2
...
# 38 "./src/main/sensors/gyroanalyse.c" 2
...
# 40 "./src/main/sensors/gyroanalyse.c" 2
...
# 41 "./src/main/sensors/gyroanalyse.c" 2
...
# 43 "./src/main/sensors/gyroanalyse.c" 2
...
# 34 "./src/main/sensors/gyroanalyse.h" 3 4
_Bool 
# 34 "./src/main/sensors/gyroanalyse.h"
    isDynamicFilterActive(void);
# 44 "./src/main/sensors/gyroanalyse.c" 2
# 62 "./src/main/sensors/gyroanalyse.c"
...
{
    for (int i = 0; i < 32; i++) {
        hanningWindow[i] = (0.5 - 0.5 * cosf(2 * 3.14159265358979323846f * i / (32 - 1)));
    }
}
...
# 139 "./src/main/sensors/gyroanalyse.c" 3 4
_Bool 
# 139 "./src/main/sensors/gyroanalyse.c"
    isDynamicFilterActive(void)
{
