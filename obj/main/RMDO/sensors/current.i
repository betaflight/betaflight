...
# 232 "./src/main/sensors/current.c" 2
# 1 "./src/main/msp/msp_protocol.h" 1
# 53 "./src/main/msp/msp_protocol.h"
       
# 233 "./src/main/sensors/current.c" 2
...
# 234 "./src/main/sensors/current.c" 2
...
void currentMeterMSPRefresh(timeUs_t currentTimeUs)
{
    ...
    if (cmp32(currentTimeUs, streamRequestAt) > 0) {
        streamRequestAt = currentTimeUs + ((1000 * 1000) / 10);

        mspSerialPush(110, 
# 256 "./src/main/sensors/current.c" 3 4
                                 ((void *)0)
# 256 "./src/main/sensors/current.c"
