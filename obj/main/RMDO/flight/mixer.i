...
# 86 "./src/main/flight/mixer.c"
    ...
    int motorIndex = 0;
    for (int i = 0; i < 17 && motorIndex < 8; i++) {
...
float convertExternalToMotor(uint16_t externalValue)
{
    ...
    case 
# 756 "./src/main/flight/mixer.c" 3 4
        1
# 756 "./src/main/flight/mixer.c"
            :
        ...
        break;
    case 
# 772 "./src/main/flight/mixer.c" 3 4
        0
# 772 "./src/main/flight/mixer.c"
             :
...
uint16_t convertMotorToExternal(float motorValue)
{
    ...
    case 
# 788 "./src/main/flight/mixer.c" 3 4
        1
# 788 "./src/main/flight/mixer.c"
            :
        if (feature(FEATURE_3D)) {
        ...
        break;
    case 
# 802 "./src/main/flight/mixer.c" 3 4
        0
# 802 "./src/main/flight/mixer.c"
             :
