...
# 47 "./src/main/rx/crsf.c" 2
# 57 "./src/main/rx/crsf.c"
static 
# 57 "./src/main/rx/crsf.c" 3 4
                  _Bool 
# 57 "./src/main/rx/crsf.c"
                       crsfFrameDone = 
# 57 "./src/main/rx/crsf.c" 3 4
...
static uint8_t telemetryBuf[(60 + 4)];
static uint8_t telemetryBufLen = 0;
# 93 "./src/main/rx/crsf.c"
...
static void crsfDataReceive(uint16_t c)
{
    ...
    if (currentTimeUs > crsfFrameStartAtUs + 1000) {
...
# 141 "./src/main/rx/crsf.c" 3 4
                                                             0 
# 141 "./src/main/rx/crsf.c"
                                                                   : 
# 141 "./src/main/rx/crsf.c" 3 4
                                                                     1
# 141 "./src/main/rx/crsf.c"
...
static uint8_t crsfFrameStatus(void)
{
    if (crsfFrameDone) {
        crsfFrameDone = 
# 161 "./src/main/rx/crsf.c" 3 4
                       0
# 161 "./src/main/rx/crsf.c"
                            ;
...
void crsfRxSendTelemetryData(void)
{
    ...
    if (telemetryBufLen > 0) {
        ...
        if (rxConfig()->halfDuplex) {
            ...
            if ((timeSinceStartOfFrameUs < 1000) ||
                (timeSinceStartOfFrameUs > 4000 - 1000)) {
                return;
            }
        }
...
# 248 "./src/main/rx/crsf.c" 3 4
_Bool 
# 248 "./src/main/rx/crsf.c"
    crsfRxInit(const rxConfig_t *rxConfig, rxRuntimeConfig_t *rxRuntimeConfig)
{
    ...
    if (!portConfig) {
        return 
# 262 "./src/main/rx/crsf.c" 3 4
              0
# 262 "./src/main/rx/crsf.c"
                   ;
    }
    ...
    serialPort = openSerialPort(portConfig->identifier,
        ...
        420000,
        MODE_RXTX,
        (SERIAL_STOPBITS_1 | SERIAL_PARITY_NO) | (rxConfig->halfDuplex ? SERIAL_BIDIR : 0)
        );
...
# 276 "./src/main/rx/crsf.c" 3 4
_Bool 
# 276 "./src/main/rx/crsf.c"
    crsfRxIsActive(void)
{
    return serialPort != 
# 278 "./src/main/rx/crsf.c" 3 4
                        ((void *)0)
# 278 "./src/main/rx/crsf.c"
                            ;
}
