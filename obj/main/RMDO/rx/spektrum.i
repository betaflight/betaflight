...
# 178 "./src/main/rx/spektrum.c" 3 4
_Bool 
    ...
    spekShouldBind(uint8_t spektrum_sat_bind)
{
    ...
    if (BindPlug) {
        ...
        if (IORead(BindPlug)) {
            return 
# 190 "./src/main/rx/spektrum.c" 3 4
                  0
# 190 "./src/main/rx/spektrum.c"
                       ;
        }
    }
...
# 259 "./src/main/rx/spektrum.c"
    ...
    for (int i = 0; i < rxConfig->spektrum_sat_bind; i++) {
        ledSet(0, 
# 262 "./src/main/rx/spektrum.c" 3 4
       0
# 262 "./src/main/rx/spektrum.c"
       );
        ledSet(2, 
...
# 263 "./src/main/rx/spektrum.c"
        ...
        IOWrite(bindIO, 
# 265 "./src/main/rx/spektrum.c" 3 4
                       0
# 265 "./src/main/rx/spektrum.c"
                            );
