...
static void ibusDataReceive(uint16_t c)
{
    ...
    if (ibusFramePosition == ibusFrameSize - 1) {
        ibusFrameDone = 
# 118 "./src/main/rx/ibus.c" 3 4
                       1
# 118 "./src/main/rx/ibus.c"
                           ;
    } else {
        ibusFramePosition++;
    }
...
static 
# 125 "./src/main/rx/ibus.c" 3 4
      _Bool 
# 125 "./src/main/rx/ibus.c"
...
static 
# 139 "./src/main/rx/ibus.c" 3 4
      _Bool 
# 139 "./src/main/rx/ibus.c"
           checksumIsOk(void) {
    if (ibusModel == 1 ) {
...
static uint8_t ibusFrameStatus(void)
{
    ...
    ibusFrameDone = 
# 165 "./src/main/rx/ibus.c" 3 4
                   0
# 165 "./src/main/rx/ibus.c"
                        ;
...
# 191 "./src/main/rx/ibus.c" 3 4
_Bool 
# 191 "./src/main/rx/ibus.c"
    ibusInit(const rxConfig_t *rxConfig, rxRuntimeConfig_t *rxRuntimeConfig)
{
    (void)(rxConfig);
    ibusSyncByte = 0;
    ...
    if (!portConfig) {
        return 
# 204 "./src/main/rx/ibus.c" 3 4
              0
# 204 "./src/main/rx/ibus.c"
                   ;
    }
...
# 209 "./src/main/rx/ibus.c" 3 4
   _Bool 
# 209 "./src/main/rx/ibus.c"
