...
# 587 "./src/main/rx/jetiexbus.c" 3 4
_Bool 
# 587 "./src/main/rx/jetiexbus.c"
    jetiExBusInit(const rxConfig_t *rxConfig, rxRuntimeConfig_t *rxRuntimeConfig)
{
    (void)(rxConfig);
    ...
    if (!portConfig) {
        return 
# 602 "./src/main/rx/jetiexbus.c" 3 4
              0
# 602 "./src/main/rx/jetiexbus.c"
                   ;
    }
...
# 613 "./src/main/rx/jetiexbus.c" 3 4
                           ((void *)0)
# 613 "./src/main/rx/jetiexbus.c"
                               ;
}
