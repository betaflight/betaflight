...
# 1 "./src/main/target/SPRACINGF3/target.h" 1
# 18 "./src/main/target/SPRACINGF3/target.h"
...
typedef struct systemConfig_s {
    ...
    char boardIdentifier[sizeof("RMDO") + 1];
} systemConfig_t;
...
extern const char *armingDisableFlagNames[16];
...
typedef uint8_t loadDmaBufferFn(motorDmaOutput_t *const motor, uint16_t packet);
...
const blackboxConfig_t pgResetTemplate_blackboxConfig __attribute__ ((section(".pg_resetdata"), used, aligned(2))) = { .p_denom = 32, .device = BLACKBOX_DEVICE_FLASH, .on_motor_test = 0, .record_acc = 1 }
