...
# 131 "./src/main/io/osd.h" 3 4
   _Bool 
# 131 "./src/main/io/osd.h"
...
const featureConfig_t pgResetTemplate_featureConfig __attribute__ ((section(".pg_resetdata"), used, aligned(2))) = { .enabledFeatures = (FEATURE_TRANSPONDER | FEATURE_RSSI_ADC | FEATURE_TELEMETRY) | FEATURE_RX_PPM }
...
void pgResetFn_flashConfig(flashConfig_t *flashConfig)
{
    ...
    flashConfig->spiDevice = ((spiDeviceByInstance(((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x00003800)))) + 1);
}
...
void pgResetFn_pwmConfig(pwmConfig_t *pwmConfig)
{
    ...
    int inputIndex = 0;
    for (int i = 0; i < 17 && inputIndex < 8; i++) {
