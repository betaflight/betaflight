...
# 65 "./src/main/fc/rc_controls.c" 2

static pidProfile_t *pidProfile;


static 
# 69 "./src/main/fc/rc_controls.c" 3 4
      _Bool 
# 69 "./src/main/fc/rc_controls.c"
           isUsingSticksToArm = 
# 69 "./src/main/fc/rc_controls.c" 3 4
                                1
# 69 "./src/main/fc/rc_controls.c"
...
# 75 "./src/main/fc/rc_controls.c" 3 4
0
# 75 "./src/main/fc/rc_controls.c"
, }
...
# 99 "./src/main/fc/rc_controls.c" 3 4
_Bool 
# 99 "./src/main/fc/rc_controls.c"
    isUsingSticksForArming(void)
{
...
# 104 "./src/main/fc/rc_controls.c" 3 4
_Bool 
# 104 "./src/main/fc/rc_controls.c"
    areSticksInApModePosition(uint16_t ap_mode)
{
...
void processRcStickPositions(throttleStatus_e throttleStatus)
{
    ...
    static 
# 137 "./src/main/fc/rc_controls.c" 3 4
          _Bool 
# 137 "./src/main/fc/rc_controls.c"
               doNotRepeat;
    uint8_t stTmp = 0;
    int i;
    ...
    if (stTmp == rcSticks) {
        if (rcDelayMs <= 
# 156 "./src/main/fc/rc_controls.c" 3 4
                        (0x7fff) 
# 156 "./src/main/fc/rc_controls.c"
...
# 160 "./src/main/fc/rc_controls.c"
    ...
    if (!isUsingSticksToArm) {
        ...
        if (rcDelayMs >= 500 && !doNotRepeat) {
            doNotRepeat = 
# 186 "./src/main/fc/rc_controls.c" 3 4
                         1
# 186 "./src/main/fc/rc_controls.c"
                             ;
...
# 192 "./src/main/fc/rc_controls.c" 3 4
               0
# 192 "./src/main/fc/rc_controls.c"
               ; };
            }
        }
        return;
        ...
        if (rcDelayMs >= 500 && !doNotRepeat) {
            doNotRepeat = 
# 198 "./src/main/fc/rc_controls.c" 3 4
                         1
# 198 "./src/main/fc/rc_controls.c"
                             ;
            if (!(armingFlags & (ARMED))) {
    ...
    doNotRepeat = 
# 212 "./src/main/fc/rc_controls.c" 3 4
                 1
# 212 "./src/main/fc/rc_controls.c"
                     ;
...
# 218 "./src/main/fc/rc_controls.c" 3 4
                            0
# 218 "./src/main/fc/rc_controls.c"
                                 );
# 227 "./src/main/fc/rc_controls.c"
    ...
    i = 0;
    if (rcSticks == (1 << (2 * THROTTLE)) + (1 << (2 * YAW)) + (3 << (2 * PITCH)) + (1 << (2 * ROLL)))
        i = 1;
    else if (rcSticks == (1 << (2 * THROTTLE)) + (1 << (2 * YAW)) + (2 << (2 * PITCH)) + (3 << (2 * ROLL)))
        i = 2;
    else if (rcSticks == (1 << (2 * THROTTLE)) + (1 << (2 * YAW)) + (3 << (2 * PITCH)) + (2 << (2 * ROLL)))
        i = 3;
    if (i) {
...
# 276 "./src/main/fc/rc_controls.c" 3 4
   _Bool 
# 276 "./src/main/fc/rc_controls.c"
...
# 276 "./src/main/fc/rc_controls.c"
    ...
    if (rcSticks == (2 << (2 * THROTTLE)) + (3 << (2 * YAW)) + (2 << (2 * PITCH)) + (3 << (2 * ROLL))) {
        ...
        shouldApplyRollAndPitchTrimDelta = 
# 279 "./src/main/fc/rc_controls.c" 3 4
                                          1
# 279 "./src/main/fc/rc_controls.c"
                                              ;
    } else if (rcSticks == (2 << (2 * THROTTLE)) + (3 << (2 * YAW)) + (1 << (2 * PITCH)) + (3 << (2 * ROLL))) {
        accelerometerTrimsDelta.values.pitch = -2;
        shouldApplyRollAndPitchTrimDelta = 
# 282 "./src/main/fc/rc_controls.c" 3 4
                                          1
# 282 "./src/main/fc/rc_controls.c"
                                              ;
    } else if (rcSticks == (2 << (2 * THROTTLE)) + (3 << (2 * YAW)) + (3 << (2 * PITCH)) + (2 << (2 * ROLL))) {
        accelerometerTrimsDelta.values.roll = 2;
        shouldApplyRollAndPitchTrimDelta = 
# 285 "./src/main/fc/rc_controls.c" 3 4
                                          1
# 285 "./src/main/fc/rc_controls.c"
                                              ;
...
# 292 "./src/main/fc/rc_controls.c"
    ...
    if (rcSticks == (1 << (2 * THROTTLE)) + (3 << (2 * YAW)) + (2 << (2 * PITCH)) + (1 << (2 * ROLL))) {
