...
static 
# 111 "./src/main/fc/fc_core.c" 3 4
      _Bool 
# 111 "./src/main/fc/fc_core.c"
           reverseMotors = 
# 111 "./src/main/fc/fc_core.c" 3 4
                           0
# 111 "./src/main/fc/fc_core.c"
                                ;
static 
# 112 "./src/main/fc/fc_core.c" 3 4
      _Bool 
# 112 "./src/main/fc/fc_core.c"
...
# 116 "./src/main/fc/fc_core.c" 3 4
_Bool 
# 116 "./src/main/fc/fc_core.c"
    isRXDataNew;
...
static 
# 134 "./src/main/fc/fc_core.c" 3 4
      _Bool 
# 134 "./src/main/fc/fc_core.c"
           isCalibrating(void)
{

    if (sensors(SENSOR_BARO) && !isBaroCalibrationComplete()) {
        return 
# 138 "./src/main/fc/fc_core.c" 3 4
              1
# 138 "./src/main/fc/fc_core.c"
                  ;
    }
...
void updateArmingStatus(void)
{
    if ((armingFlags & (ARMED))) {
        ledSet(0, 
# 155 "./src/main/fc/fc_core.c" 3 4
       1
# 155 "./src/main/fc/fc_core.c"
       );
    } else {
        ...
        if (!isUsingSticksForArming()) {
            static 
# 165 "./src/main/fc/fc_core.c" 3 4
                  _Bool 
# 165 "./src/main/fc/fc_core.c"
                       hadRx = 
# 165 "./src/main/fc/fc_core.c" 3 4
                               0
# 165 "./src/main/fc/fc_core.c"
                                    ;
            const 
# 166 "./src/main/fc/fc_core.c" 3 4
                 _Bool 
# 166 "./src/main/fc/fc_core.c"
                      haveRx = rxIsReceivingSignal();

            const 
# 168 "./src/main/fc/fc_core.c" 3 4
                 _Bool 
# 168 "./src/main/fc/fc_core.c"
...
void disarm(void)
{
    if ((armingFlags & (ARMED))) {
        ...
        systemBeep(
# 248 "./src/main/fc/fc_core.c" 3 4
       0
# 248 "./src/main/fc/fc_core.c"
       );
...
# 256 "./src/main/fc/fc_core.c" 3 4
                            1
# 256 "./src/main/fc/fc_core.c"
                                );
    }
    ...
    if (!isArmingDisabled()) {
        ...
        if (isMotorProtocolDshot() && isModeActivationConditionPresent(BOXFLIPOVERAFTERCRASH)) {
            ...
            if (!IS_RC_MODE_ACTIVE(BOXFLIPOVERAFTERCRASH)) {
                flipOverAfterCrashMode = 
# 271 "./src/main/fc/fc_core.c" 3 4
                                        0
# 271 "./src/main/fc/fc_core.c"
                                             ;
                pwmWriteDshotCommand(255, getMotorCount(), DSHOT_CMD_SPIN_DIRECTION_NORMAL);
            } else {
                flipOverAfterCrashMode = 
# 274 "./src/main/fc/fc_core.c" 3 4
                                        1
# 274 "./src/main/fc/fc_core.c"
                                            ;
...
# 316 "./src/main/fc/fc_core.c" 3 4
_Bool 
# 316 "./src/main/fc/fc_core.c"
...
# 317 "./src/main/fc/fc_core.c" 3 4
_Bool 
# 317 "./src/main/fc/fc_core.c"
...
# 318 "./src/main/fc/fc_core.c" 3 4
_Bool 
# 318 "./src/main/fc/fc_core.c"
...
# 319 "./src/main/fc/fc_core.c" 3 4
_Bool 
# 319 "./src/main/fc/fc_core.c"
...
void handleInflightCalibrationStickPosition(void)
{
    if (AccInflightCalibrationMeasurementDone) {
        ...
        AccInflightCalibrationMeasurementDone = 
# 326 "./src/main/fc/fc_core.c" 3 4
                                               0
# 326 "./src/main/fc/fc_core.c"
                                                    ;
        AccInflightCalibrationSavetoEEProm = 
...
static void updateInflightCalibrationState(void)
{
    if (AccInflightCalibrationArmed && (armingFlags & (ARMED)) && rcData[THROTTLE] > rxConfig()->mincheck && !IS_RC_MODE_ACTIVE(BOXARM)) {
        ...
        AccInflightCalibrationArmed = 
# 342 "./src/main/fc/fc_core.c" 3 4
                                     0
# 342 "./src/main/fc/fc_core.c"
                                          ;
    }
    if (IS_RC_MODE_ACTIVE(BOXCALIB)) {
        if (!AccInflightCalibrationActive && !AccInflightCalibrationMeasurementDone)
            InflightcalibratingA = 50;
        AccInflightCalibrationActive = 
# 347 "./src/main/fc/fc_core.c" 3 4
                                      1
# 347 "./src/main/fc/fc_core.c"
                                          ;
    } else if (AccInflightCalibrationMeasurementDone && !(armingFlags & (ARMED))) {
        AccInflightCalibrationMeasurementDone = 
# 349 "./src/main/fc/fc_core.c" 3 4
                                               0
# 349 "./src/main/fc/fc_core.c"
                                                    ;
        AccInflightCalibrationSavetoEEProm = 
# 350 "./src/main/fc/fc_core.c" 3 4
                                            1
# 350 "./src/main/fc/fc_core.c"
                                                ;
    }
}
# 374 "./src/main/fc/fc_core.c"
void processRx(timeUs_t currentTimeUs)
{
    static 
# 376 "./src/main/fc/fc_core.c" 3 4
          _Bool 
# 376 "./src/main/fc/fc_core.c"
               armedBeeperOn = 
# 376 "./src/main/fc/fc_core.c" 3 4
                               0
# 376 "./src/main/fc/fc_core.c"
                                    ;
    static 
# 377 "./src/main/fc/fc_core.c" 3 4
          _Bool 
# 377 "./src/main/fc/fc_core.c"
               airmodeIsActivated;
    ...
    if (isAirmodeActive() && (armingFlags & (ARMED))) {
        if (rcCommand[THROTTLE] >= rxConfig()->airModeActivateThreshold) airmodeIsActivated = 
...
# 397 "./src/main/fc/fc_core.c"
        ...
        airmodeIsActivated = 
# 399 "./src/main/fc/fc_core.c" 3 4
                            0
# 399 "./src/main/fc/fc_core.c"
                                 ;
    }
        ...
        if (isUsingSticksForArming()) {
            if (throttleStatus == THROTTLE_LOW) {
                if (armingConfig()->auto_disarm_delay != 0
                    ...
                    disarm();
                    armedBeeperOn = 
# 430 "./src/main/fc/fc_core.c" 3 4
                                   0
# 430 "./src/main/fc/fc_core.c"
                                        ;
                } else {

                    beeper(BEEPER_ARMED);
                    armedBeeperOn = 
# 434 "./src/main/fc/fc_core.c" 3 4
                                   1
# 434 "./src/main/fc/fc_core.c"
                                       ;
                }
            } else {
                ...
                if (armedBeeperOn) {
                    beeperSilence();
                    armedBeeperOn = 
# 445 "./src/main/fc/fc_core.c" 3 4
                                   0
# 445 "./src/main/fc/fc_core.c"
                                        ;
                }
            }
        } else {
            ...
            if (throttleStatus == THROTTLE_LOW) {
                beeper(BEEPER_ARMED);
                armedBeeperOn = 
# 452 "./src/main/fc/fc_core.c" 3 4
                               1
# 452 "./src/main/fc/fc_core.c"
                                   ;
...
# 473 "./src/main/fc/fc_core.c" 3 4
   _Bool 
# 473 "./src/main/fc/fc_core.c"
        canUseHorizonMode = 
# 473 "./src/main/fc/fc_core.c" 3 4
                            1
# 473 "./src/main/fc/fc_core.c"
...
# 477 "./src/main/fc/fc_core.c"
    ...
    if ((flightModeFlags & (ANGLE_MODE)) || (flightModeFlags & (HORIZON_MODE))) {
        ledSet(1, 
# 498 "./src/main/fc/fc_core.c" 3 4
       1
# 498 "./src/main/fc/fc_core.c"
       );
    } else {
        ledSet(1, 
# 500 "./src/main/fc/fc_core.c" 3 4
       0
# 500 "./src/main/fc/fc_core.c"
       );
    }
...
{
    static 
# 694 "./src/main/fc/fc_core.c" 3 4
          _Bool 
# 694 "./src/main/fc/fc_core.c"
               runTaskMainSubprocesses;
    ...
    if (runTaskMainSubprocesses) {
        ...
        runTaskMainSubprocesses = 
# 708 "./src/main/fc/fc_core.c" 3 4
                                 0
# 708 "./src/main/fc/fc_core.c"
                                      ;
    }
    ...
    if (debugMode == DEBUG_PIDLOOP) {startTime = micros();}
    gyroUpdate();
    {if (debugMode == (DEBUG_PIDLOOP)) {debug[(0)] = (micros() - startTime);}};
    ...
    if (pidUpdateCountdown) {
        ...
        subTaskMotorUpdate();
        runTaskMainSubprocesses = 
# 727 "./src/main/fc/fc_core.c" 3 4
                                 1
# 727 "./src/main/fc/fc_core.c"
                                     ;
    }
}


# 731 "./src/main/fc/fc_core.c" 3 4
_Bool 
# 731 "./src/main/fc/fc_core.c"
    isMotorsReversed(void)
{
    return reverseMotors;
}

# 735 "./src/main/fc/fc_core.c" 3 4
_Bool 
# 735 "./src/main/fc/fc_core.c"
    isFlipOverAfterCrashMode(void)
{
