...
# 79 "./src/main/cms/cms.c" 3 4
_Bool 
# 79 "./src/main/cms/cms.c"
    cmsDisplayPortRegister(displayPort_t *pDisplay)
{
    if (cmsDeviceCount == 4)
        return 
# 82 "./src/main/cms/cms.c" 3 4
              0
# 82 "./src/main/cms/cms.c"
                   ;

    cmsDisplayPorts[cmsDeviceCount++] = pDisplay;

    return 
# 86 "./src/main/cms/cms.c" 3 4
          1
...
static displayPort_t *cmsDisplayPortSelectNext(void)
{
    if (cmsDeviceCount == 0)
        return 
# 103 "./src/main/cms/cms.c" 3 4
              ((void *)0)
# 103 "./src/main/cms/cms.c"
                  ;
...
# 421 "./src/main/cms/cms.c" 3 4
   _Bool 
# 421 "./src/main/cms/cms.c"
        drawPolled = 
# 421 "./src/main/cms/cms.c" 3 4
                     0
# 421 "./src/main/cms/cms.c"
    ...
    if (currentTimeUs > lastPolledUs + 100000) {
        drawPolled = 
# 425 "./src/main/cms/cms.c" 3 4
                    1
# 425 "./src/main/cms/cms.c"
                        ;
    ...
    if (pDisplay->cleared) {
        ...
        pDisplay->cleared = 
# 436 "./src/main/cms/cms.c" 3 4
                           0
# 436 "./src/main/cms/cms.c"
                                ;
    } else if (drawPolled) {
...
static void cmsMenuOpen(void)
{
    if (!cmsInMenu) {
        ...
        if (!pCurrentDisplay)
            return;
        cmsInMenu = 
# 579 "./src/main/cms/cms.c" 3 4
                   1
# 579 "./src/main/cms/cms.c"
                       ;
...
# 622 "./src/main/cms/cms.c" 3 4
                                                ((void *)0)
# 622 "./src/main/cms/cms.c"
                                                    );
    ...
    cmsInMenu = 
# 631 "./src/main/cms/cms.c" 3 4
               0
# 631 "./src/main/cms/cms.c"
                    ;
