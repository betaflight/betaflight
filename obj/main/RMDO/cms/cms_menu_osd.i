...
# 28 "./src/main/cms/cms_menu_osd.c" 2
...
# 75 "./src/main/cms/cms_menu_osd.c" 3 4
                                       ((void *)0)
# 75 "./src/main/cms/cms_menu_osd.c"
...
# 87 "./src/main/cms/cms_menu_osd.c"
    {"COMPASS BAR", OME_VISIBLE, 
# 87 "./src/main/cms/cms_menu_osd.c" 3 4
                                       ((void *)0)
# 87 "./src/main/cms/cms_menu_osd.c"
...
CMS_Menu menuOsdActiveElems = {
    ...
    .onGlobalExit = 
# 110 "./src/main/cms/cms_menu_osd.c" 3 4
                   ((void *)0)
# 110 "./src/main/cms/cms_menu_osd.c"
                       ,
...
CMS_Menu menuAlarms = {
    ...
    .onGlobalExit = 
# 153 "./src/main/cms/cms_menu_osd.c" 3 4
                   ((void *)0)
# 153 "./src/main/cms/cms_menu_osd.c"
                       ,
...
{
    {"--- TIMERS ---", OME_Label, 
# 188 "./src/main/cms/cms_menu_osd.c" 3 4
                                 ((void *)0)
# 188 "./src/main/cms/cms_menu_osd.c"
                                     , 
# 188 "./src/main/cms/cms_menu_osd.c" 3 4
                                       ((void *)0)
# 188 "./src/main/cms/cms_menu_osd.c"
                                           , 0},
    {"1 SRC", OME_TAB, 
# 189 "./src/main/cms/cms_menu_osd.c" 3 4
                                 ((void *)0)
# 189 "./src/main/cms/cms_menu_osd.c"
                                     , &(OSD_TAB_t){&timerSource[OSD_TIMER_1], OSD_TIMER_SRC_COUNT - 1, osdTimerSourceNames}, 0 },
    {"1 PREC", OME_TAB, 
# 190 "./src/main/cms/cms_menu_osd.c" 3 4
                                 ((void *)0)
# 190 "./src/main/cms/cms_menu_osd.c"
...
CMS_Menu menuTimers = {
    ...
    .onGlobalExit = 
# 204 "./src/main/cms/cms_menu_osd.c" 3 4
                   ((void *)0)
# 204 "./src/main/cms/cms_menu_osd.c"
                       ,
    .entries = menuTimersEntries,
};
# 215 "./src/main/cms/cms_menu_osd.c"
...
{
    {"---OSD---", OME_Label, 
# 241 "./src/main/cms/cms_menu_osd.c" 3 4
                                ((void *)0)
# 241 "./src/main/cms/cms_menu_osd.c"
                                    , 
# 241 "./src/main/cms/cms_menu_osd.c" 3 4
                                               ((void *)0)
# 241 "./src/main/cms/cms_menu_osd.c"
...
CMS_Menu cmsx_menuOsd = {
    ...
    .onGlobalExit = 
# 261 "./src/main/cms/cms_menu_osd.c" 3 4
                   ((void *)0)
# 261 "./src/main/cms/cms_menu_osd.c"
                       ,
