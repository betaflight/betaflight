...
static OSD_Entry trampCmsMenuCommenceEntries[] = {
    { "CONFIRM", OME_Label, 
# 184 "./src/main/cms/cms_menu_vtx_tramp.c" 3 4
                             ((void *)0)
# 184 "./src/main/cms/cms_menu_vtx_tramp.c"
                                 , 
# 184 "./src/main/cms/cms_menu_vtx_tramp.c" 3 4
                                            ((void *)0)
# 184 "./src/main/cms/cms_menu_vtx_tramp.c"
...
# 185 "./src/main/cms/cms_menu_vtx_tramp.c" 3 4
                                               ((void *)0)
# 185 "./src/main/cms/cms_menu_vtx_tramp.c"
                                                   , 0 },
    { "BACK", OME_Back, 
# 186 "./src/main/cms/cms_menu_vtx_tramp.c" 3 4
                          ((void *)0)
# 186 "./src/main/cms/cms_menu_vtx_tramp.c"
                              , 
# 186 "./src/main/cms/cms_menu_vtx_tramp.c" 3 4
                                ((void *)0)
# 186 "./src/main/cms/cms_menu_vtx_tramp.c"
...
static CMS_Menu trampCmsMenuCommence = {
    ...
    .GUARD_type = OME_MENU,
    .onEnter = 
# 193 "./src/main/cms/cms_menu_vtx_tramp.c" 3 4
              ((void *)0)
# 193 "./src/main/cms/cms_menu_vtx_tramp.c"
                  ,
    .onExit = 
# 194 "./src/main/cms/cms_menu_vtx_tramp.c" 3 4
             ((void *)0)
# 194 "./src/main/cms/cms_menu_vtx_tramp.c"
                 ,
    .onGlobalExit = 
...
# 201 "./src/main/cms/cms_menu_vtx_tramp.c"
    ...
    { "", OME_Label, 
# 203 "./src/main/cms/cms_menu_vtx_tramp.c" 3 4
                            ((void *)0)
# 203 "./src/main/cms/cms_menu_vtx_tramp.c"
...
CMS_Menu cmsx_menuVtxTramp = {
    ...
    .onExit = 
# 220 "./src/main/cms/cms_menu_vtx_tramp.c" 3 4
             ((void *)0)
# 220 "./src/main/cms/cms_menu_vtx_tramp.c"
                 ,
    .onGlobalExit = 
