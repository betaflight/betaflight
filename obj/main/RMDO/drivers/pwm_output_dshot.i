...
void pwmDshotMotorHardwareConfig(const timerHardware_t *timerHardware, uint8_t motorIndex, motorPwmProtocolTypes_e pwmProtocolType, uint8_t output)
{
    ...
    const 
# 105 "./src/main/drivers/pwm_output_dshot.c" 3 4
         _Bool 
# 105 "./src/main/drivers/pwm_output_dshot.c"
    ...
    if (dmaRef == 
# 159 "./src/main/drivers/pwm_output_dshot.c" 3 4
                 ((void *)0)
# 159 "./src/main/drivers/pwm_output_dshot.c"
                     ) {
        return;
    }
...
# 183 "./src/main/drivers/pwm_output_dshot.c"
