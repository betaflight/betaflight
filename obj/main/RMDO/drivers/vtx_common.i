...
# 32 "./src/main/drivers/vtx_common.c" 3 4
                        ((void *)0)
# 32 "./src/main/drivers/vtx_common.c"
                            ;
...
# 45 "./src/main/drivers/vtx_common.c" 3 4
_Bool 
# 45 "./src/main/drivers/vtx_common.c"
    vtxCommonDeviceRegistered(void)
{
    return vtxDevice;
}
...
# 103 "./src/main/drivers/vtx_common.c" 3 4
_Bool 
# 103 "./src/main/drivers/vtx_common.c"
    vtxCommonGetBandAndChannel(uint8_t *pBand, uint8_t *pChannel)
{
    if (!vtxDevice)
        return 
# 106 "./src/main/drivers/vtx_common.c" 3 4
              0
# 106 "./src/main/drivers/vtx_common.c"
                   ;
    ...
    if (vtxDevice->vTable->getBandAndChannel)
        ...
        return 
# 111 "./src/main/drivers/vtx_common.c" 3 4
              0
# 111 "./src/main/drivers/vtx_common.c"
                   ;
}


# 114 "./src/main/drivers/vtx_common.c" 3 4
_Bool 
# 114 "./src/main/drivers/vtx_common.c"
    vtxCommonGetPowerIndex(uint8_t *pIndex)
{
    if (!vtxDevice)
        return 
...
# 125 "./src/main/drivers/vtx_common.c" 3 4
_Bool 
# 125 "./src/main/drivers/vtx_common.c"
    vtxCommonGetPitMode(uint8_t *pOnOff)
{
    if (!vtxDevice)
        return 
# 128 "./src/main/drivers/vtx_common.c" 3 4
              0
# 128 "./src/main/drivers/vtx_common.c"
                   ;
    ...
    if (vtxDevice->vTable->getPitMode)
        ...
        return 
# 133 "./src/main/drivers/vtx_common.c" 3 4
              0
# 133 "./src/main/drivers/vtx_common.c"
                   ;
}


# 136 "./src/main/drivers/vtx_common.c" 3 4
_Bool 
# 136 "./src/main/drivers/vtx_common.c"
    vtxCommonGetDeviceCapability(vtxDeviceCapability_t *pDeviceCapability)
{
    if (!vtxDevice)
        return 
# 139 "./src/main/drivers/vtx_common.c" 3 4
              0
# 139 "./src/main/drivers/vtx_common.c"
                   ;
