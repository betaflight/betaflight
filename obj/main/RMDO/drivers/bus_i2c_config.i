...
# 29 "./src/main/drivers/bus_i2c_config.c" 2
...
# 30 "./src/main/drivers/bus_i2c_config.c" 2
...
# 32 "./src/main/drivers/bus_i2c_config.c" 2
...
# 33 "./src/main/drivers/bus_i2c_config.c" 2
...
# 59 "./src/main/drivers/bus_i2c_impl.h"
...
# 65 "./src/main/drivers/bus_i2c_impl.h"
        pullUp;
# 74 "./src/main/drivers/bus_i2c_impl.h"
} i2cDevice_t;

extern i2cDevice_t i2cDevice[];
# 34 "./src/main/drivers/bus_i2c_config.c" 2


# 1 "./src/main/config/parameter_group_ids.h" 1
# 18 "./src/main/config/parameter_group_ids.h"
       
# 37 "./src/main/drivers/bus_i2c_config.c" 2
# 192 "./src/main/drivers/bus_i2c_config.c"
typedef struct i2cDefaultConfig_s {
    I2CDevice device;
    ioTag_t ioTagScl, ioTagSda;
    
# 195 "./src/main/drivers/bus_i2c_config.c" 3 4
   _Bool 
# 195 "./src/main/drivers/bus_i2c_config.c"
        overClock;
    
# 196 "./src/main/drivers/bus_i2c_config.c" 3 4
   _Bool 
# 196 "./src/main/drivers/bus_i2c_config.c"
        pullUp;
} i2cDefaultConfig_t;

static const i2cDefaultConfig_t i2cDefaultConfig[] = {

    { I2CDEV_1, ((ioTag_t)((((1) + 1) << 4) | (6))), ((ioTag_t)((((1) + 1) << 4) | (7))), 
# 201 "./src/main/drivers/bus_i2c_config.c" 3 4
                                                   1
# 201 "./src/main/drivers/bus_i2c_config.c"
                                                                 , 
# 201 "./src/main/drivers/bus_i2c_config.c" 3 4
                                                                   0 
# 201 "./src/main/drivers/bus_i2c_config.c"
                                                                               },
# 212 "./src/main/drivers/bus_i2c_config.c"
};
...
extern void pgResetFn_i2cConfig(i2cConfig_t *); i2cConfig_t i2cConfig_System; i2cConfig_t i2cConfig_Copy; extern const pgRegistry_t i2cConfig_Registry; const pgRegistry_t i2cConfig_Registry __attribute__ ((section(".pg_registry"), used, aligned(4))) = { .pgn = 518 | (0 << 12), .size = sizeof(i2cConfig_t) | PGR_SIZE_SYSTEM_FLAG, .address = (uint8_t*)&i2cConfig_System, .copy = (uint8_t*)&i2cConfig_Copy, .ptr = 0, .reset = {.fn = (pgResetFunc*)&pgResetFn_i2cConfig }, };

void pgResetFn_i2cConfig(i2cConfig_t *i2cConfig)
{
    memset(i2cConfig, 0, sizeof(*i2cConfig));

    for (size_t index = 0 ; index < (sizeof(i2cDefaultConfig) / sizeof((i2cDefaultConfig)[0])) ; index++) {
