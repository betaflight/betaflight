...
{
    for (int i = 0; i < 16; i++) {
        motor->dmaBuffer[i] = (packet & 0x8000) ? 14 : 7;
        packet <<= 1;
    }
...
{
    for (int i = 0; i < 4; i++) {
        motor->dmaBuffer[i] = 24 + ((packet & 0xF000) >> 12) * 3;
        packet <<= 4;
    }
...
# 262 "./src/main/drivers/pwm_output.c"
    ...
    case PWM_TYPE_DSHOT150:
        ...
        pwmCompleteWrite = &pwmCompleteDshotMotorUpdate;
        isDshot = 
# 271 "./src/main/drivers/pwm_output.c" 3 4
                 1
# 271 "./src/main/drivers/pwm_output.c"
                     ;
        break;
...
# 301 "./src/main/drivers/pwm_output.c" 3 4
                                        1
# 301 "./src/main/drivers/pwm_output.c"
                                            ;
            continue;
        }
...
# 398 "./src/main/drivers/pwm_output.c" 3 4
                                             1
# 398 "./src/main/drivers/pwm_output.c"
                                                 ;
...
uint16_t prepareDshotPacket(motorDmaOutput_t *const motor, const uint16_t value)
{
    ...
    motor->requestTelemetry = 
# 415 "./src/main/drivers/pwm_output.c" 3 4
                             0
# 415 "./src/main/drivers/pwm_output.c"
                                  ;
