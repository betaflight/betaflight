...
# 37 "./src/main/drivers/bus_spi_pinconfig.c" 2
# 57 "./src/main/drivers/bus_spi_pinconfig.c"
...
# 146 "./src/main/drivers/bus_spi_pinconfig.c"
    {
        .device = SPIDEV_1,
...
# 336 "./src/main/drivers/bus_spi_pinconfig.c"
};
...
void spiPinConfigure(void)
{
    ...
    for (size_t hwindex = 0 ; hwindex < (sizeof(spiHardware) / sizeof((spiHardware)[0])) ; hwindex++) {
        ...
        if (pDev->sck && pDev->miso && pDev->mosi) {
            ...
            pDev->rcc = hw->rcc;
            pDev->leadingEdge = 
# 379 "./src/main/drivers/bus_spi_pinconfig.c" 3 4
                               0
# 379 "./src/main/drivers/bus_spi_pinconfig.c"
                                    ;
