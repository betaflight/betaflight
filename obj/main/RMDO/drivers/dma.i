...
# 31 "./src/main/drivers/dma.c"
   , .flagsShift = 0, .irqN = DMA1_Channel1_IRQn, .rcc = ((uint32_t)0x00000001), .userParam = 0, .owner = 0, .resourceIndex = 0 },
...
# 32 "./src/main/drivers/dma.c"
   , .flagsShift = 4, .irqN = DMA1_Channel2_IRQn, .rcc = ((uint32_t)0x00000001), .userParam = 0, .owner = 0, .resourceIndex = 0 },
...
# 33 "./src/main/drivers/dma.c"
   , .flagsShift = 8, .irqN = DMA1_Channel3_IRQn, .rcc = ((uint32_t)0x00000001), .userParam = 0, .owner = 0, .resourceIndex = 0 },
...
# 34 "./src/main/drivers/dma.c"
   , .flagsShift = 12, .irqN = DMA1_Channel4_IRQn, .rcc = ((uint32_t)0x00000001), .userParam = 0, .owner = 0, .resourceIndex = 0 },
...
# 35 "./src/main/drivers/dma.c"
   , .flagsShift = 16, .irqN = DMA1_Channel5_IRQn, .rcc = ((uint32_t)0x00000001), .userParam = 0, .owner = 0, .resourceIndex = 0 },
...
# 36 "./src/main/drivers/dma.c"
   , .flagsShift = 20, .irqN = DMA1_Channel6_IRQn, .rcc = ((uint32_t)0x00000001), .userParam = 0, .owner = 0, .resourceIndex = 0 },
...
# 37 "./src/main/drivers/dma.c"
   , .flagsShift = 24, .irqN = DMA1_Channel7_IRQn, .rcc = ((uint32_t)0x00000001), .userParam = 0, .owner = 0, .resourceIndex = 0 },
...
# 39 "./src/main/drivers/dma.c"
   , .flagsShift = 0, .irqN = DMA2_Channel1_IRQn, .rcc = ((uint32_t)0x00000002), .userParam = 0, .owner = 0, .resourceIndex = 0 },
...
# 40 "./src/main/drivers/dma.c"
   , .flagsShift = 4, .irqN = DMA2_Channel2_IRQn, .rcc = ((uint32_t)0x00000002), .userParam = 0, .owner = 0, .resourceIndex = 0 },
...
# 41 "./src/main/drivers/dma.c"
   , .flagsShift = 8, .irqN = DMA2_Channel3_IRQn, .rcc = ((uint32_t)0x00000002), .userParam = 0, .owner = 0, .resourceIndex = 0 },
...
# 42 "./src/main/drivers/dma.c"
   , .flagsShift = 12, .irqN = DMA2_Channel4_IRQn, .rcc = ((uint32_t)0x00000002), .userParam = 0, .owner = 0, .resourceIndex = 0 },
...
# 43 "./src/main/drivers/dma.c"
   , .flagsShift = 16, .irqN = DMA2_Channel5_IRQn, .rcc = ((uint32_t)0x00000002), .userParam = 0, .owner = 0, .resourceIndex = 0 },
...
void DMA1_Channel1_IRQHandler(void) { if (dmaDescriptors[DMA1_CH1_HANDLER].irqHandlerCallback) dmaDescriptors[DMA1_CH1_HANDLER].irqHandlerCallback(&dmaDescriptors[DMA1_CH1_HANDLER]); }
void DMA1_Channel2_IRQHandler(void) { if (dmaDescriptors[DMA1_CH2_HANDLER].irqHandlerCallback) dmaDescriptors[DMA1_CH2_HANDLER].irqHandlerCallback(&dmaDescriptors[DMA1_CH2_HANDLER]); }
void DMA1_Channel3_IRQHandler(void) { if (dmaDescriptors[DMA1_CH3_HANDLER].irqHandlerCallback) dmaDescriptors[DMA1_CH3_HANDLER].irqHandlerCallback(&dmaDescriptors[DMA1_CH3_HANDLER]); }
void DMA1_Channel4_IRQHandler(void) { if (dmaDescriptors[DMA1_CH4_HANDLER].irqHandlerCallback) dmaDescriptors[DMA1_CH4_HANDLER].irqHandlerCallback(&dmaDescriptors[DMA1_CH4_HANDLER]); }
void DMA1_Channel5_IRQHandler(void) { if (dmaDescriptors[DMA1_CH5_HANDLER].irqHandlerCallback) dmaDescriptors[DMA1_CH5_HANDLER].irqHandlerCallback(&dmaDescriptors[DMA1_CH5_HANDLER]); }
void DMA1_Channel6_IRQHandler(void) { if (dmaDescriptors[DMA1_CH6_HANDLER].irqHandlerCallback) dmaDescriptors[DMA1_CH6_HANDLER].irqHandlerCallback(&dmaDescriptors[DMA1_CH6_HANDLER]); }
void DMA1_Channel7_IRQHandler(void) { if (dmaDescriptors[DMA1_CH7_HANDLER].irqHandlerCallback) dmaDescriptors[DMA1_CH7_HANDLER].irqHandlerCallback(&dmaDescriptors[DMA1_CH7_HANDLER]); }


void DMA2_Channel1_IRQHandler(void) { if (dmaDescriptors[DMA2_CH1_HANDLER].irqHandlerCallback) dmaDescriptors[DMA2_CH1_HANDLER].irqHandlerCallback(&dmaDescriptors[DMA2_CH1_HANDLER]); }
void DMA2_Channel2_IRQHandler(void) { if (dmaDescriptors[DMA2_CH2_HANDLER].irqHandlerCallback) dmaDescriptors[DMA2_CH2_HANDLER].irqHandlerCallback(&dmaDescriptors[DMA2_CH2_HANDLER]); }
void DMA2_Channel3_IRQHandler(void) { if (dmaDescriptors[DMA2_CH3_HANDLER].irqHandlerCallback) dmaDescriptors[DMA2_CH3_HANDLER].irqHandlerCallback(&dmaDescriptors[DMA2_CH3_HANDLER]); }
void DMA2_Channel4_IRQHandler(void) { if (dmaDescriptors[DMA2_CH4_HANDLER].irqHandlerCallback) dmaDescriptors[DMA2_CH4_HANDLER].irqHandlerCallback(&dmaDescriptors[DMA2_CH4_HANDLER]); }
void DMA2_Channel5_IRQHandler(void) { if (dmaDescriptors[DMA2_CH5_HANDLER].irqHandlerCallback) dmaDescriptors[DMA2_CH5_HANDLER].irqHandlerCallback(&dmaDescriptors[DMA2_CH5_HANDLER]); }
