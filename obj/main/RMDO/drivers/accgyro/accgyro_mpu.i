...
# 31 "./src/main/drivers/accgyro/accgyro_mpu.c" 2
...
# 67 "./src/main/drivers/accgyro/accgyro_mpu.c"
static void mpu6050FindRevision(gyroDev_t *gyro)
{
    
# 69 "./src/main/drivers/accgyro/accgyro_mpu.c" 3 4
   _Bool 
# 69 "./src/main/drivers/accgyro/accgyro_mpu.c"
        ack;
    (void)(ack);
    ...
    ack = gyro->mpuConfiguration.readFn(&gyro->bus, 0x06, readBuffer, 6);
    ...
    if (revision) {
        ...
        ack = gyro->mpuConfiguration.readFn(&gyro->bus, 0x0C, &productId, 1);
...
# 118 "./src/main/drivers/accgyro/accgyro_mpu.c" 3 4
                     __builtin_offsetof (
# 118 "./src/main/drivers/accgyro/accgyro_mpu.c"
                     gyroDev_t
# 118 "./src/main/drivers/accgyro/accgyro_mpu.c" 3 4
                     , 
# 118 "./src/main/drivers/accgyro/accgyro_mpu.c"
...
# 118 "./src/main/drivers/accgyro/accgyro_mpu.c"
    ...
    gyro->dataReady = 
# 119 "./src/main/drivers/accgyro/accgyro_mpu.c" 3 4
                     1
# 119 "./src/main/drivers/accgyro/accgyro_mpu.c"
                         ;
    if (gyro->updateFn) {
        gyro->updateFn(gyro);
    }
...
# 152 "./src/main/drivers/accgyro/accgyro_mpu.c"
    ...
    EXTIEnable(mpuIntIO, 
# 157 "./src/main/drivers/accgyro/accgyro_mpu.c" 3 4
                        1
# 157 "./src/main/drivers/accgyro/accgyro_mpu.c"
                            );
...
static 
# 165 "./src/main/drivers/accgyro/accgyro_mpu.c" 3 4
      _Bool 
# 165 "./src/main/drivers/accgyro/accgyro_mpu.c"
           mpuReadRegisterI2C(const busDevice_t *bus, uint8_t reg, uint8_t* data, uint8_t length)
{
    (void)(bus);
    const 
# 168 "./src/main/drivers/accgyro/accgyro_mpu.c" 3 4
         _Bool 
# 168 "./src/main/drivers/accgyro/accgyro_mpu.c"
              ack = i2cRead((I2CDEV_1), 0x68, reg, length, data);
    return ack;
}

static 
# 172 "./src/main/drivers/accgyro/accgyro_mpu.c" 3 4
      _Bool 
# 172 "./src/main/drivers/accgyro/accgyro_mpu.c"
           mpuWriteRegisterI2C(const busDevice_t *bus, uint8_t reg, uint8_t data)
{
    (void)(bus);
    const 
# 175 "./src/main/drivers/accgyro/accgyro_mpu.c" 3 4
         _Bool 
# 175 "./src/main/drivers/accgyro/accgyro_mpu.c"
              ack = i2cWrite((I2CDEV_1), 0x68, reg, data);
    return ack;
}


# 179 "./src/main/drivers/accgyro/accgyro_mpu.c" 3 4
_Bool 
# 179 "./src/main/drivers/accgyro/accgyro_mpu.c"
...
# 183 "./src/main/drivers/accgyro/accgyro_mpu.c"
              ack = acc->mpuConfiguration.readFn(&acc->bus, 0x3B, data, 6);
    if (!ack) {
        return 
# 185 "./src/main/drivers/accgyro/accgyro_mpu.c" 3 4
              0
# 185 "./src/main/drivers/accgyro/accgyro_mpu.c"
                   ;
    }
    ...
    return 
# 192 "./src/main/drivers/accgyro/accgyro_mpu.c" 3 4
          1
# 192 "./src/main/drivers/accgyro/accgyro_mpu.c"
              ;
}

void mpuGyroSetIsrUpdate(gyroDev_t *gyro, sensorGyroUpdateFuncPtr updateFn)
{
    for ( uint8_t __basepri_save __attribute__ ((__cleanup__ (__basepriRestoreMem), __unused__)) = __get_BASEPRI(), __ToDo = __basepriSetMemRetVal((((((0x0f)<<(4-(7-(((uint32_t)0x500)>>8))))|((0x0f)&(0x0f>>(7-(((uint32_t)0x500)>>8)))))<<4)&0xf0)); __ToDo ; __ToDo = 0 ) {
        gyro->updateFn = updateFn;
    }
}


# 202 "./src/main/drivers/accgyro/accgyro_mpu.c" 3 4
_Bool 
# 202 "./src/main/drivers/accgyro/accgyro_mpu.c"
    mpuGyroRead(gyroDev_t *gyro)
{
    uint8_t data[6];

    const 
# 206 "./src/main/drivers/accgyro/accgyro_mpu.c" 3 4
         _Bool 
# 206 "./src/main/drivers/accgyro/accgyro_mpu.c"
              ack = gyro->mpuConfiguration.readFn(&gyro->bus, 0x43, data, 6);
    if (!ack) {
        return 
...
# 208 "./src/main/drivers/accgyro/accgyro_mpu.c"
    ...
    return 
# 215 "./src/main/drivers/accgyro/accgyro_mpu.c" 3 4
          1
# 215 "./src/main/drivers/accgyro/accgyro_mpu.c"
              ;
}


# 218 "./src/main/drivers/accgyro/accgyro_mpu.c" 3 4
_Bool 
# 218 "./src/main/drivers/accgyro/accgyro_mpu.c"
    mpuGyroReadSPI(gyroDev_t *gyro)
{
    ...
    const 
# 223 "./src/main/drivers/accgyro/accgyro_mpu.c" 3 4
         _Bool 
# 223 "./src/main/drivers/accgyro/accgyro_mpu.c"
              ack = spiBusTransfer(&gyro->bus, dataToSend, data, 7);
    if (!ack) {
        return 
# 225 "./src/main/drivers/accgyro/accgyro_mpu.c" 3 4
              0
# 225 "./src/main/drivers/accgyro/accgyro_mpu.c"
                   ;
    }
    ...
    return 
# 232 "./src/main/drivers/accgyro/accgyro_mpu.c" 3 4
          1
# 232 "./src/main/drivers/accgyro/accgyro_mpu.c"
              ;
}


static 
# 236 "./src/main/drivers/accgyro/accgyro_mpu.c" 3 4
      _Bool 
# 236 "./src/main/drivers/accgyro/accgyro_mpu.c"
           detectSPISensorsAndUpdateDetectionResult(gyroDev_t *gyro)
{
    ...
    (void)(sensor);
# 341 "./src/main/drivers/accgyro/accgyro_mpu.c"
    return 
# 341 "./src/main/drivers/accgyro/accgyro_mpu.c" 3 4
          0
# 341 "./src/main/drivers/accgyro/accgyro_mpu.c"
               ;
}
...
void mpuDetect(gyroDev_t *gyro)
{
    ...
    gyro->bus.busdev_u.i2c.address = 0x68;
    
# 354 "./src/main/drivers/accgyro/accgyro_mpu.c" 3 4
   _Bool 
# 354 "./src/main/drivers/accgyro/accgyro_mpu.c"
        ack = mpuReadRegisterI2C(&gyro->bus, 0x75, &sig, 1);
    ...
    ack = mpuReadRegisterI2C(&gyro->bus, 0x00, &inquiryResult, 1);
    inquiryResult &= 0x7E;
    if (ack && inquiryResult == (0x68)) {
