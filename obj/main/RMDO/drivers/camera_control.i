...
# 71 "./src/main/drivers/camera_control.c" 3 4
   _Bool 
# 71 "./src/main/drivers/camera_control.c"
        enabled;
    IO_t io;
    timerChannel_t channel;
    uint32_t period;
...
# 121 "./src/main/drivers/camera_control.c" 3 4
                                      1
# 121 "./src/main/drivers/camera_control.c"
                                          ;
        ...
        cameraControlRuntime.enabled = 
# 129 "./src/main/drivers/camera_control.c" 3 4
                                      1
# 129 "./src/main/drivers/camera_control.c"
                                          ;
