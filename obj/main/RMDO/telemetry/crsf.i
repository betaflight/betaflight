...
# 34 "./src/main/telemetry/crsf.c" 2
...
# 40 "./src/main/telemetry/crsf.c" 2
...
# 42 "./src/main/telemetry/crsf.c" 2
...
void mwDisarm(void);
# 46 "./src/main/telemetry/crsf.c" 2
...
void imuInit(void);
# 50 "./src/main/telemetry/crsf.c" 2
...
# 93 "./src/main/rx/crsf.h"
    crsfRxIsActive(void);
# 53 "./src/main/telemetry/crsf.c" 2
...
# 55 "./src/main/telemetry/crsf.c" 2
...
# 4 "./src/main/telemetry/msp_shared.h" 2
...
static 
# 64 "./src/main/telemetry/crsf.c" 3 4
      _Bool 
# 64 "./src/main/telemetry/crsf.c"
           crsfTelemetryEnabled;
static 
# 65 "./src/main/telemetry/crsf.c" 3 4
      _Bool 
# 65 "./src/main/telemetry/crsf.c"
           deviceInfoReplyPending;
static uint8_t crsfFrame[(60 + 4)];
...
# 244 "./src/main/telemetry/crsf.c"
void crsfFrameDeviceInfo(sbuf_t *dst) {

    char buff[30];
    tfp_sprintf(buff, "%s %s: %s", "Betaflight", "3" "." "2" "." "0", systemConfig()->boardIdentifier);
...
static 
# 280 "./src/main/telemetry/crsf.c" 3 4
      _Bool 
# 280 "./src/main/telemetry/crsf.c"
           mspReplyPending;

void crsfScheduleMspResponse(void)
{
    mspReplyPending = 
# 284 "./src/main/telemetry/crsf.c" 3 4
                     1
# 284 "./src/main/telemetry/crsf.c"
                         ;
}
...
{
    deviceInfoReplyPending = 
# 338 "./src/main/telemetry/crsf.c" 3 4
                            1
# 338 "./src/main/telemetry/crsf.c"
                                ;
}
...
void initCrsfTelemetry(void)
{
    ...
    deviceInfoReplyPending = 
# 347 "./src/main/telemetry/crsf.c" 3 4
                            0
# 347 "./src/main/telemetry/crsf.c"
                                 ;

    mspReplyPending = 
# 349 "./src/main/telemetry/crsf.c" 3 4
                     0
# 349 "./src/main/telemetry/crsf.c"
                          ;
...
# 363 "./src/main/telemetry/crsf.c" 3 4
_Bool 
# 363 "./src/main/telemetry/crsf.c"
    checkCrsfTelemetryState(void)
{
...
void handleCrsfTelemetry(timeUs_t currentTimeUs)
{
    ...
    if (currentTimeUs >= crsfLastCycleTime + 100000) {
        ...
        if (deviceInfoReplyPending) {
            ...
            crsfFinalize(dst);
            deviceInfoReplyPending = 
# 392 "./src/main/telemetry/crsf.c" 3 4
                                    0
# 392 "./src/main/telemetry/crsf.c"
                                         ;
