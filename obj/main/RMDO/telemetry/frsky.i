...
# 69 "./src/main/telemetry/frsky.c" 2
...
static void sendThrottleOrBatterySizeAsRpm(void)
{
    ...
    serialize16(escData->dataAge < 255 ? escData->rpm : 0);
# 218 "./src/main/telemetry/frsky.c"
}
...
static void sendTemperature1(void)
{
    ...
    escSensorData_t *escData = getEscSensorData(255);
    serialize16(escData->dataAge < 255 ? escData->temperature : 0);
