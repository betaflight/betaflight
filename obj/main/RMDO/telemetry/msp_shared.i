...
# 5 "./src/main/telemetry/msp_shared.c" 2
...
# 8 "./src/main/telemetry/msp_shared.c" 2
...
# 12 "./src/main/telemetry/msp_shared.c" 2
...
# 93 "./src/main/rx/crsf.h"
    crsfRxIsActive(void);
# 20 "./src/main/telemetry/msp_shared.c" 2
...
# 21 "./src/main/telemetry/msp_shared.c" 2
...
# 23 "./src/main/telemetry/msp_shared.c" 2
# 33 "./src/main/telemetry/msp_shared.c"
enum {
...
# 68 "./src/main/telemetry/msp_shared.c" 3 4
                                          ((void *)0)
# 68 "./src/main/telemetry/msp_shared.c"
                                              ;
    ...
    if (mspPostProcessFn) {
        mspPostProcessFn(
# 73 "./src/main/telemetry/msp_shared.c" 3 4
                        ((void *)0)
# 73 "./src/main/telemetry/msp_shared.c"
                            );
    }
    ...
    handleMspFrame(uint8_t *frameStart, uint8_t *frameEnd)
{
    ...
    if (version != 1) {
        ...
        return 
# 112 "./src/main/telemetry/msp_shared.c" 3 4
              1
# 112 "./src/main/telemetry/msp_shared.c"
                  ;
    }
    ...
    if (header & (1 << 4)) {
        ...
        return 
# 128 "./src/main/telemetry/msp_shared.c" 3 4
              0
# 128 "./src/main/telemetry/msp_shared.c"
                   ;
    } else if (((lastSeq + 1) & 0x0F) != seqNumber) {

        mspStarted = 0;
        return 
# 132 "./src/main/telemetry/msp_shared.c" 3 4
              0
# 132 "./src/main/telemetry/msp_shared.c"
                   ;
    }
    ...
    if (bufferBytesRemaining >= frameBytesRemaining) {
        ...
        lastSeq = seqNumber;
        return 
# 144 "./src/main/telemetry/msp_shared.c" 3 4
              0
# 144 "./src/main/telemetry/msp_shared.c"
                   ;
    } else {
        ...
        if (checksum != *frameBuf->ptr) {
            ...
            return 
# 157 "./src/main/telemetry/msp_shared.c" 3 4
                  1
# 157 "./src/main/telemetry/msp_shared.c"
                      ;
        }
    }
    ...
    processMspPacket();
    return 
# 164 "./src/main/telemetry/msp_shared.c" 3 4
          1
# 164 "./src/main/telemetry/msp_shared.c"
              ;
}


# 167 "./src/main/telemetry/msp_shared.c" 3 4
_Bool 
# 167 "./src/main/telemetry/msp_shared.c"
    sendMspReply(uint8_t payloadSize, mspResponseFnPtr responseFn)
{
    static uint8_t checksum = 0;
    ...
    if (bufferBytesRemaining >= payloadBytesRemaining) {
        ...
        return 
# 205 "./src/main/telemetry/msp_shared.c" 3 4
              1
# 205 "./src/main/telemetry/msp_shared.c"
                  ;
