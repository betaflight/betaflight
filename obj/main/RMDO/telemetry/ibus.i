...
# 34 "./src/main/telemetry/ibus.c" 2
...
# 36 "./src/main/telemetry/ibus.c" 2
...
# 41 "./src/main/telemetry/ibus.c" 2
...
# 43 "./src/main/telemetry/ibus.c" 2
...
# 45 "./src/main/telemetry/ibus.c" 2
...
# 47 "./src/main/telemetry/ibus.c" 2
...
# 49 "./src/main/telemetry/ibus.c" 2
...
# 24 "./src/main/sensors/battery.h" 2
...
# 50 "./src/main/telemetry/ibus.c" 2
...
# 51 "./src/main/telemetry/ibus.c" 2
...
# 52 "./src/main/telemetry/ibus.c" 2
...
# 55 "./src/main/telemetry/ibus.c" 2
...
# 58 "./src/main/telemetry/ibus.c" 2
...
# 59 "./src/main/telemetry/ibus.c" 2
# 73 "./src/main/telemetry/ibus.c"
static serialPort_t *ibusSerialPort = 
# 73 "./src/main/telemetry/ibus.c" 3 4
                                     ((void *)0)
# 73 "./src/main/telemetry/ibus.c"
                                         ;
...
static 
# 80 "./src/main/telemetry/ibus.c" 3 4
      _Bool 
# 80 "./src/main/telemetry/ibus.c"
...
static uint8_t ibusReceiveBuffer[((4))] = { 0x0 };



static void pushOntoTail(uint8_t buffer[(2 + (2))], size_t bufferLength, uint8_t value)
{
...
void initIbusTelemetry(void)
{
    ...
    ibusTelemetryEnabled = 
# 98 "./src/main/telemetry/ibus.c" 3 4
                          0
# 98 "./src/main/telemetry/ibus.c"
                               ;
}
...
void handleIbusTelemetry(void)
{
    ...
    while (serialRxBytesWaiting(ibusSerialPort) > 0) {
        ...
        pushOntoTail(ibusReceiveBuffer, ((4)), c);

        if (isChecksumOkIa6b(ibusReceiveBuffer, ((4)))) {
...
# 125 "./src/main/telemetry/ibus.c" 3 4
_Bool 
# 125 "./src/main/telemetry/ibus.c"
    checkIbusTelemetryState(void)
{
    
# 127 "./src/main/telemetry/ibus.c" 3 4
   _Bool 
# 127 "./src/main/telemetry/ibus.c"
        newTelemetryEnabledValue = telemetryDetermineEnabledState(ibusPortSharing);

    if (newTelemetryEnabledValue == ibusTelemetryEnabled) {
        return 
# 130 "./src/main/telemetry/ibus.c" 3 4
              0
# 130 "./src/main/telemetry/ibus.c"
                   ;
    }

    if (newTelemetryEnabledValue) {
        rescheduleTask(TASK_TELEMETRY, (1000));
    ...
    return 
# 140 "./src/main/telemetry/ibus.c" 3 4
          1
# 140 "./src/main/telemetry/ibus.c"
              ;
}
...
void configureIbusTelemetryPort(void)
{
    ...
    ibusSerialPort = openSerialPort(ibusSerialPortConfig->identifier, FUNCTION_TELEMETRY_IBUS, 
# 155 "./src/main/telemetry/ibus.c" 3 4
                                                                                              ((void *)0)
# 155 "./src/main/telemetry/ibus.c"
                                                                                                  , (115200), (MODE_RXTX), SERIAL_BIDIR | (telemetryConfig()->telemetry_inverted ? SERIAL_INVERTED : SERIAL_NOT_INVERTED));
    ...
    ibusTelemetryEnabled = 
# 162 "./src/main/telemetry/ibus.c" 3 4
                          1
# 162 "./src/main/telemetry/ibus.c"
                              ;
...
void freeIbusTelemetryPort(void)
{
    ...
    ibusSerialPort = 
# 170 "./src/main/telemetry/ibus.c" 3 4
                    ((void *)0)
# 170 "./src/main/telemetry/ibus.c"
                        ;
    ibusTelemetryEnabled = 
# 171 "./src/main/telemetry/ibus.c" 3 4
                          0
# 171 "./src/main/telemetry/ibus.c"
                               ;
}
