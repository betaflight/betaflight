...
# 78 "./src/main/telemetry/hott.c" 2
...
# 80 "./src/main/telemetry/hott.c" 2
...
# 84 "./src/main/telemetry/hott.c" 2
...
# 101 "./src/main/telemetry/hott.c" 3 4
                         ((void *)0)
# 101 "./src/main/telemetry/hott.c"
                             ;
...
# 110 "./src/main/telemetry/hott.c" 3 4
                               ((void *)0)
# 110 "./src/main/telemetry/hott.c"
                                   ;
static serialPortConfig_t *portConfig;

static 
# 113 "./src/main/telemetry/hott.c" 3 4
      _Bool 
# 113 "./src/main/telemetry/hott.c"
...
# 221 "./src/main/telemetry/hott.c"
static 
# 221 "./src/main/telemetry/hott.c" 3 4
      _Bool 
# 221 "./src/main/telemetry/hott.c"
...
# 304 "./src/main/telemetry/hott.c"
                  ;
    hottTelemetryEnabled = 
# 305 "./src/main/telemetry/hott.c" 3 4
                          0
# 305 "./src/main/telemetry/hott.c"
                               ;
}
...
# 333 "./src/main/telemetry/hott.c" 3 4
                                                                            ((void *)0)
# 333 "./src/main/telemetry/hott.c"
                                                                                , 19200, mode, portOptions);
}

static 
# 336 "./src/main/telemetry/hott.c" 3 4
      _Bool 
# 336 "./src/main/telemetry/hott.c"
...
static void hottReconfigurePort(void)
{
    if (!hottIsSending) {
        hottIsSending = 
# 365 "./src/main/telemetry/hott.c" 3 4
                       1
# 365 "./src/main/telemetry/hott.c"
                           ;
        hottMsgCrc = 0;
    ...
    if (hottMsgRemainingBytesToSendCount == 0) {
        hottMsg = 
# 372 "./src/main/telemetry/hott.c" 3 4
                 ((void *)0)
# 372 "./src/main/telemetry/hott.c"
                     ;
        hottIsSending = 
# 373 "./src/main/telemetry/hott.c" 3 4
                       0
# 373 "./src/main/telemetry/hott.c"
                            ;
...
# 391 "./src/main/telemetry/hott.c" 3 4
                                                                              ((void *)0)
# 391 "./src/main/telemetry/hott.c"
    ...
    hottTelemetryEnabled = 
# 399 "./src/main/telemetry/hott.c" 3 4
                          1
# 399 "./src/main/telemetry/hott.c"
                              ;
}
...
{
    static 
# 469 "./src/main/telemetry/hott.c" 3 4
          _Bool 
# 469 "./src/main/telemetry/hott.c"
               lookingForRequest = 
# 469 "./src/main/telemetry/hott.c" 3 4
                                   1
# 469 "./src/main/telemetry/hott.c"
...
# 479 "./src/main/telemetry/hott.c"
    ...
    if (lookingForRequest) {
        ...
        lookingForRequest = 
# 485 "./src/main/telemetry/hott.c" 3 4
                           0
# 485 "./src/main/telemetry/hott.c"
                                ;
        return;
    } else {
        
# 488 "./src/main/telemetry/hott.c" 3 4
       _Bool 
# 488 "./src/main/telemetry/hott.c"
        ...
        lookingForRequest = 
# 493 "./src/main/telemetry/hott.c" 3 4
                           1
# 493 "./src/main/telemetry/hott.c"
                               ;
    }
...
static inline 
# 525 "./src/main/telemetry/hott.c" 3 4
             _Bool 
# 525 "./src/main/telemetry/hott.c"
...
static inline 
# 530 "./src/main/telemetry/hott.c" 3 4
             _Bool 
# 530 "./src/main/telemetry/hott.c"
                  shouldCheckForHoTTRequest(void)
{
    if (hottIsSending) {
        return 
# 533 "./src/main/telemetry/hott.c" 3 4
              0
# 533 "./src/main/telemetry/hott.c"
                   ;
    }
    return 
# 535 "./src/main/telemetry/hott.c" 3 4
          1
# 535 "./src/main/telemetry/hott.c"
              ;
}
...
{
    const 
# 540 "./src/main/telemetry/hott.c" 3 4
         _Bool 
# 540 "./src/main/telemetry/hott.c"
