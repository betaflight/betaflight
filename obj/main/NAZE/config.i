# 1 "./src/main/target/NAZE/config.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "./src/main/target/NAZE/config.c"
# 18 "./src/main/target/NAZE/config.c"
...
# 19 "./src/main/target/NAZE/config.c" 2
...
# 20 "./src/main/target/NAZE/config.c" 2
...
# 22 "./src/main/target/NAZE/config.c" 2
...
# 26 "./src/main/target/NAZE/config.c" 2
...
# 27 "./src/main/target/NAZE/config.c" 2
...
# 29 "./src/main/target/NAZE/config.c" 2
...
# 30 "./src/main/target/NAZE/config.c" 2
...
# 31 "./src/main/target/NAZE/config.c" 2
...
# 33 "./src/main/target/NAZE/config.c" 2
...
# 34 "./src/main/target/NAZE/config.c" 2
...
# 35 "./src/main/target/NAZE/config.c" 2
...
# 37 "./src/main/target/NAZE/config.c" 2
...
# 39 "./src/main/target/NAZE/config.c" 2
...
# 40 "./src/main/target/NAZE/config.c" 2
...
# 41 "./src/main/target/NAZE/config.c" 2
...
# 43 "./src/main/target/NAZE/config.c" 2

void targetConfiguration(void)
{
# 95 "./src/main/target/NAZE/config.c"
    if (hardwareRevision >= NAZE32_REV5) {

        beeperDevConfigMutable()->isOpenDrain = 
# 97 "./src/main/target/NAZE/config.c" 3 4
                                               0
# 97 "./src/main/target/NAZE/config.c"
                                                    ;
        beeperDevConfigMutable()->isInverted = 
# 98 "./src/main/target/NAZE/config.c" 3 4
                                              1
# 98 "./src/main/target/NAZE/config.c"
                                                  ;
    } else {
        beeperDevConfigMutable()->isOpenDrain = 
# 100 "./src/main/target/NAZE/config.c" 3 4
                                               1
# 100 "./src/main/target/NAZE/config.c"
                                                   ;
        beeperDevConfigMutable()->isInverted = 
# 101 "./src/main/target/NAZE/config.c" 3 4
                                              0
# 101 "./src/main/target/NAZE/config.c"
                                                   ;
        flashConfigMutable()->csTag = 0;
    }



    if (hardwareRevision < NAZE32_REV5) {
        compassConfigMutable()->interruptTag = ((ioTag_t)((((1) + 1) << 4) | (12)));
    }
