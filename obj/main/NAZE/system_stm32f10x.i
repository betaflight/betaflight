# 1 "./lib/main/CMSIS/CM3/DeviceSupport/ST/STM32F10x/system_stm32f10x.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "./lib/main/CMSIS/CM3/DeviceSupport/ST/STM32F10x/system_stm32f10x.c"
...
# 2 "./lib/main/CMSIS/CM3/DeviceSupport/ST/STM32F10x/system_stm32f10x.c" 2
...
# 3 "./lib/main/CMSIS/CM3/DeviceSupport/ST/STM32F10x/system_stm32f10x.c" 2
...
void SetSysClock(
# 90 "./lib/main/CMSIS/CM3/DeviceSupport/ST/STM32F10x/system_stm32f10x.c" 3 4
                _Bool 
# 90 "./lib/main/CMSIS/CM3/DeviceSupport/ST/STM32F10x/system_stm32f10x.c"
                     overclock)
{
    volatile uint32_t StartUpCounter = 0, status = 0, clocksrc = SRC_NONE;
    volatile uint32_t *RCC_CRH = &((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1000))->CRH;
    volatile uint32_t RCC_CFGR_PLLMUL = ((uint32_t)0x001C0000);
    ...
    do {
        status = ((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x1000))->CR & ((uint32_t)0x00020000);
        StartUpCounter++;
    } while ((status == 0) && (StartUpCounter != ((uint16_t)0x0500)));
    ...
    if ((((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x1000))->CR & ((uint32_t)0x00020000)) != RESET) {
        ...
        ((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x1000))->CR |= ((uint32_t)((uint32_t)0x00000001));
        StartUpCounter = 0;
        do {
            status = ((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x1000))->CR & ((uint32_t)0x00000002);
            StartUpCounter++;
        } while ((status == 0) && (StartUpCounter != ((uint16_t)0x0500)));
        if ((((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x1000))->CR & ((uint32_t)0x00000002)) != RESET) {
    ...
    *RCC_CRH &= (uint32_t)~((uint32_t)0xF << (((uint32_t)0x001C0000) >> 16));
    ...
    *RCC_CRH |= (uint32_t)0x8 << (((uint32_t)0x001C0000) >> 16);
    ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1000))->ODR &= (uint32_t)~(((uint16_t)0x8000));





    RCC_CFGR_PLLMUL = ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x1000))->IDR & ((uint16_t)0x8000) ? hse_value = 12000000, ((uint32_t)0x00100000) : ((uint32_t)0x001C0000);

    switch (clocksrc) {
        case SRC_HSE:
            if (overclock) {
                if (RCC_CFGR_PLLMUL == ((uint32_t)0x00100000))
                    RCC_CFGR_PLLMUL = ((uint32_t)0x00140000);
                else if (RCC_CFGR_PLLMUL == ((uint32_t)0x001C0000))
                    RCC_CFGR_PLLMUL = ((uint32_t)0x00200000);
            }


            ((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x1000))->CFGR |= (uint32_t)(((uint32_t)0x00010000) | RCC_CFGR_PLLMUL);
            break;
        case SRC_HSI:

            ((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x1000))->CFGR |= (uint32_t)(((uint32_t)0x00000000) | ((uint32_t)0x00380000));
            break;
    }
