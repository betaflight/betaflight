...
# 21 "./src/main/drivers/sound_beeper.h" 2
...
static 
# 53 "./src/main/flight/pid.c" 3 4
      _Bool 
# 53 "./src/main/flight/pid.c"
...
# 151 "./src/main/flight/pid.c" 3 4
                                                                            1 
# 151 "./src/main/flight/pid.c"
                                                                                 : 
# 151 "./src/main/flight/pid.c" 3 4
                                                                                   0
# 151 "./src/main/flight/pid.c"
...
void pidController(const pidProfile_t *pidProfile, const rollAndPitchTrims_t *angleTrim, timeUs_t currentTimeUs)
{
    ...
    static 
# 410 "./src/main/flight/pid.c" 3 4
          _Bool 
# 410 "./src/main/flight/pid.c"
               inCrashRecoveryMode = 
# 410 "./src/main/flight/pid.c" 3 4
                                     0
# 410 "./src/main/flight/pid.c"
    ...
    for (int axis = FD_ROLL; axis <= FD_YAW; axis++) {
        ...
        if (inCrashRecoveryMode && cmpTimeUs(currentTimeUs, crashDetectedAtUs) > crashTimeDelayUs) {
            if (pidProfile->crash_recovery == PID_CRASH_RECOVERY_BEEP) {
                systemBeep(
# 433 "./src/main/flight/pid.c" 3 4
               1
# 433 "./src/main/flight/pid.c"
               );
            }
            if (axis == FD_YAW) {
                ...
                if (sensors(SENSOR_ACC)) {
                    ...
                    if (__extension__ ({ __typeof__ (attitude.raw[FD_ROLL] - angleTrim->raw[FD_ROLL]) _x = (attitude.raw[FD_ROLL] - angleTrim->raw[FD_ROLL]); _x > 0 ? _x : -_x; }) < crashRecoveryAngleDeciDegrees
                       && __extension__ ({ __typeof__ (attitude.raw[FD_PITCH] - angleTrim->raw[FD_PITCH]) _x = (attitude.raw[FD_PITCH] - angleTrim->raw[FD_PITCH]); _x > 0 ? _x : -_x; }) < crashRecoveryAngleDeciDegrees) {
                        inCrashRecoveryMode = 
# 472 "./src/main/flight/pid.c" 3 4
                                             0
# 472 "./src/main/flight/pid.c"
                                                  ;
                        systemBeep(
# 473 "./src/main/flight/pid.c" 3 4
                       0
# 473 "./src/main/flight/pid.c"
                       );
                    }
                } else {
                    inCrashRecoveryMode = 
# 476 "./src/main/flight/pid.c" 3 4
                                         0
# 476 "./src/main/flight/pid.c"
                                              ;
                    systemBeep(
# 477 "./src/main/flight/pid.c" 3 4
                   0
# 477 "./src/main/flight/pid.c"
                   );
                }
            }
        }
        ...
        const 
# 495 "./src/main/flight/pid.c" 3 4
             _Bool 
# 495 "./src/main/flight/pid.c"
                  outputSaturated = mixerIsOutputSaturated(axis, errorRate);
        if (outputSaturated == 
# 496 "./src/main/flight/pid.c" 3 4
                              0 
# 496 "./src/main/flight/pid.c"
        ...
        if (axis != FD_YAW) {
            ...
            if (pidProfile->crash_recovery && (armingFlags & (ARMED))) {
                if (motorMixRange >= 1.0f && inCrashRecoveryMode == 
# 519 "./src/main/flight/pid.c" 3 4
                                                                   0
                        
# 520 "./src/main/flight/pid.c"
                    ...
                    inCrashRecoveryMode = 
# 523 "./src/main/flight/pid.c" 3 4
                                         1
# 523 "./src/main/flight/pid.c"
                                             ;
                    crashDetectedAtUs = currentTimeUs;
                }
                if (cmpTimeUs(currentTimeUs, crashDetectedAtUs) < crashTimeDelayUs && (__extension__ ({ __typeof__ (errorRate) _x = (errorRate); _x > 0 ? _x : -_x; }) < crashGyroThreshold
                    || __extension__ ({ __typeof__ (getSetpointRate(axis)) _x = (getSetpointRate(axis)); _x > 0 ? _x : -_x; }) > crashSetpointThreshold)) {
                    inCrashRecoveryMode = 
