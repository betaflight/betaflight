...
# 58 "./src/main/blackbox/blackbox_io.c"
void blackboxOpen(void)
{
...
# 97 "./src/main/blackbox/blackbox_io.c" 3 4
                                                0
# 97 "./src/main/blackbox/blackbox_io.c"
                                                     );
        break;
# 108 "./src/main/blackbox/blackbox_io.c"
    case BLACKBOX_DEVICE_SERIAL:
    default:
        pos = (uint8_t*) s;
        while (*pos) {
...
# 171 "./src/main/blackbox/blackbox_io.c"
    default:
        return 
...
# 237 "./src/main/blackbox/blackbox_io.c"
    ...
    case BLACKBOX_DEVICE_FLASH:
        if (flashfsGetSize() == 0 || isBlackboxDeviceFull()) {
            return 
# 243 "./src/main/blackbox/blackbox_io.c" 3 4
                  0
# 243 "./src/main/blackbox/blackbox_io.c"
                       ;
        }
        ...
        return 
# 248 "./src/main/blackbox/blackbox_io.c" 3 4
              1
# 248 "./src/main/blackbox/blackbox_io.c"
                  ;
        break;
# 262 "./src/main/blackbox/blackbox_io.c"
    default:
        return 
...
# 286 "./src/main/blackbox/blackbox_io.c" 3 4
_Bool 
# 286 "./src/main/blackbox/blackbox_io.c"
    isBlackboxErased(void)
{
    switch (blackboxConfig()->device) {
    case BLACKBOX_DEVICE_FLASH:
    ...
    default:
        ...
        return 
# 294 "./src/main/blackbox/blackbox_io.c" 3 4
              1
# 294 "./src/main/blackbox/blackbox_io.c"
                  ;
        break;
    }
}
                              ...
                              retainLog)
{
    ...
    switch (blackboxConfig()->device) {
# 488 "./src/main/blackbox/blackbox_io.c"
    default:
        return 
...
blackboxBufferReserveStatus_e blackboxDeviceReserveBufferSpace(int32_t bytes)
{
    ...
    case BLACKBOX_DEVICE_FLASH:
        ...
        return BLACKBOX_RESERVE_TEMPORARY_FAILURE;
# 609 "./src/main/blackbox/blackbox_io.c"
    default:
        return BLACKBOX_RESERVE_PERMANENT_FAILURE;
    }
}
