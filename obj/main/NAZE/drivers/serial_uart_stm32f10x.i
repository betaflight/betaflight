...
# 1 "<command-line>"
# 1 "./src/main/drivers/serial_uart_stm32f10x.c"
# 26 "./src/main/drivers/serial_uart_stm32f10x.c"
...
# 60 "./src/main/drivers/serial_uart_stm32f10x.c"
const uartHardware_t uartHardware[(1 + 1 + 0 + 0 + 0 + 0 + 0 + 0)] = {

    {
        .device = UARTDEV_1,
        .reg = ((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x3800)),
        .rxDMAChannel = ((DMA_Channel_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x0058)),
        .txDMAChannel = ((DMA_Channel_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x0044)),
...

    {
        ...
        .rxDMAChannel = 0,
        .txDMAChannel = 0,
        .rxPins = { ((ioTag_t)((((0) + 1) << 4) | (3))), 0, 0 },
        .txPins = { ((ioTag_t)((((0) + 1) << 4) | (2))), 0, 0 },
        ...
        .irqn = USART2_IRQn,
        .txPriority = (((((1)<<(4-(7-(((uint32_t)0x500)>>8))))|((2)&(0x0f>>(7-(((uint32_t)0x500)>>8)))))<<4)&0xf0),
        .rxPriority = (((((1)<<(4-(7-(((uint32_t)0x500)>>8))))|((2)&(0x0f>>(7-(((uint32_t)0x500)>>8)))))<<4)&0xf0)
    },
# 106 "./src/main/drivers/serial_uart_stm32f10x.c"
};
...
uartPort_t *serialUART(UARTDevice_e device, uint32_t baudRate, portMode_e mode, portOptions_e options)
{
    ...
    if (!uartdev) {
        return 
# 123 "./src/main/drivers/serial_uart_stm32f10x.c" 3 4
              ((void *)0)
# 123 "./src/main/drivers/serial_uart_stm32f10x.c"
                  ;
    }
    ...
    s->port.rxBufferSize = (sizeof(uartdev->rxBuffer) / sizeof((uartdev->rxBuffer)[0]));
    s->port.txBufferSize = (sizeof(uartdev->txBuffer) / sizeof((uartdev->txBuffer)[0]));
    ...
    if (options & SERIAL_BIDIR) {
        ...
        IOConfigGPIO(txIO, (options & SERIAL_BIDIR_PP) ? ((GPIO_Mode_AF_PP) | (GPIO_Speed_2MHz)) : ((GPIO_Mode_AF_OD) | (GPIO_Speed_2MHz)));
    } else {
        if (mode & MODE_TX) {
            IOInit(txIO, OWNER_SERIAL_TX, (device + 1));
            IOConfigGPIO(txIO, ((GPIO_Mode_AF_PP) | (GPIO_Speed_2MHz)));
        }

        if (mode & MODE_RX) {
            IOInit(rxIO, OWNER_SERIAL_RX, (device + 1));
            IOConfigGPIO(rxIO, ((GPIO_Mode_IPU) | (GPIO_Speed_2MHz)));
        }
    }
