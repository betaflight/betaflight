# 1 "./src/main/drivers/inverter.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "./src/main/drivers/inverter.c"
# 18 "./src/main/drivers/inverter.c"
...
# 19 "./src/main/drivers/inverter.c" 2
...
# 20 "./src/main/drivers/inverter.c" 2
...
# 22 "./src/main/drivers/inverter.c" 2
...
# 24 "./src/main/drivers/inverter.c" 2
...
# 29 "./src/main/drivers/inverter.c" 2
...
# 28 "./src/main/drivers/inverter.h"
                                               on);
# 31 "./src/main/drivers/inverter.c" 2



static const serialPinConfig_t *pSerialPinConfig;

static void inverterSet(int identifier, 
# 36 "./src/main/drivers/inverter.c" 3 4
                                       _Bool 
# 36 "./src/main/drivers/inverter.c"
                                            on)
{
    IO_t pin = IOGetByTag(pSerialPinConfig->ioTagInverter[(((identifier) <= SERIAL_PORT_USART8) ? (identifier) : (10 + ((identifier) - SERIAL_PORT_SOFTSERIAL1)))]);
...
{
    int uartIndex = (((identifier) <= SERIAL_PORT_USART8) ? (identifier) : (10 + ((identifier) - SERIAL_PORT_SOFTSERIAL1)));
    IO_t pin = IOGetByTag(pSerialPinConfig->ioTagInverter[uartIndex]);

    if (pin) {
        IOInit(pin, OWNER_INVERTER, (uartIndex + 1));
        IOConfigGPIO(pin, ((GPIO_Mode_Out_PP) | (GPIO_Speed_2MHz)));

        inverterSet(identifier, 
# 54 "./src/main/drivers/inverter.c" 3 4
                               0
# 54 "./src/main/drivers/inverter.c"
                                    );
    }
}
...
# 85 "./src/main/drivers/inverter.c"
}

void enableInverter(USART_TypeDef *USARTx, 
# 87 "./src/main/drivers/inverter.c" 3 4
                                          _Bool 
# 87 "./src/main/drivers/inverter.c"
                                               on)
{
    ...
    if (USARTx == ((USART_TypeDef *) (((uint32_t)0x40000000) + 0x4400))) {
        identifier = SERIAL_PORT_USART2;
    }
# 127 "./src/main/drivers/inverter.c"
