...
# 36 "./src/main/drivers/serial_softserial.c" 2
...
static void serialInputPortActivate(softSerial_t *softSerial)
{
    if (softSerial->port.options & SERIAL_INVERTED) {
        ...
        IOConfigGPIO(softSerial->rxIO, ((GPIO_Mode_IPD) | (GPIO_Speed_2MHz)));



    } else {

        IOConfigGPIO(softSerial->rxIO, ((GPIO_Mode_IPU) | (GPIO_Speed_2MHz)));
...
static void serialInputPortDeActivate(softSerial_t *softSerial)
{
    ...
    IOConfigGPIO(softSerial->rxIO, ((GPIO_Mode_IN_FLOATING) | (GPIO_Speed_2MHz)));



    softSerial->rxActive = 
# 169 "./src/main/drivers/serial_softserial.c" 3 4
                          0
# 169 "./src/main/drivers/serial_softserial.c"
                               ;
}
...
static void serialOutputPortActivate(softSerial_t *softSerial)
{
    ...
    IOConfigGPIO(softSerial->txIO, ((GPIO_Mode_Out_PP) | (GPIO_Speed_2MHz)));
...
static void serialOutputPortDeActivate(softSerial_t *softSerial)
{
    ...
    IOConfigGPIO(softSerial->txIO, ((GPIO_Mode_IN_FLOATING) | (GPIO_Speed_2MHz)));
...
static 
# 196 "./src/main/drivers/serial_softserial.c" 3 4
      _Bool 
# 196 "./src/main/drivers/serial_softserial.c"
...
serialPort_t *openSoftSerial(softSerialPortIndex_e portIndex, serialReceiveCallbackPtr rxCallback, uint32_t baud, portMode_e mode, portOptions_e options)
{
    ...
    if (options & SERIAL_BIDIR) {
        ...
        if (!timerTx || (timerTx->output & TIMER_OUTPUT_N_CHANNEL)) {
            return 
# 255 "./src/main/drivers/serial_softserial.c" 3 4
                  ((void *)0)
# 255 "./src/main/drivers/serial_softserial.c"
                      ;
        }
        ...
        if (mode & MODE_RX) {
            ...
            if (!timerRx || (timerRx->output & TIMER_OUTPUT_N_CHANNEL)) {
                return 
# 266 "./src/main/drivers/serial_softserial.c" 3 4
                      ((void *)0)
# 266 "./src/main/drivers/serial_softserial.c"
                          ;
            }
        ...
        if (mode & MODE_TX) {
            ...
            if (!tagTx)
                return 
# 277 "./src/main/drivers/serial_softserial.c" 3 4
                      ((void *)0)
# 277 "./src/main/drivers/serial_softserial.c"
                          ;
            ...
            if (!(mode & MODE_RX)) {
                ...
                if (!timerTx)
                    return 
# 284 "./src/main/drivers/serial_softserial.c" 3 4
                          ((void *)0)
# 284 "./src/main/drivers/serial_softserial.c"
                              ;
                softSerial->timerHardware = timerTx;
            } else {
    ...
    softSerial->rxActive = 
# 307 "./src/main/drivers/serial_softserial.c" 3 4
                          0
# 307 "./src/main/drivers/serial_softserial.c"
                               ;
    softSerial->isTransmittingData = 
# 308 "./src/main/drivers/serial_softserial.c" 3 4
                                    0
# 308 "./src/main/drivers/serial_softserial.c"
                                         ;
...
# 313 "./src/main/drivers/serial_softserial.c" 3 4
                                                                            1 
# 313 "./src/main/drivers/serial_softserial.c"
                                                                                              : 
# 313 "./src/main/drivers/serial_softserial.c" 3 4
                                                                                                0
# 313 "./src/main/drivers/serial_softserial.c"
...
# 327 "./src/main/drivers/serial_softserial.c" 3 4
                                                           ((void *)0)
# 327 "./src/main/drivers/serial_softserial.c"
                                                               , &softSerial->overCb);
        timerChConfigCallbacks(softSerial->timerHardware, &softSerial->edgeCb, 
# 328 "./src/main/drivers/serial_softserial.c" 3 4
                                                                              ((void *)0)
# 328 "./src/main/drivers/serial_softserial.c"
                                                                                  );
    } else {
...
void processTxState(softSerial_t *softSerial)
{
    ...
    if (!softSerial->isTransmittingData) {
        ...
        softSerial->isTransmittingData = 
# 377 "./src/main/drivers/serial_softserial.c" 3 4
                                        1
# 377 "./src/main/drivers/serial_softserial.c"
                                            ;
    ...
    softSerial->isTransmittingData = 
# 397 "./src/main/drivers/serial_softserial.c" 3 4
                                    0
# 397 "./src/main/drivers/serial_softserial.c"
                                         ;
}
...
void prepareForNextRxByte(softSerial_t *softSerial)
{
    ...
    softSerial->rxBitIndex = 0;
    softSerial->isSearchingForStartBit = 
# 419 "./src/main/drivers/serial_softserial.c" 3 4
                                        1
# 419 "./src/main/drivers/serial_softserial.c"
                                            ;
...
# 422 "./src/main/drivers/serial_softserial.c" 3 4
                                                                                                 1 
# 422 "./src/main/drivers/serial_softserial.c"
                                                                                                                   : 
# 422 "./src/main/drivers/serial_softserial.c" 3 4
                                                                                                                     0
# 422 "./src/main/drivers/serial_softserial.c"
...
# 481 "./src/main/drivers/serial_softserial.c" 3 4
                        __builtin_offsetof (
# 481 "./src/main/drivers/serial_softserial.c"
                        softSerial_t
# 481 "./src/main/drivers/serial_softserial.c" 3 4
                        , 
# 481 "./src/main/drivers/serial_softserial.c"
...
# 494 "./src/main/drivers/serial_softserial.c" 3 4
                        __builtin_offsetof (
# 494 "./src/main/drivers/serial_softserial.c"
                        softSerial_t
# 494 "./src/main/drivers/serial_softserial.c" 3 4
                        , 
# 494 "./src/main/drivers/serial_softserial.c"
...
# 495 "./src/main/drivers/serial_softserial.c" 3 4
   _Bool 
# 495 "./src/main/drivers/serial_softserial.c"
...
# 520 "./src/main/drivers/serial_softserial.c" 3 4
                                                       0 
# 520 "./src/main/drivers/serial_softserial.c"
                                                                          : 
# 520 "./src/main/drivers/serial_softserial.c" 3 4
                                                                            1
# 520 "./src/main/drivers/serial_softserial.c"
...
# 529 "./src/main/drivers/serial_softserial.c" 3 4
                                      0
# 529 "./src/main/drivers/serial_softserial.c"
                                           ;
        return;
    }
    ...
    if (self->rxEdge == TRAILING) {
        self->rxEdge = LEADING;
        timerChConfigIC(self->timerHardware, inverted ? 
# 541 "./src/main/drivers/serial_softserial.c" 3 4
                                                       0 
# 541 "./src/main/drivers/serial_softserial.c"
                                                                          : 
# 541 "./src/main/drivers/serial_softserial.c" 3 4
                                                                            1
# 541 "./src/main/drivers/serial_softserial.c"
        ...
        timerChConfigIC(self->timerHardware, inverted ? 
# 544 "./src/main/drivers/serial_softserial.c" 3 4
                                                       1 
# 544 "./src/main/drivers/serial_softserial.c"
                                                                         : 
# 544 "./src/main/drivers/serial_softserial.c" 3 4
                                                                           0
# 544 "./src/main/drivers/serial_softserial.c"
...
# 621 "./src/main/drivers/serial_softserial.c" 3 4
_Bool 
# 621 "./src/main/drivers/serial_softserial.c"
...
static const struct serialPortVTable softSerialVTable = {
    ...
    .writeBuf = 
# 634 "./src/main/drivers/serial_softserial.c" 3 4
               ((void *)0)
# 634 "./src/main/drivers/serial_softserial.c"
                   ,
    .beginWrite = 
# 635 "./src/main/drivers/serial_softserial.c" 3 4
                 ((void *)0)
# 635 "./src/main/drivers/serial_softserial.c"
                     ,
    .endWrite = 
