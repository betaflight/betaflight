...
# 168 "./src/main/drivers/accgyro/accgyro_mpu.c"
              ack = i2cRead((I2CDEV_2), 0x68, reg, length, data);
    return ack;
}
...
# 175 "./src/main/drivers/accgyro/accgyro_mpu.c"
              ack = i2cWrite((I2CDEV_2), 0x68, reg, data);
    return ack;
}
           ...
           detectSPISensorsAndUpdateDetectionResult(gyroDev_t *gyro)
{
    ...
    (void)(sensor);
# 261 "./src/main/drivers/accgyro/accgyro_mpu.c"
    spiBusSetInstance(&gyro->bus, ((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x3800)));


    gyro->bus.busdev_u.spi.csnPin = gyro->bus.busdev_u.spi.csnPin == ((IO_t)0) ? IOGetByTag(((ioTag_t)((((1) + 1) << 4) | (12)))) : gyro->bus.busdev_u.spi.csnPin;
    ...
    if (sensor != MPU_NONE) {
        ...
        return 
# 272 "./src/main/drivers/accgyro/accgyro_mpu.c" 3 4
              1
# 272 "./src/main/drivers/accgyro/accgyro_mpu.c"
                  ;
    }
