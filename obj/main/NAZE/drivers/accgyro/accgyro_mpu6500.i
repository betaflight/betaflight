# 1 "./src/main/drivers/accgyro/accgyro_mpu6500.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "./src/main/drivers/accgyro/accgyro_mpu6500.c"
# 18 "./src/main/drivers/accgyro/accgyro_mpu6500.c"
...
# 19 "./src/main/drivers/accgyro/accgyro_mpu6500.c" 2
...
# 20 "./src/main/drivers/accgyro/accgyro_mpu6500.c" 2
...
# 21 "./src/main/drivers/accgyro/accgyro_mpu6500.c" 2
...
# 23 "./src/main/drivers/accgyro/accgyro_mpu6500.c" 2
...
# 25 "./src/main/drivers/accgyro/accgyro_mpu6500.c" 2
...
# 26 "./src/main/drivers/accgyro/accgyro_mpu6500.c" 2
...
# 41 "./src/main/drivers/exti.h"
                             enable);
# 28 "./src/main/drivers/accgyro/accgyro_mpu6500.c" 2
...
# 11 "./src/main/drivers/gyro_sync.h" 2


# 12 "./src/main/drivers/gyro_sync.h" 3 4
_Bool 
# 12 "./src/main/drivers/gyro_sync.h"
...
# 14 "./src/main/drivers/gyro_sync.h" 3 4
                                                                                     _Bool 
# 14 "./src/main/drivers/gyro_sync.h"
                                                                                          gyro_use_32khz);
# 29 "./src/main/drivers/accgyro/accgyro_mpu6500.c" 2
...
# 31 "./src/main/drivers/accgyro/accgyro_mpu6500.c" 2
...
# 35 "./src/main/drivers/accgyro/accgyro_mpu6500.c" 2
...
# 41 "./src/main/drivers/accgyro/accgyro_mpu6500.c" 3 4
_Bool 
# 41 "./src/main/drivers/accgyro/accgyro_mpu6500.c"
    mpu6500AccDetect(accDev_t *acc)
{
    if (acc->mpuDetectionResult.sensor != MPU_65xx_I2C) {
        return 
# 44 "./src/main/drivers/accgyro/accgyro_mpu6500.c" 3 4
              0
# 44 "./src/main/drivers/accgyro/accgyro_mpu6500.c"
                   ;
    }
    ...
    return 
# 50 "./src/main/drivers/accgyro/accgyro_mpu6500.c" 3 4
          1
# 50 "./src/main/drivers/accgyro/accgyro_mpu6500.c"
              ;
}
...
void mpu6500GyroInit(gyroDev_t *gyro)
{
    ...
    gyro->mpuConfiguration.writeFn(&gyro->bus, 0x6B, (0x80));
    delay(100);
    gyro->mpuConfiguration.writeFn(&gyro->bus, 0x68, 0x07);
    delay(100);
    gyro->mpuConfiguration.writeFn(&gyro->bus, 0x6B, 0);
    delay(100);
    gyro->mpuConfiguration.writeFn(&gyro->bus, 0x6B, INV_CLK_PLL);
    delay(15);
    const uint8_t raGyroConfigData = gyro->gyroRateKHz > GYRO_RATE_8_kHz ? (INV_FSR_2000DPS << 3 | FCB_3600_32) : (INV_FSR_2000DPS << 3 | FCB_DISABLED);
    gyro->mpuConfiguration.writeFn(&gyro->bus, 0x1B, raGyroConfigData);
    delay(15);
    gyro->mpuConfiguration.writeFn(&gyro->bus, 0x1C, INV_FSR_16G << 3);
    delay(15);
    gyro->mpuConfiguration.writeFn(&gyro->bus, 0x1A, gyro->lpf);
    delay(15);
    gyro->mpuConfiguration.writeFn(&gyro->bus, 0x19, gyroMPU6xxxGetDividerDrops(gyro));
    delay(100);
    ...
    gyro->mpuConfiguration.writeFn(&gyro->bus, 0x37, (1 << 4));

    delay(15);


    gyro->mpuConfiguration.writeFn(&gyro->bus, 0x38, (1 << 0));

    delay(15);
}


# 89 "./src/main/drivers/accgyro/accgyro_mpu6500.c" 3 4
_Bool 
# 89 "./src/main/drivers/accgyro/accgyro_mpu6500.c"
    mpu6500GyroDetect(gyroDev_t *gyro)
{
    if (gyro->mpuDetectionResult.sensor != MPU_65xx_I2C) {
        return 
# 92 "./src/main/drivers/accgyro/accgyro_mpu6500.c" 3 4
              0
# 92 "./src/main/drivers/accgyro/accgyro_mpu6500.c"
                   ;
    }
    ...
    return 
# 101 "./src/main/drivers/accgyro/accgyro_mpu6500.c" 3 4
          1
# 101 "./src/main/drivers/accgyro/accgyro_mpu6500.c"
              ;
}
