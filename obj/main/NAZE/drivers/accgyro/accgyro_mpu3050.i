# 1 "./src/main/drivers/accgyro/accgyro_mpu3050.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "./src/main/drivers/accgyro/accgyro_mpu3050.c"
# 18 "./src/main/drivers/accgyro/accgyro_mpu3050.c"
...
# 19 "./src/main/drivers/accgyro/accgyro_mpu3050.c" 2
...
# 20 "./src/main/drivers/accgyro/accgyro_mpu3050.c" 2
...
# 22 "./src/main/drivers/accgyro/accgyro_mpu3050.c" 2
...
# 24 "./src/main/drivers/accgyro/accgyro_mpu3050.c" 2
...
# 25 "./src/main/drivers/accgyro/accgyro_mpu3050.c" 2
...
# 27 "./src/main/drivers/accgyro/accgyro_mpu3050.c" 2
...
# 41 "./src/main/drivers/exti.h"
                             enable);
# 28 "./src/main/drivers/accgyro/accgyro_mpu3050.c" 2
...
# 29 "./src/main/drivers/accgyro/accgyro_mpu3050.c" 2
...
# 30 "./src/main/drivers/accgyro/accgyro_mpu3050.c" 2
...
# 31 "./src/main/drivers/accgyro/accgyro_mpu3050.c" 2
...
# 33 "./src/main/drivers/accgyro/accgyro_mpu3050.c" 2
...
# 35 "./src/main/drivers/accgyro/accgyro_mpu3050.c" 2
# 51 "./src/main/drivers/accgyro/accgyro_mpu3050.c"
static void mpu3050Init(gyroDev_t *gyro)
{
    
# 53 "./src/main/drivers/accgyro/accgyro_mpu3050.c" 3 4
   _Bool 
# 53 "./src/main/drivers/accgyro/accgyro_mpu3050.c"
        ack;

    delay(25);

    ack = gyro->mpuConfiguration.writeFn(&gyro->bus, 0x15, 0);
    if (!ack)
        failureMode(FAILURE_ACC_INIT);

    gyro->mpuConfiguration.writeFn(&gyro->bus, 0x16, 0x18 | gyro->lpf);
    gyro->mpuConfiguration.writeFn(&gyro->bus, 0x17, 0);
    gyro->mpuConfiguration.writeFn(&gyro->bus, 0x3D, 0x01);
    gyro->mpuConfiguration.writeFn(&gyro->bus, 0x3E, 0x01);
}

static 
# 67 "./src/main/drivers/accgyro/accgyro_mpu3050.c" 3 4
      _Bool 
# 67 "./src/main/drivers/accgyro/accgyro_mpu3050.c"
           mpu3050GyroRead(gyroDev_t *gyro)
{
    uint8_t data[6];

    const 
# 71 "./src/main/drivers/accgyro/accgyro_mpu3050.c" 3 4
         _Bool 
# 71 "./src/main/drivers/accgyro/accgyro_mpu3050.c"
              ack = gyro->mpuConfiguration.readFn(&gyro->bus, 0x1D, data, 6);
    if (!ack) {
        return 
# 73 "./src/main/drivers/accgyro/accgyro_mpu3050.c" 3 4
              0
# 73 "./src/main/drivers/accgyro/accgyro_mpu3050.c"
                   ;
    }
    ...
    return 
# 80 "./src/main/drivers/accgyro/accgyro_mpu3050.c" 3 4
          1
# 80 "./src/main/drivers/accgyro/accgyro_mpu3050.c"
              ;
}

static 
# 83 "./src/main/drivers/accgyro/accgyro_mpu3050.c" 3 4
      _Bool 
# 83 "./src/main/drivers/accgyro/accgyro_mpu3050.c"
           mpu3050ReadTemperature(gyroDev_t *gyro, int16_t *tempData)
{
    uint8_t buf[2];
    if (!gyro->mpuConfiguration.readFn(&gyro->bus, 0x1B, buf, 2)) {
        return 
# 87 "./src/main/drivers/accgyro/accgyro_mpu3050.c" 3 4
              0
# 87 "./src/main/drivers/accgyro/accgyro_mpu3050.c"
                   ;
    }
    ...
    *tempData = 35 + ((int32_t)(buf[0] << 8 | buf[1]) + 13200) / 280;
    ...
    return 
# 92 "./src/main/drivers/accgyro/accgyro_mpu3050.c" 3 4
          1
# 92 "./src/main/drivers/accgyro/accgyro_mpu3050.c"
              ;
}


# 95 "./src/main/drivers/accgyro/accgyro_mpu3050.c" 3 4
_Bool 
# 95 "./src/main/drivers/accgyro/accgyro_mpu3050.c"
    mpu3050Detect(gyroDev_t *gyro)
{
    if (gyro->mpuDetectionResult.sensor != MPU_3050) {
        return 
# 98 "./src/main/drivers/accgyro/accgyro_mpu3050.c" 3 4
              0
# 98 "./src/main/drivers/accgyro/accgyro_mpu3050.c"
                   ;
    }
    ...
    return 
# 107 "./src/main/drivers/accgyro/accgyro_mpu3050.c" 3 4
          1
# 107 "./src/main/drivers/accgyro/accgyro_mpu3050.c"
              ;
}
