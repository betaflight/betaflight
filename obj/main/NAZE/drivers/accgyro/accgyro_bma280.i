# 1 "./src/main/drivers/accgyro/accgyro_bma280.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "./src/main/drivers/accgyro/accgyro_bma280.c"
# 18 "./src/main/drivers/accgyro/accgyro_bma280.c"
...
# 19 "./src/main/drivers/accgyro/accgyro_bma280.c" 2
...
# 20 "./src/main/drivers/accgyro/accgyro_bma280.c" 2
...
# 22 "./src/main/drivers/accgyro/accgyro_bma280.c" 2
...
# 24 "./src/main/drivers/accgyro/accgyro_bma280.c" 2
...
# 26 "./src/main/drivers/accgyro/accgyro_bma280.c" 2
...
# 27 "./src/main/drivers/accgyro/accgyro_bma280.c" 2
...
# 28 "./src/main/drivers/accgyro/accgyro_bma280.c" 2
...
{
    i2cWrite((I2CDEV_2), 0x18, 0x0F, 0x08);
    i2cWrite((I2CDEV_2), 0x18, 0x10, 0x0E);

    acc->acc_1G = 512 * 8;
}

static 
# 43 "./src/main/drivers/accgyro/accgyro_bma280.c" 3 4
      _Bool 
# 43 "./src/main/drivers/accgyro/accgyro_bma280.c"
           bma280Read(accDev_t *acc)
{
    uint8_t buf[6];

    if (!i2cRead((I2CDEV_2), 0x18, 0x02, 6, buf)) {
        return 
# 48 "./src/main/drivers/accgyro/accgyro_bma280.c" 3 4
              0
# 48 "./src/main/drivers/accgyro/accgyro_bma280.c"
                   ;
    }
    ...
    return 
# 56 "./src/main/drivers/accgyro/accgyro_bma280.c" 3 4
          1
# 56 "./src/main/drivers/accgyro/accgyro_bma280.c"
              ;
}


# 59 "./src/main/drivers/accgyro/accgyro_bma280.c" 3 4
_Bool 
# 59 "./src/main/drivers/accgyro/accgyro_bma280.c"
    bma280Detect(accDev_t *acc)
{
    uint8_t sig = 0;
    
# 62 "./src/main/drivers/accgyro/accgyro_bma280.c" 3 4
   _Bool 
# 62 "./src/main/drivers/accgyro/accgyro_bma280.c"
        ack = i2cRead((I2CDEV_2), 0x18, 0x00, 1, &sig);

    if (!ack || sig != 0xFB)
        return 
# 65 "./src/main/drivers/accgyro/accgyro_bma280.c" 3 4
              0
# 65 "./src/main/drivers/accgyro/accgyro_bma280.c"
                   ;

    acc->initFn = bma280Init;
    acc->readFn = bma280Read;
    return 
# 69 "./src/main/drivers/accgyro/accgyro_bma280.c" 3 4
          1
# 69 "./src/main/drivers/accgyro/accgyro_bma280.c"
              ;
}
