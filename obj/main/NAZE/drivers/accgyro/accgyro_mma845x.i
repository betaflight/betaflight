# 1 "./src/main/drivers/accgyro/accgyro_mma845x.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "./src/main/drivers/accgyro/accgyro_mma845x.c"
# 18 "./src/main/drivers/accgyro/accgyro_mma845x.c"
...
# 19 "./src/main/drivers/accgyro/accgyro_mma845x.c" 2
...
# 20 "./src/main/drivers/accgyro/accgyro_mma845x.c" 2
...
# 22 "./src/main/drivers/accgyro/accgyro_mma845x.c" 2
...
# 24 "./src/main/drivers/accgyro/accgyro_mma845x.c" 2
...
# 25 "./src/main/drivers/accgyro/accgyro_mma845x.c" 2
...
# 27 "./src/main/drivers/accgyro/accgyro_mma845x.c" 2
...
# 28 "./src/main/drivers/accgyro/accgyro_mma845x.c" 2
...
# 29 "./src/main/drivers/accgyro/accgyro_mma845x.c" 2
# 81 "./src/main/drivers/accgyro/accgyro_mma845x.c"
static uint8_t device_id;

static inline void mma8451ConfigureInterrupt(void)
{

    IOInit(IOGetByTag(((ioTag_t)((((0) + 1) << 4) | (5)))), OWNER_MPU_EXTI, 0);

    IOConfigGPIO(IOGetByTag(((ioTag_t)((((0) + 1) << 4) | (5)))), ((GPIO_Mode_IN_FLOATING) | (GPIO_Speed_2MHz)));


    i2cWrite((I2CDEV_2), 0x1C, 0x2C, 0x02);
    i2cWrite((I2CDEV_2), 0x1C, 0x2D, 0x01);
    i2cWrite((I2CDEV_2), 0x1C, 0x2E, 0);
}

static void mma8452Init(accDev_t *acc)
{

    i2cWrite((I2CDEV_2), 0x1C, 0x2A, 0);
    i2cWrite((I2CDEV_2), 0x1C, 0x0E, 0x02);
    i2cWrite((I2CDEV_2), 0x1C, 0x0F, 0x03);
    i2cWrite((I2CDEV_2), 0x1C, 0x2B, 0x02 | 0x02 << 3);

    mma8451ConfigureInterrupt();

    i2cWrite((I2CDEV_2), 0x1C, 0x2A, 0x04 | 0x01);

    acc->acc_1G = 256;
}

static 
# 111 "./src/main/drivers/accgyro/accgyro_mma845x.c" 3 4
      _Bool 
# 111 "./src/main/drivers/accgyro/accgyro_mma845x.c"
           mma8452Read(accDev_t *acc)
{
    uint8_t buf[6];

    if (!i2cRead((I2CDEV_2), 0x1C, 0x01, 6, buf)) {
        return 
# 116 "./src/main/drivers/accgyro/accgyro_mma845x.c" 3 4
              0
# 116 "./src/main/drivers/accgyro/accgyro_mma845x.c"
                   ;
    }
    ...
    return 
# 123 "./src/main/drivers/accgyro/accgyro_mma845x.c" 3 4
          1
# 123 "./src/main/drivers/accgyro/accgyro_mma845x.c"
              ;
}


# 126 "./src/main/drivers/accgyro/accgyro_mma845x.c" 3 4
_Bool 
# 126 "./src/main/drivers/accgyro/accgyro_mma845x.c"
    mma8452Detect(accDev_t *acc)
{
    uint8_t sig = 0;
    
# 129 "./src/main/drivers/accgyro/accgyro_mma845x.c" 3 4
   _Bool 
# 129 "./src/main/drivers/accgyro/accgyro_mma845x.c"
        ack = i2cRead((I2CDEV_2), 0x1C, 0x0D, 1, &sig);

    if (!ack || (sig != 0x2A && sig != 0x1A))
        return 
# 132 "./src/main/drivers/accgyro/accgyro_mma845x.c" 3 4
              0
# 132 "./src/main/drivers/accgyro/accgyro_mma845x.c"
                   ;
    ...
    device_id = sig;
    return 
# 137 "./src/main/drivers/accgyro/accgyro_mma845x.c" 3 4
          1
# 137 "./src/main/drivers/accgyro/accgyro_mma845x.c"
              ;
}
