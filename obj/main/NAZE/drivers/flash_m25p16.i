...
# 26 "./src/main/drivers/flash_m25p16.c" 2
...
# 27 "./src/main/drivers/flash_m25p16.c" 2
...
# 28 "./src/main/drivers/flash_m25p16.c" 2
...
# 29 "./src/main/drivers/flash_m25p16.c" 2
...
# 30 "./src/main/drivers/flash_m25p16.c" 2
# 57 "./src/main/drivers/flash_m25p16.c"
static busDevice_t busInstance;
static busDevice_t *bus;
# 67 "./src/main/drivers/flash_m25p16.c"
static flashGeometry_t geometry = {.pageSize = 256};
...
static 
# 74 "./src/main/drivers/flash_m25p16.c" 3 4
      _Bool 
# 74 "./src/main/drivers/flash_m25p16.c"
           couldBeBusy = 
# 74 "./src/main/drivers/flash_m25p16.c" 3 4
                         0
# 74 "./src/main/drivers/flash_m25p16.c"
...
{
    __NOP(); IOLo(bus->busdev_u.spi.csnPin);

    spiTransferByte(bus->busdev_u.spi.instance, command);

    IOHi(bus->busdev_u.spi.csnPin); __NOP();
}
...
{
    m25p16_performOneByteCommand(0x06);


    couldBeBusy = 
# 97 "./src/main/drivers/flash_m25p16.c" 3 4
                 1
# 97 "./src/main/drivers/flash_m25p16.c"
                     ;
}

static uint8_t m25p16_readStatus(void)
{
    const uint8_t command[2] = { 0x05, 0 };
    uint8_t in[2];
...
# 114 "./src/main/drivers/flash_m25p16.c" 3 4
_Bool 
# 114 "./src/main/drivers/flash_m25p16.c"
    m25p16_isReady(void)
{

    couldBeBusy = couldBeBusy && ((m25p16_readStatus() & 0x01) != 0);

    return !couldBeBusy;
}


# 122 "./src/main/drivers/flash_m25p16.c" 3 4
_Bool 
# 122 "./src/main/drivers/flash_m25p16.c"
    m25p16_waitForReady(uint32_t timeoutMillis)
{
    ...
    while (!m25p16_isReady()) {
        if (millis() - time > timeoutMillis) {
            return 
# 127 "./src/main/drivers/flash_m25p16.c" 3 4
                  0
# 127 "./src/main/drivers/flash_m25p16.c"
                       ;
        }
    }

    return 
# 131 "./src/main/drivers/flash_m25p16.c" 3 4
          1
# 131 "./src/main/drivers/flash_m25p16.c"
              ;
}
...
static 
# 139 "./src/main/drivers/flash_m25p16.c" 3 4
      _Bool 
# 139 "./src/main/drivers/flash_m25p16.c"
           m25p16_readIdentification(void)
{
    ...
    default:
        ...
        return 
# 194 "./src/main/drivers/flash_m25p16.c" 3 4
              0
# 194 "./src/main/drivers/flash_m25p16.c"
                   ;
    }
    ...
    couldBeBusy = 
# 200 "./src/main/drivers/flash_m25p16.c" 3 4
                 1
# 200 "./src/main/drivers/flash_m25p16.c"
                     ;

    return 
# 202 "./src/main/drivers/flash_m25p16.c" 3 4
          1
# 202 "./src/main/drivers/flash_m25p16.c"
              ;
}
...
# 211 "./src/main/drivers/flash_m25p16.c" 3 4
_Bool 
# 211 "./src/main/drivers/flash_m25p16.c"
    m25p16_init(const flashConfig_t *flashConfig)
{
    ...
    if (geometry.sectors) {
        return 
# 217 "./src/main/drivers/flash_m25p16.c" 3 4
              1
# 217 "./src/main/drivers/flash_m25p16.c"
                  ;
    }

    bus = &busInstance;
    bus->bustype = 2;
    spiBusSetInstance(bus, spiInstanceByDevice(((flashConfig->spiDevice) - 1)));
    if (flashConfig->csTag) {
        bus->busdev_u.spi.csnPin = IOGetByTag(flashConfig->csTag);
    } else {
        return 
# 226 "./src/main/drivers/flash_m25p16.c" 3 4
              0
# 226 "./src/main/drivers/flash_m25p16.c"
                   ;
    }

    IOInit(bus->busdev_u.spi.csnPin, OWNER_FLASH_CS, 0);
    IOConfigGPIO(bus->busdev_u.spi.csnPin, ((GPIO_Mode_Out_PP) | (GPIO_Speed_50MHz)));
...
void m25p16_eraseSector(uint32_t address)
{
    const uint8_t out[] = { 0xD8, (address >> 16) & 0xFF, (address >> 8) & 0xFF, address & 0xFF};

    m25p16_waitForReady(5000);

    m25p16_writeEnable();

    __NOP(); IOLo(bus->busdev_u.spi.csnPin);

    spiTransfer(bus->busdev_u.spi.instance, out, 
# 255 "./src/main/drivers/flash_m25p16.c" 3 4
                                                ((void *)0)
# 255 "./src/main/drivers/flash_m25p16.c"
                                                    , sizeof(out));
...
void m25p16_eraseCompletely(void)
{
    m25p16_waitForReady(21000);

    m25p16_writeEnable();

    m25p16_performOneByteCommand(0xC7);
}

void m25p16_pageProgramBegin(uint32_t address)
{
    const uint8_t command[] = { 0x02, (address >> 16) & 0xFF, (address >> 8) & 0xFF, address & 0xFF};

    m25p16_waitForReady(6);

    m25p16_writeEnable();

    __NOP(); IOLo(bus->busdev_u.spi.csnPin);

    spiTransfer(bus->busdev_u.spi.instance, command, 
# 279 "./src/main/drivers/flash_m25p16.c" 3 4
                                                    ((void *)0)
# 279 "./src/main/drivers/flash_m25p16.c"
                                                        , sizeof(command));
}

void m25p16_pageProgramContinue(const uint8_t *data, int length)
{
    spiTransfer(bus->busdev_u.spi.instance, data, 
# 284 "./src/main/drivers/flash_m25p16.c" 3 4
                                                 ((void *)0)
# 284 "./src/main/drivers/flash_m25p16.c"
                                                     , length);
}
...
# 307 "./src/main/drivers/flash_m25p16.c"
void m25p16_pageProgram(uint32_t address, const uint8_t *data, int length)
{
...
# 324 "./src/main/drivers/flash_m25p16.c"
int m25p16_readBytes(uint32_t address, uint8_t *buffer, int length)
{
    const uint8_t command[] = { 0x03, (address >> 16) & 0xFF, (address >> 8) & 0xFF, address & 0xFF};

    if (!m25p16_waitForReady(6)) {
        return 0;
    }
    ...
    spiTransfer(bus->busdev_u.spi.instance, command, 
# 334 "./src/main/drivers/flash_m25p16.c" 3 4
                                                    ((void *)0)
# 334 "./src/main/drivers/flash_m25p16.c"
                                                        , sizeof(command));
    spiTransfer(bus->busdev_u.spi.instance, 
# 335 "./src/main/drivers/flash_m25p16.c" 3 4
                                           ((void *)0)
# 335 "./src/main/drivers/flash_m25p16.c"
                                               , buffer, length);
