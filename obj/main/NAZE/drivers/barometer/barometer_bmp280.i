# 1 "./src/main/drivers/barometer/barometer_bmp280.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "./src/main/drivers/barometer/barometer_bmp280.c"
# 18 "./src/main/drivers/barometer/barometer_bmp280.c"
...
# 19 "./src/main/drivers/barometer/barometer_bmp280.c" 2
...
# 20 "./src/main/drivers/barometer/barometer_bmp280.c" 2
...
# 22 "./src/main/drivers/barometer/barometer_bmp280.c" 2

# 1 "./src/main/build/build_config.h" 1
# 18 "./src/main/build/build_config.h"
       
# 24 "./src/main/drivers/barometer/barometer_bmp280.c" 2
...
# 25 "./src/main/drivers/barometer/barometer_bmp280.c" 2
...
# 27 "./src/main/drivers/barometer/barometer_bmp280.c" 2
...
# 31 "./src/main/drivers/barometer/barometer_bmp280.c" 2
...
# 32 "./src/main/drivers/barometer/barometer_bmp280.c" 2
...
# 33 "./src/main/drivers/barometer/barometer_bmp280.c" 2
...
# 34 "./src/main/drivers/barometer/barometer_bmp280.c" 2
...
# 36 "./src/main/drivers/barometer/barometer_bmp280.c" 2
...
# 68 "./src/main/drivers/barometer/barometer_bmp280.c" 3 4
_Bool 
# 68 "./src/main/drivers/barometer/barometer_bmp280.c"
    bmp280ReadRegister(busDevice_t *busdev, uint8_t reg, uint8_t length, uint8_t *data)
{
    ...
    return 
# 80 "./src/main/drivers/barometer/barometer_bmp280.c" 3 4
          0
# 80 "./src/main/drivers/barometer/barometer_bmp280.c"
               ;
}


# 83 "./src/main/drivers/barometer/barometer_bmp280.c" 3 4
_Bool 
# 83 "./src/main/drivers/barometer/barometer_bmp280.c"
    bmp280WriteRegister(busDevice_t *busdev, uint8_t reg, uint8_t data)
{
    switch (busdev->bustype) {
    ...
    return 
# 95 "./src/main/drivers/barometer/barometer_bmp280.c" 3 4
          0
# 95 "./src/main/drivers/barometer/barometer_bmp280.c"
               ;
}

void bmp280BusInit(busDevice_t *busdev)
{
# 108 "./src/main/drivers/barometer/barometer_bmp280.c"
    (void)(busdev);
...
# 125 "./src/main/drivers/barometer/barometer_bmp280.c" 3 4
_Bool 
# 125 "./src/main/drivers/barometer/barometer_bmp280.c"
    bmp280Detect(baroDev_t *baro)
{
    delay(20);
...
# 130 "./src/main/drivers/barometer/barometer_bmp280.c" 3 4
   _Bool 
# 130 "./src/main/drivers/barometer/barometer_bmp280.c"
...
# 130 "./src/main/drivers/barometer/barometer_bmp280.c"
    ...
    if ((busdev->bustype == 1) && (busdev->busdev_u.i2c.address == 0)) {
        ...
        busdev->busdev_u.i2c.address = (0x76);
        defaultAddressApplied = 
# 137 "./src/main/drivers/barometer/barometer_bmp280.c" 3 4
                               1
# 137 "./src/main/drivers/barometer/barometer_bmp280.c"
                                   ;
    }

    bmp280ReadRegister(busdev, (0xD0), 1, &bmp280_chip_id);
    ...
    if (bmp280_chip_id != (0x58)) {
        ...
        return 
# 147 "./src/main/drivers/barometer/barometer_bmp280.c" 3 4
              0
# 147 "./src/main/drivers/barometer/barometer_bmp280.c"
                   ;
    }


    bmp280ReadRegister(busdev, (0x88), 24, (uint8_t *)&bmp280_cal);


    bmp280WriteRegister(busdev, (0xF4), (((0x04)) << 2 | ((0x01)) << 5 | (0x01)));
    ...
    baro->up_delay = (((20) + (37) * (((1 << ((0x01))) >> 1) + ((1 << ((0x04))) >> 1)) + (((0x04)) ? (10) : 0) + 15) / 16) * 1000;
    baro->calculate = bmp280_calculate;

    return 
# 166 "./src/main/drivers/barometer/barometer_bmp280.c" 3 4
          1
# 166 "./src/main/drivers/barometer/barometer_bmp280.c"
              ;
}
...
static void bmp280_start_up(baroDev_t *baro)
{
    ...
    bmp280WriteRegister(&baro->busdev, (0xF4), (((0x04)) << 2 | ((0x01)) << 5 | (0x01)));
}
...
static void bmp280_get_up(baroDev_t *baro)
{
    ...
    bmp280ReadRegister(&baro->busdev, (0xF7), (6), data);
