...
# 64 "./src/main/drivers/barometer/barometer_ms5611.c" 3 4
_Bool 
# 64 "./src/main/drivers/barometer/barometer_ms5611.c"
    ms5611ReadCommand(busDevice_t *busdev, uint8_t cmd, uint8_t len, uint8_t *data)
{
    ...
    return 
# 76 "./src/main/drivers/barometer/barometer_ms5611.c" 3 4
          0
# 76 "./src/main/drivers/barometer/barometer_ms5611.c"
               ;
}


# 79 "./src/main/drivers/barometer/barometer_ms5611.c" 3 4
_Bool 
# 79 "./src/main/drivers/barometer/barometer_ms5611.c"
    ms5611WriteCommand(busDevice_t *busdev, uint8_t cmd, uint8_t byte)
{
    switch (busdev->bustype) {
...
{
# 104 "./src/main/drivers/barometer/barometer_ms5611.c"
    (void)(busdev);
...
# 125 "./src/main/drivers/barometer/barometer_ms5611.c" 3 4
   _Bool 
# 125 "./src/main/drivers/barometer/barometer_ms5611.c"
...
# 125 "./src/main/drivers/barometer/barometer_ms5611.c"
    ...
    if ((busdev->bustype == 1) && (busdev->busdev_u.i2c.address == 0)) {
        ...
        defaultAddressApplied = 
# 136 "./src/main/drivers/barometer/barometer_ms5611.c" 3 4
                               1
# 136 "./src/main/drivers/barometer/barometer_ms5611.c"
                                   ;
    }

    if (!ms5611ReadCommand(busdev, 0xA0, 1, &sig) || sig == 0xFF) {
        goto fail;
    }
...
static void ms5611_reset(busDevice_t *busdev)
{
    ms5611WriteCommand(busdev, 0x1E, 1);
...
static uint16_t ms5611_prom(busDevice_t *busdev, int8_t coef_num)
{
    ...
    ms5611ReadCommand(busdev, 0xA0 + coef_num * 2, 2, rxbuf);
...
# 198 "./src/main/drivers/barometer/barometer_ms5611.c" 3 4
   _Bool 
# 198 "./src/main/drivers/barometer/barometer_ms5611.c"
        blankEeprom = 
# 198 "./src/main/drivers/barometer/barometer_ms5611.c" 3 4
                      1
# 198 "./src/main/drivers/barometer/barometer_ms5611.c"
    ...
    for (i = 0; i < 16; i++) {
        if (prom[i >> 1]) {
            blankEeprom = 
# 202 "./src/main/drivers/barometer/barometer_ms5611.c" 3 4
                         0
# 202 "./src/main/drivers/barometer/barometer_ms5611.c"
                              ;
        }
        if (i & 1)
            res ^= ((prom[i >> 1]) & 0x00FF);
...
static uint32_t ms5611_read_adc(busDevice_t *busdev)
{
    ...
    ms5611ReadCommand(busdev, 0x00, 3, rxbuf);
...
static void ms5611_start_ut(baroDev_t *baro)
{
    ms5611WriteCommand(&baro->busdev, 0x40 + 0x10 + ms5611_osr, 1);
}
...
static void ms5611_start_up(baroDev_t *baro)
{
    ms5611WriteCommand(&baro->busdev, 0x40 + 0x00 + ms5611_osr, 1);
}
