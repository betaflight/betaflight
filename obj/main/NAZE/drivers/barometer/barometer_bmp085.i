# 1 "./src/main/drivers/barometer/barometer_bmp085.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "./src/main/drivers/barometer/barometer_bmp085.c"
# 18 "./src/main/drivers/barometer/barometer_bmp085.c"
...
# 19 "./src/main/drivers/barometer/barometer_bmp085.c" 2
...
# 20 "./src/main/drivers/barometer/barometer_bmp085.c" 2
...
# 22 "./src/main/drivers/barometer/barometer_bmp085.c" 2

# 1 "./src/main/build/build_config.h" 1
# 18 "./src/main/build/build_config.h"
       
# 24 "./src/main/drivers/barometer/barometer_bmp085.c" 2
...
# 26 "./src/main/drivers/barometer/barometer_bmp085.c" 2
...
# 30 "./src/main/drivers/barometer/barometer_bmp085.c" 2
...
# 41 "./src/main/drivers/exti.h"
                             enable);
# 31 "./src/main/drivers/barometer/barometer_bmp085.c" 2
...
# 32 "./src/main/drivers/barometer/barometer_bmp085.c" 2
# 1 "./src/main/drivers/nvic.h" 1

       
# 33 "./src/main/drivers/barometer/barometer_bmp085.c" 2
...
# 34 "./src/main/drivers/barometer/barometer_bmp085.c" 2
...
# 36 "./src/main/drivers/barometer/barometer_bmp085.c" 2
# 56 "./src/main/drivers/barometer/barometer_bmp085.c"
typedef struct {
    int16_t ac1;
    int16_t ac2;
    int16_t ac3;
...
# 114 "./src/main/drivers/barometer/barometer_bmp085.c"
...
static 
# 119 "./src/main/drivers/barometer/barometer_bmp085.c" 3 4
      _Bool 
# 119 "./src/main/drivers/barometer/barometer_bmp085.c"
           bmp085InitDone = 
# 119 "./src/main/drivers/barometer/barometer_bmp085.c" 3 4
                            0
# 119 "./src/main/drivers/barometer/barometer_bmp085.c"
                                 ;
static uint16_t bmp085_ut;
static uint32_t bmp085_up;
...
static IO_t xclrIO;
# 143 "./src/main/drivers/barometer/barometer_bmp085.c"
void bmp085InitXclrIO(const bmp085Config_t *config)
{
    if (!xclrIO && config && config->xclrIO) {
        ...
        IOConfigGPIO(xclrIO, ((GPIO_Mode_Out_PP) | (GPIO_Speed_2MHz)));
    }
}
...
# 158 "./src/main/drivers/barometer/barometer_bmp085.c" 3 4
_Bool 
# 158 "./src/main/drivers/barometer/barometer_bmp085.c"
    bmp085ReadRegister(busDevice_t *busdev, uint8_t cmd, uint8_t len, uint8_t *data)
{
    return i2cBusReadRegisterBuffer(busdev, cmd, data, len);
}


# 163 "./src/main/drivers/barometer/barometer_bmp085.c" 3 4
_Bool 
# 163 "./src/main/drivers/barometer/barometer_bmp085.c"
    bmp085WriteRegister(busDevice_t *busdev, uint8_t cmd, uint8_t byte)
{
    return i2cBusWriteRegister(busdev, cmd, byte);
}


# 168 "./src/main/drivers/barometer/barometer_bmp085.c" 3 4
_Bool 
# 168 "./src/main/drivers/barometer/barometer_bmp085.c"
    bmp085Detect(const bmp085Config_t *config, baroDev_t *baro)
{
    uint8_t data;
    
# 171 "./src/main/drivers/barometer/barometer_bmp085.c" 3 4
   _Bool 
# 171 "./src/main/drivers/barometer/barometer_bmp085.c"
        ack;
    
# 172 "./src/main/drivers/barometer/barometer_bmp085.c" 3 4
   _Bool 
# 172 "./src/main/drivers/barometer/barometer_bmp085.c"
...
# 172 "./src/main/drivers/barometer/barometer_bmp085.c"
    ...
    if (bmp085InitDone)
        return 
# 179 "./src/main/drivers/barometer/barometer_bmp085.c" 3 4
              1
# 179 "./src/main/drivers/barometer/barometer_bmp085.c"
                  ;

    bmp085InitXclrIO(config);
    ;
# 195 "./src/main/drivers/barometer/barometer_bmp085.c"
    (void)(config);
    ...
    if ((busdev->bustype == 1) && (busdev->busdev_u.i2c.address == 0)) {

        busdev->busdev_u.i2c.address = 0x77;
        defaultAddressApplied = 
# 205 "./src/main/drivers/barometer/barometer_bmp085.c" 3 4
                               1
# 205 "./src/main/drivers/barometer/barometer_bmp085.c"
                                   ;
    }

    ack = bmp085ReadRegister(busdev, 0xD0, 1, &data);
    if (ack) {
        bmp085.chip_id = (data & 0xFF) >> 0;
        bmp085.oversampling_setting = 3;

        if (bmp085.chip_id == 0x55) {
            bmp085ReadRegister(busdev, 0xD1, 1, &data);
            bmp085.ml_version = (data & 0x0F) >> 0;
            bmp085.al_version = (data & 0xF0) >> 4;
            bmp085_get_cal_param(busdev);
            baro->ut_delay = 6000;
            baro->up_delay = 27000;
            ...
            bmp085InitDone = 
# 228 "./src/main/drivers/barometer/barometer_bmp085.c" 3 4
                            1
# 228 "./src/main/drivers/barometer/barometer_bmp085.c"
                                ;
            return 
# 229 "./src/main/drivers/barometer/barometer_bmp085.c" 3 4
                  1
# 229 "./src/main/drivers/barometer/barometer_bmp085.c"
                      ;
        }
    }
    ...
    return 
# 244 "./src/main/drivers/barometer/barometer_bmp085.c" 3 4
          0
# 244 "./src/main/drivers/barometer/barometer_bmp085.c"
               ;
}
...
static void bmp085_start_ut(baroDev_t *baro)
{
    ...
    bmp085WriteRegister(&baro->busdev, 0xF4, 0x2E);
}

static void bmp085_get_ut(baroDev_t *baro)
{
    uint8_t data[2];
# 319 "./src/main/drivers/barometer/barometer_bmp085.c"
    bmp085ReadRegister(&baro->busdev, 0xF6, 2, data);
...
static void bmp085_start_up(baroDev_t *baro)
{
    ...
    ctrl_reg_data = 0x34 + (bmp085.oversampling_setting << 6);





    bmp085WriteRegister(&baro->busdev, 0xF4, ctrl_reg_data);
}
...
{
    uint8_t data[3];
# 351 "./src/main/drivers/barometer/barometer_bmp085.c"
    bmp085ReadRegister(&baro->busdev, 0xF6, 3, data);
...
{
    uint8_t data[22];
    bmp085ReadRegister(busdev, 0xaa, 22, data);
