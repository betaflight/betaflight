# 1 "./src/main/drivers/adc_stm32f10x.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "./src/main/drivers/adc_stm32f10x.c"
# 18 "./src/main/drivers/adc_stm32f10x.c"
...
# 19 "./src/main/drivers/adc_stm32f10x.c" 2
...
# 20 "./src/main/drivers/adc_stm32f10x.c" 2
...
# 21 "./src/main/drivers/adc_stm32f10x.c" 2
...
# 23 "./src/main/drivers/adc_stm32f10x.c" 2
...
# 27 "./src/main/drivers/adc_stm32f10x.c" 2
...
# 29 "./src/main/drivers/adc_stm32f10x.c" 2
...
# 31 "./src/main/drivers/adc_stm32f10x.c" 2
# 1 "./src/main/drivers/adc_impl.h" 1
# 18 "./src/main/drivers/adc_impl.h"
       
# 31 "./src/main/drivers/adc_impl.h"
...
# 33 "./src/main/drivers/adc_stm32f10x.c" 2
...
# 34 "./src/main/drivers/adc_stm32f10x.c" 2
...
# 35 "./src/main/drivers/adc_stm32f10x.c" 2
...
const adcDevice_t adcHardware[] = {
    { .ADCx = ((ADC_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x2400)), .rccADC = (((RCC_APB2) << 5) | (16*((((uint32_t)0x00000200))>65535L) + (8*(((((uint32_t)0x00000200))*1L >>16*((((uint32_t)0x00000200))>65535L))>255) + (8 - 90/(((((((uint32_t)0x00000200))*1L >>16*((((uint32_t)0x00000200))>65535L)) >>8*(((((uint32_t)0x00000200))*1L >>16*((((uint32_t)0x00000200))>65535L))>255))/4+14)|1) - 2/((((((uint32_t)0x00000200))*1L >>16*((((uint32_t)0x00000200))>65535L)) >>8*(((((uint32_t)0x00000200))*1L >>16*((((uint32_t)0x00000200))>65535L))>255))/2+1))))), .DMAy_Channelx = ((DMA_Channel_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x0008)) }
};

ADCDevice adcDeviceByInstance(ADC_TypeDef *instance)
{
    if (instance == ((ADC_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x2400)))
        return ADCDEV_1;
...
const adcTagMap_t adcTagMap[] = {
    { ((ioTag_t)((((0) + 1) << 4) | (0))), ((uint8_t)0x00) },
    { ((ioTag_t)((((0) + 1) << 4) | (1))), ((uint8_t)0x01) },
    { ((ioTag_t)((((0) + 1) << 4) | (2))), ((uint8_t)0x02) },
    { ((ioTag_t)((((0) + 1) << 4) | (3))), ((uint8_t)0x03) },
    { ((ioTag_t)((((0) + 1) << 4) | (4))), ((uint8_t)0x04) },
    { ((ioTag_t)((((0) + 1) << 4) | (5))), ((uint8_t)0x05) },
    { ((ioTag_t)((((0) + 1) << 4) | (6))), ((uint8_t)0x06) },
    { ((ioTag_t)((((0) + 1) << 4) | (7))), ((uint8_t)0x07) },
    { ((ioTag_t)((((1) + 1) << 4) | (0))), ((uint8_t)0x08) },
    { ((ioTag_t)((((1) + 1) << 4) | (1))), ((uint8_t)0x09) },
};
# 79 "./src/main/drivers/adc_stm32f10x.c"
void adcInit(const adcConfig_t *config)
{
    ...
    ADCDevice device = adcDeviceByInstance(((ADC_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x2400)));
...
# 108 "./src/main/drivers/adc_stm32f10x.c" 3 4
   _Bool 
# 108 "./src/main/drivers/adc_stm32f10x.c"
        adcActive = 
# 108 "./src/main/drivers/adc_stm32f10x.c" 3 4
                    0
# 108 "./src/main/drivers/adc_stm32f10x.c"
    ...
    for (int i = 0; i < ADC_CHANNEL_COUNT; i++) {
        ...
        adcActive = 
# 113 "./src/main/drivers/adc_stm32f10x.c" 3 4
                   1
# 113 "./src/main/drivers/adc_stm32f10x.c"
                       ;
        IOInit(IOGetByTag(adcOperatingConfig[i].tag), OWNER_ADC_BATT + i, 0);
        IOConfigGPIO(IOGetByTag(adcOperatingConfig[i].tag), ((GPIO_Mode_AIN) | (0)));
...
# 119 "./src/main/drivers/adc_stm32f10x.c" 3 4
                                       1
# 119 "./src/main/drivers/adc_stm32f10x.c"
                                           ;
    }
    ...
    DMA_InitStructure.DMA_MemoryInc = configuredAdcChannels > 1 ? ((uint32_t)0x00000080) : ((uint32_t)0x00000000);
