...
# 23 "./src/main/drivers/light_led.h" 2
...
# 29 "./src/main/drivers/system.c" 2
...
void SysTick_Handler(void)
{
    for ( uint8_t __basepri_save __attribute__ ((__cleanup__ (__basepriRestoreMem), __unused__)) = __get_BASEPRI(), __ToDo = __basepriSetMemRetVal((((((0)<<(4-(7-(((uint32_t)0x500)>>8))))|((1)&(0x0f>>(7-(((uint32_t)0x500)>>8)))))<<4)&0xf0)); __ToDo ; __ToDo = 0 ) {
        sysTickUptime++;
        sysTickPending = 0;
        (void)(((SysTick_Type *) ((0xE000E000) + 0x0010))->CTRL);
    }
...
uint32_t microsISR(void)
{
    ...
    for ( uint8_t __basepri_save __attribute__ ((__cleanup__ (__basepriRestoreMem), __unused__)) = __get_BASEPRI(), __ToDo = __basepriSetMemRetVal((((((0)<<(4-(7-(((uint32_t)0x500)>>8))))|((1)&(0x0f>>(7-(((uint32_t)0x500)>>8)))))<<4)&0xf0)); __ToDo ; __ToDo = 0 ) {
        cycle_cnt = ((SysTick_Type *) ((0xE000E000) + 0x0010))->VAL;

        if (((SysTick_Type *) ((0xE000E000) + 0x0010))->CTRL & (1ul << 16)) {
...
uint32_t micros(void)
{
    ...
    if ((((SCB_Type *) ((0xE000E000) + 0x0D00))->ICSR & (0x1FFul << 0)) || (__get_BASEPRI())) {
        return microsISR();
    }
...
static void indicate(uint8_t count, uint16_t duration)
{
    if (count) {
        ledSet(1, 
# 170 "./src/main/drivers/system.c" 3 4
       1
# 170 "./src/main/drivers/system.c"
       );
        ledSet(0, 
# 171 "./src/main/drivers/system.c" 3 4
       0
# 171 "./src/main/drivers/system.c"
       );
        ...
        while (count--) {
            ...
            ledToggle(0);
            systemBeep(
# 176 "./src/main/drivers/system.c" 3 4
           1
# 176 "./src/main/drivers/system.c"
           );
            delay(duration);
            ...
            ledToggle(0);
            systemBeep(
# 181 "./src/main/drivers/system.c" 3 4
           0
# 181 "./src/main/drivers/system.c"
           );
            delay(duration);
        }
    }
