...
{
# 78 "./src/main/drivers/pwm_output.c"
    ...
    if (output & TIMER_OUTPUT_N_CHANNEL) {
        ...
        TIM_OCInitStructure.TIM_OCNPolarity = (output & TIMER_OUTPUT_INVERTED) ? ((uint16_t)0x0000) : ((uint16_t)0x0008);
    } else {
...
# 120 "./src/main/drivers/pwm_output.c"
...
# 170 "./src/main/drivers/pwm_output.c"
void pwmWriteMotor(uint8_t index, float value)
{
...
# 197 "./src/main/drivers/pwm_output.c" 3 4
_Bool 
# 197 "./src/main/drivers/pwm_output.c"
    pwmAreMotorsEnabled(void)
{
...
# 228 "./src/main/drivers/pwm_output.c" 3 4
   _Bool 
# 228 "./src/main/drivers/pwm_output.c"
    ...
    case PWM_TYPE_BRUSHED:
        sMin = 0;
        useUnsyncedPwm = 
# 248 "./src/main/drivers/pwm_output.c" 3 4
                        1
# 248 "./src/main/drivers/pwm_output.c"
                            ;
        idlePulse = 0;
        break;
    case PWM_TYPE_STANDARD:
        ...
        sLen = 1e-3f;
        useUnsyncedPwm = 
# 254 "./src/main/drivers/pwm_output.c" 3 4
                        1
# 254 "./src/main/drivers/pwm_output.c"
                            ;
        idlePulse = 0;
        break;
# 274 "./src/main/drivers/pwm_output.c"
    }
    ...
    for (int motorIndex = 0; motorIndex < 8 && motorIndex < motorCount; motorIndex++) {
        ...
        if (timerHardware == 
# 285 "./src/main/drivers/pwm_output.c" 3 4
                            ((void *)0)
# 285 "./src/main/drivers/pwm_output.c"
                                ) {
...
# 306 "./src/main/drivers/pwm_output.c"
        IOInit(motors[motorIndex].io, OWNER_MOTOR, (motorIndex + 1));



        IOConfigGPIO(motors[motorIndex].io, ((GPIO_Mode_AF_PP) | (GPIO_Speed_2MHz)));
...
# 333 "./src/main/drivers/pwm_output.c" 3 4
       _Bool 
# 333 "./src/main/drivers/pwm_output.c"
            timerAlreadyUsed = 
# 333 "./src/main/drivers/pwm_output.c" 3 4
                               0
# 333 "./src/main/drivers/pwm_output.c"
        ...
        for (int i = 0; i < motorIndex; i++) {
            if (motors[i].channel.tim == motors[motorIndex].channel.tim) {
                timerAlreadyUsed = 
# 336 "./src/main/drivers/pwm_output.c" 3 4
                                  1
# 336 "./src/main/drivers/pwm_output.c"
                                      ;
                break;
            }
        }
...
# 341 "./src/main/drivers/pwm_output.c" 3 4
                                    1
# 341 "./src/main/drivers/pwm_output.c"
                                        ;
    }

    pwmMotorsEnabled = 
# 344 "./src/main/drivers/pwm_output.c" 3 4
                      1
# 344 "./src/main/drivers/pwm_output.c"
                          ;
}
...
# 352 "./src/main/drivers/pwm_output.c" 3 4
_Bool 
# 352 "./src/main/drivers/pwm_output.c"
    isMotorProtocolDshot(void)
{
    return isDshot;
}
# 433 "./src/main/drivers/pwm_output.c"
void pwmWriteServo(uint8_t index, float value)
{
...
void servoDevInit(const servoDevConfig_t *servoConfig)
{
    for (uint8_t servoIndex = 0; servoIndex < 8; servoIndex++) {
        ...
        IOConfigGPIO(servos[servoIndex].io, ((GPIO_Mode_AF_PP) | (GPIO_Speed_2MHz)));
...
# 465 "./src/main/drivers/pwm_output.c" 3 4
                                    1
# 465 "./src/main/drivers/pwm_output.c"
                                        ;
    }
}
...
void pwmWriteBeeper(
# 472 "./src/main/drivers/pwm_output.c" 3 4
                   _Bool 
# 472 "./src/main/drivers/pwm_output.c"
                        onoffBeep)
{
        if (!beeperPwm.io)
            return;
        if (onoffBeep == 
# 476 "./src/main/drivers/pwm_output.c" 3 4
                        1
# 476 "./src/main/drivers/pwm_output.c"
                            ) {
            *beeperPwm.channel.ccr = (((1) * 1000000) / freqBeep) / 2;
            beeperPwm.enabled = 
# 478 "./src/main/drivers/pwm_output.c" 3 4
                               1
# 478 "./src/main/drivers/pwm_output.c"
                                   ;
        } else {
            *beeperPwm.channel.ccr = 0;
            beeperPwm.enabled = 
# 481 "./src/main/drivers/pwm_output.c" 3 4
                               0
# 481 "./src/main/drivers/pwm_output.c"
                                    ;
        }
}
...
void beeperPwmInit(const ioTag_t tag, uint16_t frequency)
{
        ...
        if (beeperPwm.io && timer) {
            ...
            IOConfigGPIO(beeperPwm.io, ((GPIO_Mode_AF_PP) | (GPIO_Speed_2MHz)));
        ...
        *beeperPwm.channel.ccr = 0;
        beeperPwm.enabled = 
# 505 "./src/main/drivers/pwm_output.c" 3 4
                           0
# 505 "./src/main/drivers/pwm_output.c"
                                ;
}
