# 1 "./src/main/drivers/rx_pwm.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "./src/main/drivers/rx_pwm.c"
# 18 "./src/main/drivers/rx_pwm.c"
...
# 19 "./src/main/drivers/rx_pwm.c" 2
...
# 20 "./src/main/drivers/rx_pwm.c" 2
...
# 22 "./src/main/drivers/rx_pwm.c" 2
...
# 26 "./src/main/drivers/rx_pwm.c" 2
...
# 27 "./src/main/drivers/rx_pwm.c" 2
...
# 29 "./src/main/drivers/rx_pwm.c" 2

# 1 "./src/main/drivers/nvic.h" 1

       
# 31 "./src/main/drivers/rx_pwm.c" 2
...
# 32 "./src/main/drivers/rx_pwm.c" 2
...
# 33 "./src/main/drivers/rx_pwm.c" 2
...
# 35 "./src/main/drivers/rx_pwm.c" 2
...
# 36 "./src/main/drivers/rx_pwm.c" 2
...
# 38 "./src/main/drivers/rx_pwm.c" 2
# 52 "./src/main/drivers/rx_pwm.c"
...
# 100 "./src/main/drivers/rx_pwm.c" 3 4
   _Bool 
# 100 "./src/main/drivers/rx_pwm.c"
            tracking;
    
# 101 "./src/main/drivers/rx_pwm.c" 3 4
   _Bool 
# 101 "./src/main/drivers/rx_pwm.c"
            overflowed;
} ppmDevice_t;

static ppmDevice_t ppmDev;
# 113 "./src/main/drivers/rx_pwm.c"

# 113 "./src/main/drivers/rx_pwm.c" 3 4
_Bool 
# 113 "./src/main/drivers/rx_pwm.c"
    isPPMDataBeingReceived(void)
{
...
static void ppmResetDevice(void)
{
    ...
    ppmDev.tracking = 
# 160 "./src/main/drivers/rx_pwm.c" 3 4
                         0
# 160 "./src/main/drivers/rx_pwm.c"
                              ;
    ppmDev.overflowed = 
# 161 "./src/main/drivers/rx_pwm.c" 3 4
                         0
# 161 "./src/main/drivers/rx_pwm.c"
                              ;
}
...
static void ppmOverflowCallback(timerOvrHandlerRec_t* cbRec, captureCompare_t capture)
{
    ...
    if (capture == 0x10000 - 1) {
        ppmDev.overflowed = 
# 171 "./src/main/drivers/rx_pwm.c" 3 4
                           1
# 171 "./src/main/drivers/rx_pwm.c"
                               ;
    }
}
...
static void ppmEdgeCallback(timerCCHandlerRec_t* cbRec, captureCompare_t capture)
{
    ...
    ppmDev.overflowed = 
# 207 "./src/main/drivers/rx_pwm.c" 3 4
                       0
# 207 "./src/main/drivers/rx_pwm.c"
                            ;
    ...
    if (ppmDev.deltaTime > 2700) {
        ...
        ppmDev.tracking = 
# 242 "./src/main/drivers/rx_pwm.c" 3 4
                           1
# 242 "./src/main/drivers/rx_pwm.c"
                               ;
        ...
        if (ppmDev.deltaTime > 750
            ...
            ppmDev.tracking = 
# 257 "./src/main/drivers/rx_pwm.c" 3 4
                             0
# 257 "./src/main/drivers/rx_pwm.c"
                                  ;
            for (i = 0; i < 12; i++) {
                ppmDev.captures[i] = 0;
            }
...
# 267 "./src/main/drivers/rx_pwm.c" 3 4
_Bool 
# 267 "./src/main/drivers/rx_pwm.c"
    isPWMDataBeingReceived(void)
{
    int channel;
    for (channel = 0; channel < 12; channel++) {
        if (captures[channel] != 0) {
            return 
# 272 "./src/main/drivers/rx_pwm.c" 3 4
                  1
# 272 "./src/main/drivers/rx_pwm.c"
                      ;
        }
    }
    return 
# 275 "./src/main/drivers/rx_pwm.c" 3 4
          0
# 275 "./src/main/drivers/rx_pwm.c"
               ;
}
...
# 281 "./src/main/drivers/rx_pwm.c" 3 4
                                  __builtin_offsetof (
# 281 "./src/main/drivers/rx_pwm.c"
                                  pwmInputPort_t
# 281 "./src/main/drivers/rx_pwm.c" 3 4
                                  , 
# 281 "./src/main/drivers/rx_pwm.c"
...
# 291 "./src/main/drivers/rx_pwm.c" 3 4
                                  __builtin_offsetof (
# 291 "./src/main/drivers/rx_pwm.c"
                                  pwmInputPort_t
# 291 "./src/main/drivers/rx_pwm.c" 3 4
                                  , 
# 291 "./src/main/drivers/rx_pwm.c"
...
void pwmRxInit(const pwmConfig_t *pwmConfig)
{
    ...
    for (int channel = 0; channel < 8; channel++) {
        ...
        IOConfigGPIO(io, ((GPIO_Mode_IPD) | (GPIO_Speed_2MHz)));
