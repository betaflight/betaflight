# 1 "./src/main/drivers/bus_i2c_stm32f10x.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "./src/main/drivers/bus_i2c_stm32f10x.c"
# 18 "./src/main/drivers/bus_i2c_stm32f10x.c"
...
# 19 "./src/main/drivers/bus_i2c_stm32f10x.c" 2
...
# 20 "./src/main/drivers/bus_i2c_stm32f10x.c" 2
...
# 21 "./src/main/drivers/bus_i2c_stm32f10x.c" 2
...
# 22 "./src/main/drivers/bus_i2c_stm32f10x.c" 2
...
# 24 "./src/main/drivers/bus_i2c_stm32f10x.c" 2
...
# 26 "./src/main/drivers/bus_i2c_stm32f10x.c" 2
...
# 27 "./src/main/drivers/bus_i2c_stm32f10x.c" 2
# 1 "./src/main/drivers/nvic.h" 1

       
# 28 "./src/main/drivers/bus_i2c_stm32f10x.c" 2
...
# 29 "./src/main/drivers/bus_i2c_stm32f10x.c" 2
...
# 31 "./src/main/drivers/bus_i2c_stm32f10x.c" 2
# 1 "./src/main/drivers/bus_i2c_impl.h" 1
# 18 "./src/main/drivers/bus_i2c_impl.h"
       
# 31 "./src/main/drivers/bus_i2c_impl.h"
...
typedef struct i2cState_s {
    volatile 
# 47 "./src/main/drivers/bus_i2c_impl.h" 3 4
            _Bool 
# 47 "./src/main/drivers/bus_i2c_impl.h"
                 error;
    volatile 
# 48 "./src/main/drivers/bus_i2c_impl.h" 3 4
            _Bool 
# 48 "./src/main/drivers/bus_i2c_impl.h"
                 busy;
...
# 64 "./src/main/drivers/bus_i2c_impl.h" 3 4
   _Bool 
# 64 "./src/main/drivers/bus_i2c_impl.h"
        overClock;
    
# 65 "./src/main/drivers/bus_i2c_impl.h" 3 4
   _Bool 
# 65 "./src/main/drivers/bus_i2c_impl.h"
        pullUp;
...
# 32 "./src/main/drivers/bus_i2c_stm32f10x.c" 2
...
# 50 "./src/main/drivers/bus_i2c_stm32f10x.c"
const i2cHardware_t i2cHardware[2] = {
# 63 "./src/main/drivers/bus_i2c_stm32f10x.c"
    {
        .device = I2CDEV_2,
        .reg = ((I2C_TypeDef *) (((uint32_t)0x40000000) + 0x5800)),
        .sclPins = { ((ioTag_t)((((1) + 1) << 4) | (10))), 0 },
        .sdaPins = { ((ioTag_t)((((1) + 1) << 4) | (11))), 0 },
        .rcc = (((RCC_APB1) << 5) | (16*((((uint32_t)0x00400000))>65535L) + (8*(((((uint32_t)0x00400000))*1L >>16*((((uint32_t)0x00400000))>65535L))>255) + (8 - 90/(((((((uint32_t)0x00400000))*1L >>16*((((uint32_t)0x00400000))>65535L)) >>8*(((((uint32_t)0x00400000))*1L >>16*((((uint32_t)0x00400000))>65535L))>255))/4+14)|1) - 2/((((((uint32_t)0x00400000))*1L >>16*((((uint32_t)0x00400000))>65535L)) >>8*(((((uint32_t)0x00400000))*1L >>16*((((uint32_t)0x00400000))>65535L))>255))/2+1))))),
        .ev_irq = I2C2_EV_IRQn,
        .er_irq = I2C2_ER_IRQn,
    },
# 84 "./src/main/drivers/bus_i2c_stm32f10x.c"
};

i2cDevice_t i2cDevice[2];
...
# 116 "./src/main/drivers/bus_i2c_stm32f10x.c"
static 
# 116 "./src/main/drivers/bus_i2c_stm32f10x.c" 3 4
      _Bool 
# 116 "./src/main/drivers/bus_i2c_stm32f10x.c"
           i2cHandleHardwareFailure(I2CDevice device)
{
    i2cErrorCount++;

    i2cInit(device);
    return 
# 121 "./src/main/drivers/bus_i2c_stm32f10x.c" 3 4
          0
# 121 "./src/main/drivers/bus_i2c_stm32f10x.c"
               ;
}


# 124 "./src/main/drivers/bus_i2c_stm32f10x.c" 3 4
_Bool 
# 124 "./src/main/drivers/bus_i2c_stm32f10x.c"
    i2cWriteBuffer(I2CDevice device, uint8_t addr_, uint8_t reg_, uint8_t len_, uint8_t *data)
{
    if (device == I2CINVALID || device > 2) {
        return 
# 127 "./src/main/drivers/bus_i2c_stm32f10x.c" 3 4
              0
# 127 "./src/main/drivers/bus_i2c_stm32f10x.c"
                   ;
    }
    ...
    if (!I2Cx) {
        return 
# 133 "./src/main/drivers/bus_i2c_stm32f10x.c" 3 4
              0
# 133 "./src/main/drivers/bus_i2c_stm32f10x.c"
                   ;
    }
    ...
    state->busy = 1;
    state->error = 
# 147 "./src/main/drivers/bus_i2c_stm32f10x.c" 3 4
                  0
# 147 "./src/main/drivers/bus_i2c_stm32f10x.c"
                       ;

    if (!(I2Cx->CR2 & ((uint16_t)0x0200))) {
        if (!(I2Cx->CR1 & ((uint16_t)0x0100))) {
            while (I2Cx->CR1 & ((uint16_t)0x0200) && --timeout > 0) {; }
            if (timeout == 0)
                return i2cHandleHardwareFailure(device);
            I2C_GenerateSTART(I2Cx, ENABLE);
        }
        I2C_ITConfig(I2Cx, ((uint16_t)0x0200) | ((uint16_t)0x0100), ENABLE);
    }
...
# 167 "./src/main/drivers/bus_i2c_stm32f10x.c" 3 4
_Bool 
# 167 "./src/main/drivers/bus_i2c_stm32f10x.c"
    i2cWrite(I2CDevice device, uint8_t addr_, uint8_t reg_, uint8_t data)
{
    return i2cWriteBuffer(device, addr_, reg_, 1, &data);
}


# 172 "./src/main/drivers/bus_i2c_stm32f10x.c" 3 4
_Bool 
# 172 "./src/main/drivers/bus_i2c_stm32f10x.c"
    i2cRead(I2CDevice device, uint8_t addr_, uint8_t reg_, uint8_t len, uint8_t* buf)
{
    if (device == I2CINVALID || device > 2) {
        return 
# 175 "./src/main/drivers/bus_i2c_stm32f10x.c" 3 4
              0
# 175 "./src/main/drivers/bus_i2c_stm32f10x.c"
                   ;
    }
    ...
    if (!I2Cx) {
        return 
# 181 "./src/main/drivers/bus_i2c_stm32f10x.c" 3 4
              0
# 181 "./src/main/drivers/bus_i2c_stm32f10x.c"
                   ;
    }
    ...
    state->busy = 1;
    state->error = 
# 195 "./src/main/drivers/bus_i2c_stm32f10x.c" 3 4
                  0
# 195 "./src/main/drivers/bus_i2c_stm32f10x.c"
                       ;
...
static void i2c_er_handler(I2CDevice device) {
    ...
    if (SR1Register & 0x0F00)
        state->error = 
# 225 "./src/main/drivers/bus_i2c_stm32f10x.c" 3 4
                      1
# 225 "./src/main/drivers/bus_i2c_stm32f10x.c"
                          ;


    if (SR1Register & 0x0700) {
        (void)I2Cx->SR2;
        I2C_ITConfig(I2Cx, ((uint16_t)0x0400), DISABLE);
        if (!(SR1Register & ((uint16_t)0x0200)) && !(I2Cx->CR1 & ((uint16_t)0x0200))) {
            if (I2Cx->CR1 & ((uint16_t)0x0100)) {
                while (I2Cx->CR1 & ((uint16_t)0x0100)) {; }
                I2C_GenerateSTOP(I2Cx, ENABLE);
                while (I2Cx->CR1 & ((uint16_t)0x0200)) {; }
                i2cInit(device);
            }
            else {
                I2C_GenerateSTOP(I2Cx, ENABLE);
                I2C_ITConfig(I2Cx, ((uint16_t)0x0200) | ((uint16_t)0x0100), DISABLE);
            }
        }
    }
    I2Cx->SR1 &= ~0x0F00;
...
void i2c_ev_handler(I2CDevice device) {
    ...
    if (SReg_1 & ((uint16_t)0x0001)) {
        ...
        if (state->reading && (subaddress_sent || 0xFF == state->reg)) {
            ...
            if (state->bytes == 2)
                I2Cx->CR1 |= ((uint16_t)0x0800);
            I2C_Send7bitAddress(I2Cx, state->addr, ((uint8_t)0x01));
        }
        else {
            I2C_Send7bitAddress(I2Cx, state->addr, ((uint8_t)0x00));
            if (state->reg != 0xFF)
                index = -1;
        }
    }
    else if (SReg_1 & ((uint16_t)0x0002)) {
        ...
        if (state->bytes == 1 && state->reading && subaddress_sent) {
            ...
            I2C_GenerateSTOP(I2Cx, ENABLE);
            final_stop = 1;
            I2C_ITConfig(I2Cx, ((uint16_t)0x0400), ENABLE);
        }
        else {
            (void)I2Cx->SR2;
            __DMB();
    ...
    else if (SReg_1 & ((uint16_t)0x0004)) {
        final_stop = 1;
    ...
    else if (SReg_1 & ((uint16_t)0x0040)) {
        state->read_p[index++] = (uint8_t)I2Cx->DR;
    ...
    else if (SReg_1 & ((uint16_t)0x0080)) {
        if (index != -1) {
...
void i2cInit(I2CDevice device)
{
    ...
    IOInit(scl, OWNER_I2C_SCL, (device + 1));
    IOInit(sda, OWNER_I2C_SDA, (device + 1));
    ...
    IOConfigGPIO(scl, ((GPIO_Mode_AF_OD) | (GPIO_Speed_50MHz)));
    IOConfigGPIO(sda, ((GPIO_Mode_AF_OD) | (GPIO_Speed_50MHz)));
    ...
    I2C_ITConfig(I2Cx, ((uint16_t)0x0200) | ((uint16_t)0x0100), DISABLE);
    i2cInit.I2C_Mode = ((uint16_t)0x0000);
    i2cInit.I2C_DutyCycle = ((uint16_t)0xBFFF);
    i2cInit.I2C_OwnAddress1 = 0;
    i2cInit.I2C_Ack = ((uint16_t)0x0400);
    i2cInit.I2C_AcknowledgedAddress = ((uint16_t)0x4000);
    ...
    nvic.NVIC_IRQChannelPreemptionPriority = ((((((((0)<<(4-(7-(((uint32_t)0x500)>>8))))|((0)&(0x0f>>(7-(((uint32_t)0x500)>>8)))))<<4)&0xf0))>>(4-(7-(((uint32_t)0x500)>>8))))>>4);
    nvic.NVIC_IRQChannelSubPriority = ((((((((0)<<(4-(7-(((uint32_t)0x500)>>8))))|((0)&(0x0f>>(7-(((uint32_t)0x500)>>8)))))<<4)&0xf0))&(0x0f>>(7-(((uint32_t)0x500)>>8))))>>4);
...
static void i2cUnstick(IO_t scl, IO_t sda)
{
    ...
    IOConfigGPIO(scl, ((GPIO_Mode_Out_OD) | (GPIO_Speed_2MHz)));
    IOConfigGPIO(sda, ((GPIO_Mode_Out_OD) | (GPIO_Speed_2MHz)));
