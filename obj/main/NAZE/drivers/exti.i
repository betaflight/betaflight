...
# 50 "./src/main/drivers/exti.c"
void EXTIInit(void)
{


    RCC_APB2PeriphClockCmd(((uint32_t)0x00000001), ENABLE);
# 66 "./src/main/drivers/exti.c"
                             ...
                             enable)
{
    ...
    if (!extiLine)
        return;
    if (enable)
        ((EXTI_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0400))->IMR |= extiLine;
    else
        ((EXTI_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0400))->IMR &= ~extiLine;
# 185 "./src/main/drivers/exti.c"
}

void EXTI_IRQHandler(void)
{
    uint32_t exti_active = ((EXTI_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0400))->IMR & ((EXTI_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0400))->PR;

    while (exti_active) {
        unsigned idx = 31 - __builtin_clz(exti_active);
        uint32_t mask = 1 << idx;
        extiChannelRecs[idx].handler->fn(extiChannelRecs[idx].handler);
        ((EXTI_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0400))->PR = mask;
        exti_active &= ~mask;
    }
}
...
void EXTI2_IRQHandler(void) { EXTI_IRQHandler(); } struct dummy;
