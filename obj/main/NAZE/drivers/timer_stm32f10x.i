# 1 "./src/main/drivers/timer_stm32f10x.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "./src/main/drivers/timer_stm32f10x.c"
# 18 "./src/main/drivers/timer_stm32f10x.c"
...
# 19 "./src/main/drivers/timer_stm32f10x.c" 2
...
# 21 "./src/main/drivers/timer_stm32f10x.c" 2
...
# 24 "./src/main/drivers/timer_stm32f10x.c" 2
...
# 25 "./src/main/drivers/timer_stm32f10x.c" 2

const timerDef_t timerDefinitions[4] = {
    ...
    { .TIMx = ((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0000)), .rcc = (((RCC_APB1) << 5) | (16*((((uint32_t)0x00000001))>65535L) + (8*(((((uint32_t)0x00000001))*1L >>16*((((uint32_t)0x00000001))>65535L))>255) + (8 - 90/(((((((uint32_t)0x00000001))*1L >>16*((((uint32_t)0x00000001))>65535L)) >>8*(((((uint32_t)0x00000001))*1L >>16*((((uint32_t)0x00000001))>65535L))>255))/4+14)|1) - 2/((((((uint32_t)0x00000001))*1L >>16*((((uint32_t)0x00000001))>65535L)) >>8*(((((uint32_t)0x00000001))*1L >>16*((((uint32_t)0x00000001))>65535L))>255))/2+1))))), .inputIrq = TIM2_IRQn },
    { .TIMx = ((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0400)), .rcc = (((RCC_APB1) << 5) | (16*((((uint32_t)0x00000002))>65535L) + (8*(((((uint32_t)0x00000002))*1L >>16*((((uint32_t)0x00000002))>65535L))>255) + (8 - 90/(((((((uint32_t)0x00000002))*1L >>16*((((uint32_t)0x00000002))>65535L)) >>8*(((((uint32_t)0x00000002))*1L >>16*((((uint32_t)0x00000002))>65535L))>255))/4+14)|1) - 2/((((((uint32_t)0x00000002))*1L >>16*((((uint32_t)0x00000002))>65535L)) >>8*(((((uint32_t)0x00000002))*1L >>16*((((uint32_t)0x00000002))>65535L))>255))/2+1))))), .inputIrq = TIM3_IRQn },
    { .TIMx = ((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0800)), .rcc = (((RCC_APB1) << 5) | (16*((((uint32_t)0x00000004))>65535L) + (8*(((((uint32_t)0x00000004))*1L >>16*((((uint32_t)0x00000004))>65535L))>255) + (8 - 90/(((((((uint32_t)0x00000004))*1L >>16*((((uint32_t)0x00000004))>65535L)) >>8*(((((uint32_t)0x00000004))*1L >>16*((((uint32_t)0x00000004))>65535L))>255))/4+14)|1) - 2/((((((uint32_t)0x00000004))*1L >>16*((((uint32_t)0x00000004))>65535L)) >>8*(((((uint32_t)0x00000004))*1L >>16*((((uint32_t)0x00000004))>65535L))>255))/2+1))))), .inputIrq = TIM4_IRQn },
# 45 "./src/main/drivers/timer_stm32f10x.c"
};
