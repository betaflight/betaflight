...
# 26 "./src/main/drivers/sound_beeper.c" 2
...
# 30 "./src/main/drivers/sound_beeper.c" 3 4
                      ((void *)0)
# 30 "./src/main/drivers/sound_beeper.c"
                                    ;
static 
...
void systemBeep(
# 35 "./src/main/drivers/sound_beeper.c" 3 4
               _Bool 
# 35 "./src/main/drivers/sound_beeper.c"
                    onoff)
{
...
void beeperInit(const beeperDevConfig_t *config)
{
    ...
    if (beeperFrequency == 0) {
        ...
        if (beeperIO) {
            ...
            IOConfigGPIO(beeperIO, config->isOpenDrain ? ((GPIO_Mode_Out_OD) | (GPIO_Speed_2MHz)) : ((GPIO_Mode_Out_PP) | (GPIO_Speed_2MHz)));
        }
        systemBeep(
# 70 "./src/main/drivers/sound_beeper.c" 3 4
                  0
# 70 "./src/main/drivers/sound_beeper.c"
                       );
    } else {
