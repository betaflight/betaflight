...
extern spiDevice_t spiDevice[2];
...
SPIDevice spiDeviceByInstance(SPI_TypeDef *instance)
{
    ...
    if (instance == ((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x3800)))
        return SPIDEV_2;
...
# 85 "./src/main/drivers/bus_spi.c"
    ...
    IOConfigGPIO(IOGetByTag(spi->sck), ((GPIO_Mode_AF_PP) | (GPIO_Speed_50MHz)));
    IOConfigGPIO(IOGetByTag(spi->miso), ((GPIO_Mode_IN_FLOATING) | (GPIO_Speed_50MHz)));
    IOConfigGPIO(IOGetByTag(spi->mosi), ((GPIO_Mode_AF_PP) | (GPIO_Speed_50MHz)));
    ...
    spiInit.SPI_DataSize = ((uint16_t)0x0000);
...
# 132 "./src/main/drivers/bus_spi.c" 3 4
_Bool 
# 132 "./src/main/drivers/bus_spi.c"
    spiInit(SPIDevice device)
{
    switch (device) {
    case SPIINVALID:
        return 
# 136 "./src/main/drivers/bus_spi.c" 3 4
              0
# 136 "./src/main/drivers/bus_spi.c"
                   ;
    case SPIDEV_1:
    ...
    case SPIDEV_2:
        ...
        return 
# 147 "./src/main/drivers/bus_spi.c" 3 4
              1
# 147 "./src/main/drivers/bus_spi.c"
                  ;
...
# 208 "./src/main/drivers/bus_spi.c" 3 4
_Bool 
# 208 "./src/main/drivers/bus_spi.c"
    spiIsBusBusy(SPI_TypeDef *instance)
{



    return SPI_I2S_GetFlagStatus(instance, ((uint16_t)0x0002)) == RESET || SPI_I2S_GetFlagStatus(instance, ((uint16_t)0x0080)) == SET;


}


# 218 "./src/main/drivers/bus_spi.c" 3 4
_Bool 
# 218 "./src/main/drivers/bus_spi.c"
    spiTransfer(SPI_TypeDef *instance, const uint8_t *txData, uint8_t *rxData, int len)
{
    uint16_t spiTimeout = 1000;
    ...
    return 
# 249 "./src/main/drivers/bus_spi.c" 3 4
          1
# 249 "./src/main/drivers/bus_spi.c"
              ;
}
...
# 253 "./src/main/drivers/bus_spi.c" 2


# 254 "./src/main/drivers/bus_spi.c" 3 4
_Bool 
# 254 "./src/main/drivers/bus_spi.c"
    spiBusTransfer(const busDevice_t *bus, const uint8_t *txData, uint8_t *rxData, int length)
{
    ...
    return 
# 259 "./src/main/drivers/bus_spi.c" 3 4
          1
# 259 "./src/main/drivers/bus_spi.c"
              ;
}

void spiSetDivisor(SPI_TypeDef *instance, uint16_t divisor)
{
# 274 "./src/main/drivers/bus_spi.c"
...
# 301 "./src/main/drivers/bus_spi.c" 3 4
_Bool 
# 301 "./src/main/drivers/bus_spi.c"
    spiBusWriteRegister(const busDevice_t *bus, uint8_t reg, uint8_t data)
{
    IOLo(bus->busdev_u.spi.csnPin);
    ...
    return 
# 308 "./src/main/drivers/bus_spi.c" 3 4
          1
# 308 "./src/main/drivers/bus_spi.c"
              ;
}


# 311 "./src/main/drivers/bus_spi.c" 3 4
_Bool 
# 311 "./src/main/drivers/bus_spi.c"
    spiBusReadRegisterBuffer(const busDevice_t *bus, uint8_t reg, uint8_t *data, uint8_t length)
{
    IOLo(bus->busdev_u.spi.csnPin);
    spiTransferByte(bus->busdev_u.spi.instance, reg | 0x80);
    spiTransfer(bus->busdev_u.spi.instance, 
# 315 "./src/main/drivers/bus_spi.c" 3 4
                                           ((void *)0)
# 315 "./src/main/drivers/bus_spi.c"
                                               , data, length);
    IOHi(bus->busdev_u.spi.csnPin);

    return 
# 318 "./src/main/drivers/bus_spi.c" 3 4
          1
# 318 "./src/main/drivers/bus_spi.c"
              ;
}
...
uint8_t spiBusReadRegister(const busDevice_t *bus, uint8_t reg)
{
    ...
    spiTransferByte(bus->busdev_u.spi.instance, reg | 0x80);
    spiTransfer(bus->busdev_u.spi.instance, 
# 326 "./src/main/drivers/bus_spi.c" 3 4
                                           ((void *)0)
# 326 "./src/main/drivers/bus_spi.c"
                                               , &data, 1);
    IOHi(bus->busdev_u.spi.csnPin);
