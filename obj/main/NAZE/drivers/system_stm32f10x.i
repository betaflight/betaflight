# 1 "./src/main/drivers/system_stm32f10x.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "./src/main/drivers/system_stm32f10x.c"
# 18 "./src/main/drivers/system_stm32f10x.c"
...
# 19 "./src/main/drivers/system_stm32f10x.c" 2
...
# 20 "./src/main/drivers/system_stm32f10x.c" 2
...
# 22 "./src/main/drivers/system_stm32f10x.c" 2

# 1 "./src/main/drivers/nvic.h" 1

       
# 24 "./src/main/drivers/system_stm32f10x.c" 2
...
# 25 "./src/main/drivers/system_stm32f10x.c" 2




void SetSysClock(
# 29 "./src/main/drivers/system_stm32f10x.c" 3 4
                _Bool 
# 29 "./src/main/drivers/system_stm32f10x.c"
                     overclock);

void systemReset(void)
{

    ((SCB_Type *) ((0xE000E000) + 0x0D00))->AIRCR = ((uint32_t)0x05FA0000) | (uint32_t)0x04;
}
...
void enableGPIOPowerUsageAndNoiseReductions(void)
{
    RCC_APB2PeriphClockCmd(((uint32_t)0x00000004) | ((uint32_t)0x00000008) | ((uint32_t)0x00000010), ENABLE);

    GPIO_InitTypeDef GPIO_InitStructure = {
        .GPIO_Mode = GPIO_Mode_AIN,
        .GPIO_Pin = ((uint16_t)0xFFFF)
    };
...
# 60 "./src/main/drivers/system_stm32f10x.c" 3 4
_Bool 
# 60 "./src/main/drivers/system_stm32f10x.c"
    isMPUSoftReset(void)
{
    if (cachedRccCsrValue & ((uint32_t)0x10000000))
        return 
# 63 "./src/main/drivers/system_stm32f10x.c" 3 4
              1
# 63 "./src/main/drivers/system_stm32f10x.c"
                  ;
    else
        return 
# 65 "./src/main/drivers/system_stm32f10x.c" 3 4
              0
# 65 "./src/main/drivers/system_stm32f10x.c"
                   ;
}
...
void systemInit(void)
{
    ...
    SetSysClock(
# 72 "./src/main/drivers/system_stm32f10x.c" 3 4
               0
# 72 "./src/main/drivers/system_stm32f10x.c"
                    );
# 81 "./src/main/drivers/system_stm32f10x.c"
    ...
    cachedRccCsrValue = ((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x20000) + 0x1000))->CSR;
    RCC_ClearFlag();
    ...
    GPIO_InitTypeDef GPIO_InitStructure = {
        ...
        .GPIO_Pin = ((uint16_t)0x0200),
        .GPIO_Speed = GPIO_Speed_2MHz
    };

    ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800))->BSRR = GPIO_InitStructure.GPIO_Pin;
    GPIO_Init(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0800)), &GPIO_InitStructure);



    ((AFIO_TypeDef *) ((((uint32_t)0x40000000) + 0x10000) + 0x0000))->MAPR |= (0x2 << 24);
