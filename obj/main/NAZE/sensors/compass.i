...
const compassConfig_t pgResetTemplate_compassConfig __attribute__ ((section(".pg_resetdata"), used, aligned(2))) = { .mag_align = ALIGN_DEFAULT, .mag_hardware = 1, .mag_declination = 0, .interruptTag = ((ioTag_t)((((2) + 1) << 4) | (14))) }
