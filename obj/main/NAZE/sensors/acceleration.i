...
# 441 "./src/main/drivers/accgyro/accgyro_lsm303dlhc.h"

# 441 "./src/main/drivers/accgyro/accgyro_lsm303dlhc.h" 3 4
_Bool 
# 441 "./src/main/drivers/accgyro/accgyro_lsm303dlhc.h"
...
# 56 "./src/main/sensors/acceleration.c" 2
...
# 71 "./src/main/io/beeper.h"
    isBeeperOn(void);
# 59 "./src/main/sensors/acceleration.c" 2
...
# 61 "./src/main/sensors/acceleration.c" 2
...
# 67 "./src/main/sensors/acceleration.c" 2
...
extern 
# 75 "./src/main/sensors/acceleration.c" 3 4
      _Bool 
# 75 "./src/main/sensors/acceleration.c"
           AccInflightCalibrationMeasurementDone;
extern 
# 76 "./src/main/sensors/acceleration.c" 3 4
      _Bool 
# 76 "./src/main/sensors/acceleration.c"
...
# 113 "./src/main/sensors/acceleration.c" 3 4
   0
# 113 "./src/main/sensors/acceleration.c"
   , };
...
# 123 "./src/main/sensors/acceleration.c" 3 4
_Bool 
# 123 "./src/main/sensors/acceleration.c"
...
retry:
    ...
    case ACC_ADXL345:
        ...
        acc_params.useFifo = 
# 139 "./src/main/sensors/acceleration.c" 3 4
                            0
# 139 "./src/main/sensors/acceleration.c"
                                 ;
        acc_params.dataRate = 800;
        if (adxl345Detect(&acc_params, dev)) {

            dev->accAlign = CW270_DEG;
        ...
        ;
    case ACC_LSM303DLHC:
# 160 "./src/main/sensors/acceleration.c"
        ;
    case ACC_MPU6050:

        if (mpu6050AccDetect(dev)) {

            dev->accAlign = CW0_DEG;
    ...
    case ACC_BMA280:
        ...
        ;
    case ACC_MPU6000:
# 204 "./src/main/sensors/acceleration.c"
        ;
    case ACC_MPU9250:
# 215 "./src/main/sensors/acceleration.c"
        ;
    case ACC_MPU6500:
    case ACC_ICM20601:
    case ACC_ICM20602:
...
# 260 "./src/main/sensors/acceleration.c"
        ;
    case ACC_ICM20689:
# 271 "./src/main/sensors/acceleration.c"
        ;
    case ACC_BMI160:
# 282 "./src/main/sensors/acceleration.c"
        ;
    case ACC_FAKE:
    ...
    if (accHardware == ACC_NONE) {
        return 
# 306 "./src/main/sensors/acceleration.c" 3 4
              0
# 306 "./src/main/sensors/acceleration.c"
                   ;
    }
    ...
    return 
# 311 "./src/main/sensors/acceleration.c" 3 4
          1
# 311 "./src/main/sensors/acceleration.c"
              ;
}


# 314 "./src/main/sensors/acceleration.c" 3 4
_Bool 
# 314 "./src/main/sensors/acceleration.c"
    accInit(uint32_t gyroSamplingInverval)
{
    ...
    if (!accDetect(&acc.dev, accelerometerConfig()->acc_hardware)) {
        return 
# 323 "./src/main/sensors/acceleration.c" 3 4
              0
# 323 "./src/main/sensors/acceleration.c"
                   ;
    }
    acc.dev.acc_1G = 256;
    ...
    return 
# 351 "./src/main/sensors/acceleration.c" 3 4
          1
# 351 "./src/main/sensors/acceleration.c"
              ;
}
...
# 359 "./src/main/sensors/acceleration.c" 3 4
_Bool 
# 359 "./src/main/sensors/acceleration.c"
    isAccelerationCalibrationComplete(void)
{
...
static 
# 364 "./src/main/sensors/acceleration.c" 3 4
      _Bool 
# 364 "./src/main/sensors/acceleration.c"
...
static 
# 369 "./src/main/sensors/acceleration.c" 3 4
      _Bool 
# 369 "./src/main/sensors/acceleration.c"
...
static void performInflightAccelerationCalibration(rollAndPitchTrims_t *rollAndPitchTrims)
{
    ...
    if (InflightcalibratingA > 0) {
        ...
        if (InflightcalibratingA == 1) {
            AccInflightCalibrationActive = 
# 434 "./src/main/sensors/acceleration.c" 3 4
                                          0
# 434 "./src/main/sensors/acceleration.c"
                                               ;
            AccInflightCalibrationMeasurementDone = 
# 435 "./src/main/sensors/acceleration.c" 3 4
                                                   1
# 435 "./src/main/sensors/acceleration.c"
                                                       ;
...
# 471 "./src/main/sensors/acceleration.c" 3 4
                                   1
# 471 "./src/main/sensors/acceleration.c"
                                       ;
