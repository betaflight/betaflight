# 1 "./src/main/target/NAZE/hardware_revision.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "./src/main/target/NAZE/hardware_revision.c"
# 18 "./src/main/target/NAZE/hardware_revision.c"
...
# 19 "./src/main/target/NAZE/hardware_revision.c" 2
...
# 20 "./src/main/target/NAZE/hardware_revision.c" 2
...
# 21 "./src/main/target/NAZE/hardware_revision.c" 2
...
# 23 "./src/main/target/NAZE/hardware_revision.c" 2

# 1 "./src/main/build/build_config.h" 1
# 18 "./src/main/build/build_config.h"
       
# 25 "./src/main/target/NAZE/hardware_revision.c" 2
...
# 22 "./src/main/drivers/accgyro/accgyro.h" 2
...
# 27 "./src/main/target/NAZE/hardware_revision.c" 2
...
# 29 "./src/main/target/NAZE/hardware_revision.c" 2
...
# 30 "./src/main/target/NAZE/hardware_revision.c" 2
...
# 31 "./src/main/target/NAZE/hardware_revision.c" 2
...
# 32 "./src/main/target/NAZE/hardware_revision.c" 2
...
# 33 "./src/main/target/NAZE/hardware_revision.c" 2
...
# 35 "./src/main/target/NAZE/hardware_revision.c" 2
...
# 58 "./src/main/target/NAZE/hardware_revision.c"
static IO_t nazeSpiCsPin = ((IO_t)0);

uint8_t detectSpiDevice(void)
{

    nazeSpiCsPin = IOGetByTag(((ioTag_t)((((1) + 1) << 4) | (12))));
    ...
    delay(50);
    IOLo(nazeSpiCsPin);
    spiTransfer(((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x3800)), out, in, sizeof(out));
    IOHi(nazeSpiCsPin);

    flash_id = in[1] << 16 | in[2] << 8 | in[3];
    if (flash_id == (0x202015))
        return (1);
    ...
    delay(50);
    IOLo(nazeSpiCsPin);
    spiTransferByte(((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x3800)), 0x75 | (0x80));
    in[0] = spiTransferByte(((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x3800)), 0xff);
    IOHi(nazeSpiCsPin);
...
void updateHardwareRevision(void)
{
    ...
    if (detectedSpiDevice == (2) && hardwareRevision == NAZE32_REV5)
...
ioTag_t selectMPUIntExtiConfigByHardwareRevision(void)
{
    ...
    if (hardwareRevision < NAZE32_REV5) {
        ...
        return ((ioTag_t)((((1) + 1) << 4) | (13)));
    } else {

        return ((ioTag_t)((((2) + 1) << 4) | (13)));
    }
