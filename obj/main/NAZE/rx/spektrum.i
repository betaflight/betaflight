...
# 48 "./src/main/rx/spektrum.c" 2
# 62 "./src/main/rx/spektrum.c"
static uint8_t spek_chan_shift;
static uint8_t spek_chan_mask;
static 
# 64 "./src/main/rx/spektrum.c" 3 4
      _Bool 
# 64 "./src/main/rx/spektrum.c"
           rcFrameComplete = 
# 64 "./src/main/rx/spektrum.c" 3 4
                             0
# 64 "./src/main/rx/spektrum.c"
                                  ;
static 
# 65 "./src/main/rx/spektrum.c" 3 4
      _Bool 
# 65 "./src/main/rx/spektrum.c"
           spekHiRes = 
# 65 "./src/main/rx/spektrum.c" 3 4
                       0
# 65 "./src/main/rx/spektrum.c"
                            ;
static 
# 66 "./src/main/rx/spektrum.c" 3 4
      _Bool 
# 66 "./src/main/rx/spektrum.c"
           srxlEnabled = 
# 66 "./src/main/rx/spektrum.c" 3 4
                         0
# 66 "./src/main/rx/spektrum.c"
...
static void spektrumDataReceive(uint16_t c)
{
    ...
    if (spekFramePosition < 16) {
        ...
        if (spekFramePosition < 16) {
            rcFrameComplete = 
# 103 "./src/main/rx/spektrum.c" 3 4
                             0
# 103 "./src/main/rx/spektrum.c"
                                  ;
        } else {
            rcFrameComplete = 
# 105 "./src/main/rx/spektrum.c" 3 4
                             1
# 105 "./src/main/rx/spektrum.c"
                                 ;
        }
    }
}

static uint32_t spekChannelData[12];
...
static uint8_t spektrumFrameStatus(void)
{
    ...
    rcFrameComplete = 
# 119 "./src/main/rx/spektrum.c" 3 4
                     0
# 119 "./src/main/rx/spektrum.c"
                          ;
    ...
    if (spek_fade_last_sec == 0) {
        ...
        if ((current_secs - spek_fade_last_sec) == 1) {
            if (rssi_channel != 0) {
                if (spekHiRes)
                    spekChannelData[rssi_channel] = 2048 - ((fade - spek_fade_last_sec_count) * 2048 / (40 / 2));
                else
                    spekChannelData[rssi_channel] = 1024 - ((fade - spek_fade_last_sec_count) * 1024 / (40 / 2));
            }
        }
        spek_fade_last_sec_count = fade;
        spek_fade_last_sec = current_secs;
...
# 297 "./src/main/rx/spektrum.c"

# 297 "./src/main/rx/spektrum.c" 3 4
_Bool 
# 297 "./src/main/rx/spektrum.c"
    spektrumInit(const rxConfig_t *rxConfig, rxRuntimeConfig_t *rxRuntimeConfig)
{
    ...
    if (!portConfig) {
        return 
# 303 "./src/main/rx/spektrum.c" 3 4
              0
# 303 "./src/main/rx/spektrum.c"
                   ;
    }

    srxlEnabled = 
# 306 "./src/main/rx/spektrum.c" 3 4
                 0
# 306 "./src/main/rx/spektrum.c"
                      ;

    
# 308 "./src/main/rx/spektrum.c" 3 4
   _Bool 
# 308 "./src/main/rx/spektrum.c"
    ...
    case SERIALRX_SPEKTRUM2048:
        ...
        spek_chan_mask = 0x07;
        spekHiRes = 
# 322 "./src/main/rx/spektrum.c" 3 4
                   1
# 322 "./src/main/rx/spektrum.c"
                       ;
    ...
    case SERIALRX_SPEKTRUM1024:
        ...
        spek_chan_mask = 0x03;
        spekHiRes = 
# 330 "./src/main/rx/spektrum.c" 3 4
                   0
# 330 "./src/main/rx/spektrum.c"
                        ;
    ...
    return serialPort != 
# 361 "./src/main/rx/spektrum.c" 3 4
                        ((void *)0)
# 361 "./src/main/rx/spektrum.c"
                            ;
}
...
# 381 "./src/main/rx/spektrum.c" 3 4
_Bool 
# 381 "./src/main/rx/spektrum.c"
    srxlRxIsActive(void)
{
    return serialPort != 
# 383 "./src/main/rx/spektrum.c" 3 4
                        ((void *)0)
# 383 "./src/main/rx/spektrum.c"
                            ;
}
