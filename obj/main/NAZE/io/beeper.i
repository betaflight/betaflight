...
0
# 70 "./src/main/io/beeper.c"
, .ioTag = ((ioTag_t)((((0) + 1) << 4) | (12))), .frequency = 0 }
...
# 213 "./src/main/io/beeper.c"
    ...
    { BEEPER_ALL,19,
# 215 "./src/main/io/beeper.c" 3 4
     ((void *)0)
# 215 "./src/main/io/beeper.c"
     ,"ALL" },
    { BEEPER_PREFERENCE,20,
# 216 "./src/main/io/beeper.c" 3 4
     ((void *)0)
# 216 "./src/main/io/beeper.c"
     ,"PREFERRED" },
};
...
# 239 "./src/main/io/beeper.c" 3 4
                                                 ((void *)0)
# 239 "./src/main/io/beeper.c"
                                                     ;
...
{
    systemBeep(
# 270 "./src/main/io/beeper.c" 3 4
   0
# 270 "./src/main/io/beeper.c"
   );
    warningLedDisable();
    warningLedRefresh();
    ...
    currentBeeperEntry = 
# 280 "./src/main/io/beeper.c" 3 4
                        ((void *)0)
# 280 "./src/main/io/beeper.c"
                            ;
}
...
void beeperUpdate(timeUs_t currentTimeUs)
{
    ...
    if (currentBeeperEntry == 
# 362 "./src/main/io/beeper.c" 3 4
                             ((void *)0)
# 362 "./src/main/io/beeper.c"
                                 ) {
        return;
    }
    ...
    if (!beeperIsOn) {
        ...
        if (currentBeeperEntry->sequence[beeperPos] != 0) {
            if (!(getBeeperOffMask() & (1 << (currentBeeperEntry->mode - 1))))
                systemBeep(
# 385 "./src/main/io/beeper.c" 3 4
               1
# 385 "./src/main/io/beeper.c"
               );
            warningLedEnable();
            warningLedRefresh();
        ...
        if (currentBeeperEntry->sequence[beeperPos] != 0) {
            systemBeep(
# 399 "./src/main/io/beeper.c" 3 4
           0
# 399 "./src/main/io/beeper.c"
           );
            warningLedDisable();
            warningLedRefresh();
        }
...
# 463 "./src/main/io/beeper.c" 3 4
                                                                                      ((void *)0)
# 463 "./src/main/io/beeper.c"
                                                                                          ;
...
# 478 "./src/main/io/beeper.c" 3 4
_Bool 
# 478 "./src/main/io/beeper.c"
    isBeeperOn(void)
{
    return beeperIsOn;
}
