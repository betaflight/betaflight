...
void max7456Invert(
# 40 "./src/main/drivers/max7456.h" 3 4
                     _Bool 
# 40 "./src/main/drivers/max7456.h"
                          invert);
...
# 50 "./src/main/drivers/max7456.h" 3 4
_Bool 
# 50 "./src/main/drivers/max7456.h"
...
# 42 "./src/main/drivers/system.h" 3 4
_Bool 
...
# 51 "./src/main/fc/fc_core.h" 3 4
_Bool 
# 51 "./src/main/fc/fc_core.h"
    isMotorsReversed(void);

# 52 "./src/main/fc/fc_core.h" 3 4
_Bool 
# 52 "./src/main/fc/fc_core.h"
    isFlipOverAfterCrashMode(void);
# 62 "./src/main/fc/fc_msp.c" 2
...
# 63 "./src/main/fc/fc_msp.c" 2
# 1 "./src/main/fc/fc_msp_box.h" 1
# 18 "./src/main/fc/fc_msp_box.h"
...
# 98 "./src/main/fc/rc_adjustments.h"
...
# 71 "./src/main/msp/msp_serial.h" 3 4
_Bool 
# 71 "./src/main/msp/msp_serial.h"
...
typedef enum {
    ...
    TASK_BEEPER,
# 72 "./src/main/scheduler/scheduler.h"
    TASK_BARO,
    ...
    TASK_LEDSTRIP,
# 122 "./src/main/scheduler/scheduler.h"
    TASK_COUNT,
...
# 133 "./src/main/scheduler/scheduler.h" 3 4
   _Bool 
# 133 "./src/main/scheduler/scheduler.h"
...
# 159 "./src/main/scheduler/scheduler.h" 3 4
                                      _Bool 
# 159 "./src/main/scheduler/scheduler.h"
                                           newEnabledState);
timeDelta_t getTaskDeltaTime(cfTaskId_e taskId);
void schedulerSetCalulateTaskStatistics(
# 161 "./src/main/scheduler/scheduler.h" 3 4
                                       _Bool 
# 161 "./src/main/scheduler/scheduler.h"
...
static void mspRebootFn(serialPort_t *serialPort)
{
    ...
    while (
# 219 "./src/main/fc/fc_msp.c" 3 4
          1
# 219 "./src/main/fc/fc_msp.c"
              ) ;
}
...
static void serializeDataflashSummaryReply(sbuf_t *dst)
{
    ...
    uint8_t flags = (flashfsIsReady() ? 1 : 0) | 2 ;
...
static void serializeDataflashReadReply(sbuf_t *dst, uint32_t address, const uint16_t size, 
# 296 "./src/main/fc/fc_msp.c" 3 4
                                                                                           _Bool 
# 296 "./src/main/fc/fc_msp.c"
                                                                                                useLegacyFormat, 
# 296 "./src/main/fc/fc_msp.c" 3 4
                                                                                                                 _Bool 
# 296 "./src/main/fc/fc_msp.c"
                                                                                                                      allowCompression)
{
    ((void)sizeof(char[1 - 2*!!(16 < 16)]));

    uint16_t readLen = size;
    const int bytesRemainingInBuf = sbufBytesRemaining(dst) - 16;
...
static 
# 387 "./src/main/fc/fc_msp.c" 3 4
      _Bool 
# 387 "./src/main/fc/fc_msp.c"
...
# 419 "./src/main/fc/fc_msp.c"
    ...
    case 160:
        sbufWriteU32(dst, (*(uint32_t*)0x1FFFF7E8));
        sbufWriteU32(dst, (*(uint32_t*)0x1FFFF7EC));
        sbufWriteU32(dst, (*(uint32_t*)0x1FFFF7F0));
        break;
...
# 630 "./src/main/fc/fc_msp.c"
        ...
        sbufWriteU8(dst, 0);
# 668 "./src/main/fc/fc_msp.c"
        break;
    }

    default:
        return 
# 672 "./src/main/fc/fc_msp.c" 3 4
              0
# 672 "./src/main/fc/fc_msp.c"
                   ;
    }
    return 
# 674 "./src/main/fc/fc_msp.c" 3 4
          1
# 674 "./src/main/fc/fc_msp.c"
              ;
}
# 709 "./src/main/fc/fc_msp.c"
static 
# 709 "./src/main/fc/fc_msp.c" 3 4
      _Bool 
# 709 "./src/main/fc/fc_msp.c"
           mspFcProcessOutCommand(uint8_t cmdMSP, sbuf_t *dst)
{
    switch (cmdMSP) {
    case 150:
    case 101:
...
# 979 "./src/main/fc/fc_msp.c"
    ...
    case 96:
        ...
        break;
# 1221 "./src/main/fc/fc_msp.c"
        break;

    default:
        return 
# 1224 "./src/main/fc/fc_msp.c" 3 4
              0
# 1224 "./src/main/fc/fc_msp.c"
                   ;
    }
    return 
# 1226 "./src/main/fc/fc_msp.c" 3 4
          1
# 1226 "./src/main/fc/fc_msp.c"
              ;
}
...
# 1280 "./src/main/fc/fc_msp.c" 3 4
   _Bool 
# 1280 "./src/main/fc/fc_msp.c"
        allowCompression = 
# 1280 "./src/main/fc/fc_msp.c" 3 4
                           0
# 1280 "./src/main/fc/fc_msp.c"
...
# 1281 "./src/main/fc/fc_msp.c" 3 4
   _Bool 
# 1281 "./src/main/fc/fc_msp.c"
        useLegacyFormat;
    if (dataSize >= sizeof(uint32_t) + sizeof(uint16_t)) {
        ...
        useLegacyFormat = 
# 1287 "./src/main/fc/fc_msp.c" 3 4
                         0
# 1287 "./src/main/fc/fc_msp.c"
                              ;
    } else {
        readLength = 128;
        useLegacyFormat = 
# 1290 "./src/main/fc/fc_msp.c" 3 4
                         1
# 1290 "./src/main/fc/fc_msp.c"
                             ;
    }

    serializeDataflashReadReply(dst, readAddress, readLength, useLegacyFormat, allowCompression);
}
# 1306 "./src/main/fc/fc_msp.c"
static mspResult_e mspFcProcessInCommand(uint8_t cmdMSP, sbuf_t *src)
{
    ...
    case 204:
        if (sbufBytesRemaining(src) >= 10) {
            ...
            for (int i = 0; i < 3; i++) {
                value = sbufReadU8(src);
                currentControlRateProfile->rates[i] = __extension__ ({ __typeof__ (value) _a = (value); __typeof__ (i == FD_YAW ? 255 : 100) _b = (i == FD_YAW ? 255 : 100); _a < _b ? _a : _b; });
            }
            value = sbufReadU8(src);
...
# 1477 "./src/main/fc/fc_msp.c"
    ...
    case 81:
        ...
        break;
# 1708 "./src/main/fc/fc_msp.c"
    case 72:
        flashfsEraseCompletely();
        break;
# 1754 "./src/main/fc/fc_msp.c"
    case 37:
        featureClearAll();
