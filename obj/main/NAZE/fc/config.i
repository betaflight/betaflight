...
# 100 "./src/main/fc/config.c" 2


pidProfile_t *currentPidProfile;
# 115 "./src/main/fc/config.c"
...
const featureConfig_t pgResetTemplate_featureConfig __attribute__ ((section(".pg_resetdata"), used, aligned(2))) = { .enabledFeatures = 0 | FEATURE_RX_PPM }
...
extern const systemConfig_t pgResetTemplate_systemConfig; systemConfig_t systemConfig_System; systemConfig_t systemConfig_Copy; extern const pgRegistry_t systemConfig_Registry; const pgRegistry_t systemConfig_Registry __attribute__ ((section(".pg_registry"), used, aligned(4))) = { .pgn = 18 | (1 << 12), .size = sizeof(systemConfig_t) | PGR_SIZE_SYSTEM_FLAG, .address = (uint8_t*)&systemConfig_System, .copy = (uint8_t*)&systemConfig_Copy, .ptr = 0, .reset = {.ptr = (void*)&pgResetTemplate_systemConfig}, };
# 141 "./src/main/fc/config.c"
...
# 141 "./src/main/fc/config.c" 3 4
1
# 141 "./src/main/fc/config.c"
, .boardIdentifier = "AFNA" }
...
extern void pgResetFn_flashConfig(flashConfig_t *); flashConfig_t flashConfig_System; flashConfig_t flashConfig_Copy; extern const pgRegistry_t flashConfig_Registry; const pgRegistry_t flashConfig_Registry __attribute__ ((section(".pg_registry"), used, aligned(4))) = { .pgn = 506 | (0 << 12), .size = sizeof(flashConfig_t) | PGR_SIZE_SYSTEM_FLAG, .address = (uint8_t*)&flashConfig_System, .copy = (uint8_t*)&flashConfig_Copy, .ptr = 0, .reset = {.fn = (pgResetFunc*)&pgResetFn_flashConfig }, };

void pgResetFn_flashConfig(flashConfig_t *flashConfig)
{

    flashConfig->csTag = ((ioTag_t)((((1) + 1) << 4) | (12)));



    flashConfig->spiDevice = ((spiDeviceByInstance(((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x3800)))) + 1);
}
# 192 "./src/main/fc/config.c"
...
# 198 "./src/main/fc/config.c" 3 4
                             1
# 198 "./src/main/fc/config.c"
                                 ;
    adcConfig->vbat.ioTag = ((ioTag_t)((((0) + 1) << 4) | (4)));



    adcConfig->external1.enabled = 
# 203 "./src/main/fc/config.c" 3 4
                                  1
# 203 "./src/main/fc/config.c"
                                      ;
    adcConfig->external1.ioTag = ((ioTag_t)((((0) + 1) << 4) | (5)));



    adcConfig->current.enabled = 
# 208 "./src/main/fc/config.c" 3 4
                                1
# 208 "./src/main/fc/config.c"
                                    ;
    adcConfig->current.ioTag = ((ioTag_t)((((1) + 1) << 4) | (1)));



    adcConfig->rssi.enabled = 
# 213 "./src/main/fc/config.c" 3 4
                             1
# 213 "./src/main/fc/config.c"
                                 ;
    adcConfig->rssi.ioTag = ((ioTag_t)((((0) + 1) << 4) | (1)));
...
void pgResetFn_pwmConfig(pwmConfig_t *pwmConfig)
{
    ...
    int inputIndex = 0;
    for (int i = 0; i < 14 && inputIndex < 8; i++) {
...
# 335 "./src/main/fc/config.c" 3 4
                                                                      ((void *)0)
# 335 "./src/main/fc/config.c"
                                                                          )
...
# 440 "./src/main/fc/config.c"
    featureClear(FEATURE_GPS);



    featureClear(FEATURE_SONAR);
# 464 "./src/main/fc/config.c"
...
# 514 "./src/main/fc/config.c" 3 4
                                             0
# 514 "./src/main/fc/config.c"
                                                  ;
    }
    ...
    if (gyroConfig()->gyro_use_32khz) {
        ...
        gyroConfigMutable()->gyro_sync_denom = __extension__ ({ __typeof__ (gyroConfig()->gyro_sync_denom) _a = (gyroConfig()->gyro_sync_denom); __typeof__ (16) _b = (16); _a > _b ? _a : _b; });



    } else {

        gyroConfigMutable()->gyro_sync_denom = __extension__ ({ __typeof__ (gyroConfig()->gyro_sync_denom) _a = (gyroConfig()->gyro_sync_denom); __typeof__ (3) _b = (3); _a > _b ? _a : _b; });
