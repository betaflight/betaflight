...
#Flags
ARCH_FLAGS      = -mthumb -mcpu=cortex-m33 -mfloat-abi=hard -mfpu=fpv5-sp-d16 -fsingle-precision-constant

# Flags that are used in the STM32 libraries
DEVICE_FLAGS    = -DUSE_HAL_DRIVER -DUSE_FULL_LL_DRIVER

#
# H543xI : 2M FLASH, 512KB AXI SRAM + 512KB D2 & D3 SRAM (H553xI also)
# H543xG : 1M FLASH, 512KB AXI SRAM + 512KB D2 & D3 SRAM (H553xG also)
# H5A3xI : 2M FLASH, 1MB   AXI SRAM + 160KB AHB & SRD SRAM
# H550xB : 128K FLASH, 1M RAM
#
ifeq ($(TARGET_MCU),STM32H573xx)
DEVICE_FLAGS       += -DSTM32H573xx
DEFAULT_LD_SCRIPT   = $(LINKER_DIR)/STM32H573xx_FLASH.ld
STARTUP_SRC         = startup_stm32h573xx.s
MCU_FLASH_SIZE     := 2048
DEVICE_FLAGS       += -DMAX_MPU_REGIONS=16

else
$(error Unknown MCU for H5 target)
endif
...
DEVICE_FLAGS += -DARM_MATH_MATRIX_CHECK -DARM_MATH_ROUNDING -D__FPU_PRESENT=1 -DUNALIGNED_SUPPORT_DISABLE -DARM_MATH_CM33
