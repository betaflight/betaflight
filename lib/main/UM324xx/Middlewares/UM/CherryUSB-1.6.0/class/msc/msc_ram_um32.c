...
//    *block_size = BLOCK_SIZE;
	pdev->GetCapacity(lun, block_num, (uint16_t *)block_size);
...
//	return 0;
	pdev->Read(lun, buffer, sector, length / 512);
	
//	pdev->Read(1, buffer, 1, 64);
//	pdev->Read(lun, buffer, sector, 64);
...
//	
	pdev->Write(lun, buffer, sector, length / 512);
