...
#ifndef __UM324XX_HAL_EMAC_H__
#define __UM324XX_HAL_EMAC_H__
...
/* ETHERNET CONFIG register Mask */
#define ETH_MACCR_CLEAR_MASK    0xFF20810FU

/* ETHERNET DMA_OPMODE register Mask */
#define ETH_DMAOMR_CLEAR_MASK   0xF8DE3F23U


#define RDES_ADDR                       0x20020000
#define TDES_ADDR                       0x20020100
#define EMAC_TX_BUF_ADDR                0x20021000
#define EMAC_RX_BUF_ADDR                0x20024000
#define DES_SIZE                        0x20
...
typedef enum
{
  ...
  HAL_ETH_RGMII_MODE            = ((uint32_t)SYSCFG_EMACMR_EMACMR_0),    /*!<   Reduced Media Independent Interface       */
  HAL_ETH_RMII_MODE             = ((uint32_t)SYSCFG_EMACMR_EMACMR_2)    /*!<   Reduced Media Independent Interface       */
...
{
  EMAC_TypeDef                *Instance;                 /*!< Register base address       */
...
/** @defgroup ETH_Burst_Mode ETH Burst Mode
  * @{
  */
#define ETH_BURSTLENGTH_FIXED           EMAC_DMA_BUSMODE_FB
#define ETH_BURSTLENGTH_MIXED           EMAC_DMA_BUSMODE_MB
...
/** @defgroup ETH_Speed  ETH Speed
  * @{
  */
#define ETH_SPEED_10M        ((uint32_t)0x00008000U)
...
/** @defgroup ETH_Duplex_Mode ETH Duplex Mode
  * @{
  */
#define ETH_FULLDUPLEX_MODE       EMAC_CONFIG_DP
...
/**
  ...
  * @retval None
  */
#define __HAL_ETH_DMA_ENABLE_IT(__HANDLE__, __INTERRUPT__)                 ((__HANDLE__)->Instance->DMA_INTEN \
                                                                            |= (__INTERRUPT__))
...
/**
  ...
  * @retval None
  */
#define __HAL_ETH_DMA_DISABLE_IT(__HANDLE__, __INTERRUPT__)                ((__HANDLE__)->Instance->DMA_INTEN \
                                                                            &= ~(__INTERRUPT__))
...
/**
  ...
  */
#define __HAL_ETH_DMA_GET_IT_SOURCE(__HANDLE__, __INTERRUPT__)      (((__HANDLE__)->Instance->DMA_INTEN &\
...
/**
  ...
  */
#define __HAL_ETH_DMA_GET_IT(__HANDLE__, __INTERRUPT__)      (((__HANDLE__)->Instance->DMA_DMASTATUS &\
                                                               (__INTERRUPT__)) == (__INTERRUPT__))
...
/**
  ...
  * @retval None
  */
#define __HAL_ETH_DMA_CLEAR_IT(__HANDLE__, __INTERRUPT__)      ((__HANDLE__)->Instance->DMA_DMASTATUS = (__INTERRUPT__))
...
/**
  ...
  */
#define __HAL_ETH_MAC_GET_IT(__HANDLE__, __INTERRUPT__)                   (((__HANDLE__)->Instance->INTSTATUS &\
                                                                            ( __INTERRUPT__)) == ( __INTERRUPT__))
