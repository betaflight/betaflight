...
ErrorStatus LL_TIM_DeInit(const TIM_TypeDef *TIMx)
{
  ...
  if (TIMx == TIM1)
  {
		__HAL_RCM_TIM1_FORCE_RESET();
		__HAL_RCM_TIM1_RELEASE_RESET();
  }
  else if (TIMx == TIM8)
  {
		__HAL_RCM_TIM8_FORCE_RESET();
		__HAL_RCM_TIM8_RELEASE_RESET();
  }
  else if (TIMx == TIM2)
  {
		__HAL_RCM_TIM2_FORCE_RESET();
		__HAL_RCM_TIM2_RELEASE_RESET();
  }
  else if (TIMx == TIM3)
  {
		__HAL_RCM_TIM3_FORCE_RESET();
		__HAL_RCM_TIM3_RELEASE_RESET();
  }
  else if (TIMx == TIM4)
  {
		__HAL_RCM_TIM4_FORCE_RESET();
		__HAL_RCM_TIM4_RELEASE_RESET();
  }
  else if (TIMx == TIM5)
  {
		__HAL_RCM_TIM5_FORCE_RESET();
		__HAL_RCM_TIM5_RELEASE_RESET();
  }
  else if (TIMx == TIM9)
  {
		__HAL_RCM_TIM9_FORCE_RESET();
		__HAL_RCM_TIM9_RELEASE_RESET();
  }
  else if (TIMx == TIM10)
  {
		__HAL_RCM_TIM10_FORCE_RESET();
		__HAL_RCM_TIM10_RELEASE_RESET();
  }
  else if (TIMx == TIM11)
  {
		__HAL_RCM_TIM11_FORCE_RESET();
		__HAL_RCM_TIM11_RELEASE_RESET();
  }
  else if (TIMx == TIM12)
  {
		__HAL_RCM_TIM12_FORCE_RESET();
		__HAL_RCM_TIM12_RELEASE_RESET();
  }
  else if (TIMx == TIM13)
  {
		__HAL_RCM_TIM13_FORCE_RESET();
		__HAL_RCM_TIM13_RELEASE_RESET();
  }
  else if (TIMx == TIM14)
  {
		__HAL_RCM_TIM14_FORCE_RESET();
		__HAL_RCM_TIM14_RELEASE_RESET();
  }
  else if (TIMx == TIM6)
  {
		__HAL_RCM_TIM6_FORCE_RESET();
		__HAL_RCM_TIM6_RELEASE_RESET();
  }
  else if (TIMx == TIM7)
  {
		__HAL_RCM_TIM7_FORCE_RESET();
		__HAL_RCM_TIM7_RELEASE_RESET();
  }
  else
  {
    result = ERROR;
...
static ErrorStatus IC1Config(TIM_TypeDef *TIMx, LL_TIM_IC_InitTypeDef *TIM_ICInitStruct)
{
  ...
  TIMx->CCER &= (uint32_t)~TIM_CCER_CC1E;
	...
	if (TIM_ICInitStruct->ICPolarity == LL_TIM_IC_POLARITY_BOTHEDGE)
	{
		TIMx->CCMR1 |= (0x03<<0);
		TIMx->SMCR |= (4<<4);
		TIMx->CCER |= ((uint32_t)TIM_CCER_CC1E);
...
static ErrorStatus IC2Config(TIM_TypeDef *TIMx, LL_TIM_IC_InitTypeDef *TIM_ICInitStruct)
{
  ...
  TIMx->CCER &= (uint32_t)~TIM_CCER_CC2E;
	...
	if ((TIMx == TIM12) || (TIMx == TIM13) || (TIMx == TIM14) || (TIMx == TIM4))
	{
		TIMx->CR2 |= (1<<7);
	}
...
static ErrorStatus IC3Config(TIM_TypeDef *TIMx, LL_TIM_IC_InitTypeDef *TIM_ICInitStruct)
{
  ...
  TIMx->CCER &= (uint32_t)~TIM_CCER_CC3E;
	...
	if ((TIMx == TIM2) || (TIMx == TIM3) || (TIMx == TIM12))
	{
		TIMx->CR2 |= (1<<7);
	}
