/********************************** (C) COPYRIGHT
 * ******************************* File Name          : ch32h417_eth.h Author
 *          : WCH Version            : V1.0.0 Date               : 2021/06/06
...
typedef struct {
  ...
  uint32_t
      ETH_DropTCPIPChecksumErrorFrame; /* Selects or not the Dropping of
...
#define ETH_MAX_PACKET_SIZE                                                    \
  1536 /* ETH_HEADER + ETH_EXTRA + MAX_ETH_PAYLOAD + ETH_CRC */
#define ETH_HEADER                                                             \
...
#define ETH_DMASR_NIS                                                          \
  ((unsigned int)0x00010000) /* Normal interrupt summary                       \
                              */
...
#define ETH_DMASR_TUS                                                          \
  ((unsigned int)0x00000020)                     /* Transmit underflow status  \
                                                  */
...
#define ETH_MACFFR_BFD                                                         \
  ((unsigned int)0x00000020)                       /* Broadcast frame disable  \
                                                    */
...
#define ETH_MACPMTCSR_MPR                                                      \
  ((unsigned int)0x00000020) /* Magic Packet Received                          \
                              */
#define ETH_MACPMTCSR_WFE                                                      \
  ((unsigned int)0x00000004)                         /* Wake-Up Frame Enable   \
                                                      */
...
#define ETH_PTPTSCR_TSSTI                                                      \
  ((unsigned int)0x00000004) /* Time stamp initialize                          \
                              */
...
#define ETH_PTPTTHR_TTSH                                                       \
  ((unsigned int)0xFFFFFFFF) /* Target time stamp high                         \
                              */

#define ETH_PTPTTLR_TTSL                                                       \
  ((unsigned int)0xFFFFFFFF) /* Target time stamp low                          \
                              */
...
#define ETH_DMARDLAR_SRL                                                       \
  ((unsigned int)0xFFFFFFFF) /* Start of receive list                          \
                              */

#define ETH_DMATDLAR_STL                                                       \
  ((unsigned int)0xFFFFFFFF) /* Start of transmit list                         \
                              */
...
#define ETH_DMAOMR_OSF                                                         \
  ((unsigned int)0x00000004)                     /* operate on second frame    \
                                                  */
...
#define ETH_DMAIER_RIE                                                         \
  ((unsigned int)0x00000040) /* Receive interrupt enable                       \
                              */
